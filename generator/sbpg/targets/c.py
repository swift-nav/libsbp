...
ALL_MESSAGES_TEMPLATE_NAME = "sbp_all_messages_template.h"
...
def render_source(include_dir, package_specs):
    print("new_c::render_messages")
    all_msgs = []
    all_packages = []
    msg_msgid_len =0
    ...
    py_template = JENV.get_template(ALL_MESSAGES_TEMPLATE_NAME)
    with open(destination_filename, 'w') as f:
