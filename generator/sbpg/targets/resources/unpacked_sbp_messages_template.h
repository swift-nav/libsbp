...
#define (((path)))_(((f.name)))_strcmp(a,b) sbp_(((f.encoding)))_string_strcmp(a,b,(((f.max_items))))
...
#define (((path)))_(((f.name)))_valid(f) sbp_(((f.encoding)))_string_valid(f, (((common_args))))
...
#define (((path)))_(((f.name)))_strcmp(a,b) sbp_(((f.encoding)))_string_strcmp(a,b,(((common_args))))
  ((*- else *))
