...
\begin{center}
  \begin{longtable}{{llllp{6.5cm}}}
    ...
    \midrule
    {0} & {GPS L1CA} & {32} & {QZS L1CI} \\
    {1} & {GPS L2CM} & {33} & {QZS L1CQ} \\
    {2} & {SBAS L1CA} & {34} & {QZS L1CX} \\
    {3} & {GLO L1OF} & {35} & {QZS L2CM} \\
    {4} & {GLO L2OF} & {36} & {QZS L2CL} \\
    {5} & {GPS L1P} & {37} & {QZS L2CX} \\
    {6} & {GPS L2P} & {38} & {QZS L5I} \\
    {7} & {GPS L2CL} & {39} & {QZS L5Q} \\
    {8} & {GPS L2CX} & {40} & {QZS L5X} \\
    {9} & {GPS L5I} & {41} & {SBAS L5I} \\
    {10} & {GPS L5Q} & {42} & {SBAS L5Q} \\
    {11} & {GPS L5X} & {43} & {SBAS L5X} \\
    {12} & {BDS2 B1} & {44} & {BDS3 B1CI} \\
    {13} & {BDS2 B2} & {45} & {BDS3 B1CQ} \\
    {14} & {GAL E1B} & {46} & {BDS3 B1CX} \\
    {15} & {GAL E1C} & {47} & {BDS3 B5I} \\
    {16} & {GAL E1X} & {48} & {BDS3 B5Q} \\
    {17} & {GAL E6B} & {49} & {BDS3 B5X} \\
    {18} & {GAL E6C} & {50} & {BDS3 B7I} \\
    {19} & {GAL E6X} & {51} & {BDS3 B7Q} \\
    {20} & {GAL E7I} & {52} & {BDS3 B7X} \\
    {21} & {GAL E7Q} & {53} & {BDS3 B3I} \\
    {22} & {GAL E7X} & {54} & {BDS3 B3Q} \\
    {23} & {GAL E8I} & {55} & {BDS3 B3X} \\
    {24} & {GAL E8Q} & {56} & {GPS L1CI} \\
    {25} & {GAL E8X} & {57} & {GPS L1CQ} \\
    {26} & {GAL E5I} & {58} & {GPS L1CX} \\
    {27} & {GAL E5Q} & {59} & {AUX GPS} \\
    {28} & {GAL E5X} & {60} & {AUX SBAS} \\
    {29} & {GLO L1P} & {61} & {AUX GAL} \\
    {30} & {GLO L2P} & {62} & {AUX QZS} \\
    {31} & {QZS L1CA} & {63} & {AUX BDS} \\
    \bottomrule
  \end{longtable}
