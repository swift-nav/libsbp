...
\begin{large}
Signals encoded following Swift RTCM specifications (DF380, DF381, DF382 and DF467).
Code, Constellation, and Band. Signal descriptions are provided in both RINEX and RTCM Conventions.
\end{large}\\
...
\begin{center}
  \begin{longtable}{l|ll|ll|ll}
    ...
    1                      & GPS L1P     & L1 P               & GAL E1B      & E1 B I/NAV   & BDS2 B1Q     & B1 Q        \\
    2                      & GPS L1W     & L1 Z-tracking      & GAL E1C      & E1 C         & BDS2 B1I+Q   & B1 I+Q      \\
    ...
    7                      & GPS L2CM    & L2 L2C (M)         & GAL E5X      & E5a I+Q      & BDS2 B2Q     & B2 Q        \\
    8                      & GPS L2CL    & L2 L2C (L)         & GAL E7I      & E5b I I/NAV  & BDS2 B2I+Q   & B2 I+Q      \\
    9                      & GPS L2CX    & L2 L2C (M+L)       & GAL E7Q      & E5b Q        & BDS3 B1A D   & B1a D       \\
    10                     & GPS L2P     & L2 P               & GAL E7X      & E5b I+Q      & BDS3 B1A P   & B1a P       \\
    11                     & GPS L2W     & L2 Z-tracking      & GAL E8I      & E5 I         & BDS3 B1A D+P & B1a D+P     \\
    ...
    \bottomrule
  \end{longtable}
\captionof{table}{Signal and Tracking Mode Identifier}
\end{center}
