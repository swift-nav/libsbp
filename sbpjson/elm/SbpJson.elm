...
--     decodeString msgAESCmacSignature myJsonString
...
--     decodeString msgMeasurementPoint myJsonString
...
--     decodeString msgOrientQuatCov myJsonString
...
--     decodeString msgTelSv myJsonString
...
--     decodeString telemetrySV myJsonString
...
-}
type alias MsgMeasurementPoint =
    { func : String
    , id : Int
    , line : Int
    , max : Int
...
msgAESCmacSignatureToString : MsgAESCmacSignature -> String
msgAESCmacSignatureToString r = Jenc.encode 0 (encodeMsgAESCmacSignature r)
...
msgMeasurementPointToString : MsgMeasurementPoint -> String
msgMeasurementPointToString r = Jenc.encode 0 (encodeMsgMeasurementPoint r)
...
msgOrientQuatCovToString : MsgOrientQuatCov -> String
msgOrientQuatCovToString r = Jenc.encode 0 (encodeMsgOrientQuatCov r)
...
msgTelSvToString : MsgTelSv -> String
msgTelSvToString r = Jenc.encode 0 (encodeMsgTelSv r)
...
telemetrySVToString : TelemetrySV -> String
telemetrySVToString r = Jenc.encode 0 (encodeTelemetrySV r)
...
msgAESCmacSignature : Jdec.Decoder MsgAESCmacSignature
msgAESCmacSignature =
    Jpipe.decode MsgAESCmacSignature
...
encodeMsgAESCmacSignature : MsgAESCmacSignature -> Jenc.Value
encodeMsgAESCmacSignature x =
    Jenc.object
...
msgMeasurementPoint : Jdec.Decoder MsgMeasurementPoint
msgMeasurementPoint =
    Jpipe.decode MsgMeasurementPoint
        |> Jpipe.required "func" Jdec.string
        |> Jpipe.required "id" Jdec.int
        |> Jpipe.required "line" Jdec.int
        |> Jpipe.required "max" Jdec.int
        |> Jpipe.required "min" Jdec.int
        |> Jpipe.required "num_executions" Jdec.int
        |> Jpipe.required "return_addr" Jdec.int
        |> Jpipe.required "slice_time" Jdec.int
        |> Jpipe.required "total_time" Jdec.int

encodeMsgMeasurementPoint : MsgMeasurementPoint -> Jenc.Value
encodeMsgMeasurementPoint x =
    Jenc.object
        [ ("func", Jenc.string x.func)
        , ("id", Jenc.int x.id)
        , ("line", Jenc.int x.line)
        , ("max", Jenc.int x.max)
        , ("min", Jenc.int x.min)
        , ("num_executions", Jenc.int x.numExecutions)
        , ("return_addr", Jenc.int x.returnAddr)
        , ("slice_time", Jenc.int x.sliceTime)
        , ("total_time", Jenc.int x.totalTime)
        ]
...
telemetrySV =
    Jpipe.decode TelemetrySV
        ...
        |> Jpipe.required "el" Jdec.int
        |> Jpipe.required "ephemeris_flags" Jdec.int
        |> Jpipe.required "outlier_flags" Jdec.int
        |> Jpipe.required "phase_residual" Jdec.int
        |> Jpipe.required "pseudorange_residual" Jdec.int
        |> Jpipe.required "sid" gnssSignal
...
encodeTelemetrySV x =
    Jenc.object
        ...
        , ("outlier_flags", Jenc.int x.outlierFlags)
        , ("phase_residual", Jenc.int x.phaseResidual)
        , ("pseudorange_residual", Jenc.int x.pseudorangeResidual)
        , ("sid", encodeGnssSignal x.sid)
        ]
