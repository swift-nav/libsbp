...
--     decodeString telemetrySVHeader myJsonString
...
telemetrySVHeaderToString : TelemetrySVHeader -> String
telemetrySVHeaderToString r = Jenc.encode 0 (encodeTelemetrySVHeader r)
