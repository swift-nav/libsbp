...
export class Convert {
    ...
    public static toTelemetrySVHeader(json: string): TelemetrySVHeader {
        return cast(JSON.parse(json), r("TelemetrySVHeader"));
    }

    public static telemetrySVHeaderToJson(value: TelemetrySVHeader): string {
