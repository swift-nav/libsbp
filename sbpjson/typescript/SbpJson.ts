 ...
 */
export interface MsgAESCmacSignature {
 ...
 * tags, the receiving end will expect either a MSG_GNSS_TIME_OFFSET or MSG_PPS_TIME to
 * establish the relationship between IMU time and GNSS time.,
 * Regardless of the timestamping mode, the timestamp is required to roll over to zero when
 * reaching one week (604800 seconds, or 604800000 milliseconds).,
...
/**
 * Tracks execution time of certain code paths in specially built products. This message
 * should only be expected and processed on the direction of Swift's engineering teams.
 */
export interface MsgMeasurementPoint {
    func:           string;
    id:             number;
    line:           number;
    max:            number;
...
/**
 * This message reports the orientation as a unit quaternion together with the upper
 * triangle of the symmetric 3x3 attitude covariance matrix and a GPS time-of-week time-tag.
 * The reference frame of the quaternion and the parameterization of the covariance matrix
 * are both encoded in the flags field, allowing additional frames or parameterizations to
 ...
 * of each component has a value of 2^-31. This message will only be available in future INS
 ...
 * moment a pulse is detected on the PPS input. This is to be used for synchronisation of
 ...
 * the receiving end will also expect either `MSG_GNSS_TIME_OFFSET` or `MSG_PPS_TIME` to
 * sync incoming wheeltick data to GNSS time.,
...
export class Convert {
    ...
    public static toECDSASignature(json: string): ECDSASignature {
        return cast(JSON.parse(json), r("ECDSASignature"));
    }

    public static eCDSASignatureToJson(value: ECDSASignature): string {
    ...
    public static toMsgAcknowledge(json: string): MsgAcknowledge {
        return cast(JSON.parse(json), r("MsgAcknowledge"));
    }

    public static msgAcknowledgeToJson(value: MsgAcknowledge): string {
    ...
    public static toMsgAESCmacSignature(json: string): MsgAESCmacSignature {
        return cast(JSON.parse(json), r("MsgAESCmacSignature"));
    }

    public static msgAESCmacSignatureToJson(value: MsgAESCmacSignature): string {
    ...
    public static toMsgImuComp(json: string): MsgImuComp {
        return cast(JSON.parse(json), r("MsgImuComp"));
    }

    public static msgImuCompToJson(value: MsgImuComp): string {
    ...
    public static toMsgMeasurementPoint(json: string): MsgMeasurementPoint {
        return cast(JSON.parse(json), r("MsgMeasurementPoint"));
    }

    public static msgMeasurementPointToJson(value: MsgMeasurementPoint): string {
    ...
    public static toMsgOrientQuatCov(json: string): MsgOrientQuatCov {
        return cast(JSON.parse(json), r("MsgOrientQuatCov"));
    }

    public static msgOrientQuatCovToJson(value: MsgOrientQuatCov): string {
    ...
    public static toMsgPoseRelative(json: string): MsgPoseRelative {
        return cast(JSON.parse(json), r("MsgPoseRelative"));
    }

    public static msgPoseRelativeToJson(value: MsgPoseRelative): string {
    ...
    public static toMsgProfilingQueueInfo(json: string): MsgProfilingQueueInfo {
        return cast(JSON.parse(json), r("MsgProfilingQueueInfo"));
    }

    public static msgProfilingQueueInfoToJson(value: MsgProfilingQueueInfo): string {
    ...
    public static toMsgReferenceFrameParam(json: string): MsgReferenceFrameParam {
        return cast(JSON.parse(json), r("MsgReferenceFrameParam"));
    }

    public static msgReferenceFrameParamToJson(value: MsgReferenceFrameParam): string {
    ...
    public static toMsgSsrCodePhaseBiasesBounds(json: string): MsgSsrCodePhaseBiasesBounds {
        return cast(JSON.parse(json), r("MsgSsrCodePhaseBiasesBounds"));
    }

    public static msgSsrCodePhaseBiasesBoundsToJson(value: MsgSsrCodePhaseBiasesBounds): string {
        return JSON.stringify(uncast(value, r("MsgSsrCodePhaseBiasesBounds")), null, 2);
    }

    public static toMsgSsrFlagHighLevel(json: string): MsgSsrFlagHighLevel {
        return cast(JSON.parse(json), r("MsgSsrFlagHighLevel"));
    }

    public static msgSsrFlagHighLevelToJson(value: MsgSsrFlagHighLevel): string {
        return JSON.stringify(uncast(value, r("MsgSsrFlagHighLevel")), null, 2);
    }

    public static toMsgSsrFlagIonoGridPointSatLos(json: string): MsgSsrFlagIonoGridPointSatLos {
        return cast(JSON.parse(json), r("MsgSsrFlagIonoGridPointSatLos"));
    }

    public static msgSsrFlagIonoGridPointSatLosToJson(value: MsgSsrFlagIonoGridPointSatLos): string {
        return JSON.stringify(uncast(value, r("MsgSsrFlagIonoGridPointSatLos")), null, 2);
    }

    public static toMsgSsrFlagIonoGridPoints(json: string): MsgSsrFlagIonoGridPoints {
        return cast(JSON.parse(json), r("MsgSsrFlagIonoGridPoints"));
    }

    public static msgSsrFlagIonoGridPointsToJson(value: MsgSsrFlagIonoGridPoints): string {
        return JSON.stringify(uncast(value, r("MsgSsrFlagIonoGridPoints")), null, 2);
    }

    public static toMsgSsrFlagIonoTileSatLos(json: string): MsgSsrFlagIonoTileSatLos {
        return cast(JSON.parse(json), r("MsgSsrFlagIonoTileSatLos"));
    }

    public static msgSsrFlagIonoTileSatLosToJson(value: MsgSsrFlagIonoTileSatLos): string {
        return JSON.stringify(uncast(value, r("MsgSsrFlagIonoTileSatLos")), null, 2);
    }

    public static toMsgSsrFlagSatellites(json: string): MsgSsrFlagSatellites {
        return cast(JSON.parse(json), r("MsgSsrFlagSatellites"));
    }

    public static msgSsrFlagSatellitesToJson(value: MsgSsrFlagSatellites): string {
        return JSON.stringify(uncast(value, r("MsgSsrFlagSatellites")), null, 2);
    }

    public static toMsgSsrFlagTropoGridPoints(json: string): MsgSsrFlagTropoGridPoints {
        return cast(JSON.parse(json), r("MsgSsrFlagTropoGridPoints"));
    }

    public static msgSsrFlagTropoGridPointsToJson(value: MsgSsrFlagTropoGridPoints): string {
    ...
    public static toMsgSsrGriddedCorrectionBounds(json: string): MsgSsrGriddedCorrectionBounds {
        return cast(JSON.parse(json), r("MsgSsrGriddedCorrectionBounds"));
    }

    public static msgSsrGriddedCorrectionBoundsToJson(value: MsgSsrGriddedCorrectionBounds): string {
    ...
    public static toMsgUTCLeapSecond(json: string): MsgUTCLeapSecond {
        return cast(JSON.parse(json), r("MsgUTCLeapSecond"));
    }

    public static msgUTCLeapSecondToJson(value: MsgUTCLeapSecond): string {
    ...
    public static toMsgVelCog(json: string): MsgVelCog {
        return cast(JSON.parse(json), r("MsgVelCog"));
    }

    public static msgVelCogToJson(value: MsgVelCog): string {
