...
OBS_MSG_LIST = [SBP_MSG_OBS, SBP_MSG_OBS_DEP_A, SBP_MSG_OBS_DEP_B, SBP_MSG_OBS_DEP_C]
...
def get_args():
    ...
    parser = argparse.ArgumentParser(
        description="Swift Navigation SBP Pusher Example.")
    parser.add_argument(
        "-a", "--app", default=[None], nargs=1, help="pusher app.")
    parser.add_argument(
        "-k", "--key", default=[None], nargs=1, help="pusher app key.")
    parser.add_argument(
        "-s", "--secret", default=[None], nargs=1, help="pusher app secret.")
    parser.add_argument(
        "-p",
        "--port",
