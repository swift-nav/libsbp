...
solution_meta_t::msg_soln_meta_t::msg_soln_meta_t(kaitai::kstream* p__io, sbp_t::sbp_message_t* p__parent, solution_meta_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root;
    m_sol_in = 0;
...
solution_meta_t::msg_soln_meta_dep_a_t::msg_soln_meta_dep_a_t(kaitai::kstream* p__io, sbp_t::sbp_message_t* p__parent, solution_meta_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root;
    m_sol_in = 0;
