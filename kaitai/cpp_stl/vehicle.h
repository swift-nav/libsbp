...
public:
    ...
    public:
        ...
        msg_odometry_t(kaitai::kstream* p__io, sbp_t::message_t* p__parent = 0, vehicle_t* p__root = 0);
    ...
    public:
        ...
        msg_wheeltick_t(kaitai::kstream* p__io, sbp_t::message_t* p__parent = 0, vehicle_t* p__root = 0);
