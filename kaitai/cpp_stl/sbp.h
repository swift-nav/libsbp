...
public:
    ...
    enum msg_ids_t {
        ...
        MSG_IDS_MSG_CERTIFICATE_CHAIN_DEP = 3077,
        MSG_IDS_MSG_ECDSA_SIGNATURE_DEP_A = 3078,
        MSG_IDS_MSG_ECDSA_SIGNATURE_DEP_B = 3079,
        MSG_IDS_MSG_ECDSA_SIGNATURE = 3080,
        MSG_IDS_MSG_CERTIFICATE_CHAIN = 3081,
