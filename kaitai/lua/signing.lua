...
-- 
-- Deprecated.
Signing.MsgCertificateChainDep = class.class(KaitaiStruct)

function Signing.MsgCertificateChainDep:_init(io, parent, root)
  KaitaiStruct._init(self, io)
  self._parent = parent
  self._root = root or self
  self:_read()
...
function Signing.MsgCertificateChainDep:_read()
...
Signing.EcdsaSignature = class.class(KaitaiStruct)

function Signing.EcdsaSignature:_init(io, parent, root)
  KaitaiStruct._init(self, io)
  self._parent = parent
  self._root = root or self
  self:_read()
...
function Signing.EcdsaSignature:_read()
...
-- 
-- Deprecated.
Signing.MsgEcdsaSignatureDepB = class.class(KaitaiStruct)

function Signing.MsgEcdsaSignatureDepB:_init(io, parent, root)
  KaitaiStruct._init(self, io)
  self._parent = parent
  self._root = root or self
  self:_read()
...
function Signing.MsgEcdsaSignatureDepB:_read()
  self.flags = self._io:read_u1()
  self.stream_counter = self._io:read_u1()
  self.on_demand_counter = self._io:read_u1()
  self.certificate_id = {}
...
-- 
-- Deprecated.
Signing.MsgEcdsaSignatureDepA = class.class(KaitaiStruct)

function Signing.MsgEcdsaSignatureDepA:_init(io, parent, root)
  KaitaiStruct._init(self, io)
  self._parent = parent
  self._root = root or self
  self:_read()
...
function Signing.MsgEcdsaSignatureDepA:_read()
  self.flags = self._io:read_u1()
  self.stream_counter = self._io:read_u1()
  self.on_demand_counter = self._io:read_u1()
  self.certificate_id = {}
