...
from kaitai.python.tests.utils_kaitai import get_next_msg_kaitai, get_flattened_msg, serialise
from generator.sbpg.targets.common import snake_case, snake_case_keys
...
def compare_parser_outputs(filename):
    ...
    for msg_construct, msg_kaitai, msg_hybrid1, msg_hybrid2 in zip(get_next_msg_construct(file1), get_next_msg_kaitai(file2), get_next_msg_hybrid1(file3), get_next_msg_hybrid2(file4)):
        ...
        json_kaitai = json.dumps(msg_kaitai, allow_nan=False, sort_keys=True, separators=(',', ':'), default=serialise)
        json_hybrid1 = json.dumps(msg_hybrid1, allow_nan=False, sort_keys=True, separators=(',', ':'), default=serialise)
        json_hybrid2 = json.dumps(msg_hybrid2, allow_nan=False, sort_keys=True, separators=(',', ':'), default=serialise)
