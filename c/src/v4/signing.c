...
bool sbp_msg_certificate_chain_encode_internal(
  ...
  for (size_t i = 0; i < SBP_MSG_CERTIFICATE_CHAIN_SIGNATURE_MAX; i++) {
...
bool sbp_msg_certificate_chain_decode_internal(
  ...
  for (uint8_t i = 0; i < SBP_MSG_CERTIFICATE_CHAIN_SIGNATURE_MAX; i++) {
...
int sbp_msg_certificate_chain_cmp(const sbp_msg_certificate_chain_t *a,
  ...
  for (uint8_t i = 0; ret == 0 && i < SBP_MSG_CERTIFICATE_CHAIN_SIGNATURE_MAX;
       i++) {
