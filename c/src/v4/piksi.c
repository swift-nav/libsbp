...
s8 sbp_msg_set_time_send(struct sbp_state *s, u16 sender_id,
...
s8 sbp_msg_reset_send(struct sbp_state *s, u16 sender_id,
...
s8 sbp_msg_reset_dep_send(struct sbp_state *s, u16 sender_id,
                          const sbp_msg_reset_dep_t *msg,
...
s8 sbp_msg_cw_results_send(struct sbp_state *s, u16 sender_id,
                           const sbp_msg_cw_results_t *msg,
                           sbp_write_fn_t write) {
  uint8_t payload[SBP_MAX_PAYLOAD_LEN];
  uint8_t payload_len;
...
s8 sbp_msg_cw_start_send(struct sbp_state *s, u16 sender_id,
...
s8 sbp_msg_reset_filters_send(struct sbp_state *s, u16 sender_id,
                              const sbp_msg_reset_filters_t *msg,
                              sbp_write_fn_t write) {
  uint8_t payload[SBP_MAX_PAYLOAD_LEN];
  uint8_t payload_len;
...
s8 sbp_msg_init_base_dep_send(struct sbp_state *s, u16 sender_id,
                              const sbp_msg_init_base_dep_t *msg,
                              sbp_write_fn_t write) {
  uint8_t payload[SBP_MAX_PAYLOAD_LEN];
  uint8_t payload_len;
...
s8 sbp_msg_thread_state_send(struct sbp_state *s, u16 sender_id,
                             const sbp_msg_thread_state_t *msg,
                             sbp_write_fn_t write) {
  uint8_t payload[SBP_MAX_PAYLOAD_LEN];
  uint8_t payload_len;
...
s8 sbp_msg_uart_state_send(struct sbp_state *s, u16 sender_id,
                           const sbp_msg_uart_state_t *msg,
                           sbp_write_fn_t write) {
  uint8_t payload[SBP_MAX_PAYLOAD_LEN];
  uint8_t payload_len;
...
s8 sbp_msg_uart_state_depa_send(struct sbp_state *s, u16 sender_id,
                                const sbp_msg_uart_state_depa_t *msg,
                                sbp_write_fn_t write) {
  uint8_t payload[SBP_MAX_PAYLOAD_LEN];
  uint8_t payload_len;
...
s8 sbp_msg_iar_state_send(struct sbp_state *s, u16 sender_id,
                          const sbp_msg_iar_state_t *msg,
                          sbp_write_fn_t write) {
  uint8_t payload[SBP_MAX_PAYLOAD_LEN];
  uint8_t payload_len;
...
s8 sbp_msg_mask_satellite_dep_send(struct sbp_state *s, u16 sender_id,
                                   const sbp_msg_mask_satellite_dep_t *msg,
                                   sbp_write_fn_t write) {
  uint8_t payload[SBP_MAX_PAYLOAD_LEN];
  uint8_t payload_len;
...
s8 sbp_msg_device_monitor_send(struct sbp_state *s, u16 sender_id,
                               const sbp_msg_device_monitor_t *msg,
                               sbp_write_fn_t write) {
  uint8_t payload[SBP_MAX_PAYLOAD_LEN];
  uint8_t payload_len;
...
int sbp_msg_command_req_command_strcmp(const sbp_msg_command_req_t *a,
  ...
  return sbp_null_terminated_string_strcmp(
      &a->command, &b->command, &sbp_msg_command_req_tcommand_params);
}
...
bool sbp_msg_command_req_command_set(sbp_msg_command_req_t *msg,
  ...
  return sbp_null_terminated_string_set(
      &msg->command, &sbp_msg_command_req_tcommand_params, new_str);
}
...
bool sbp_msg_command_req_command_printf(sbp_msg_command_req_t *msg,
  ...
  bool ret = sbp_null_terminated_string_vprintf(
      &msg->command, &sbp_msg_command_req_tcommand_params, fmt, ap);
  va_end(ap);
  return ret;
}
...
s8 sbp_msg_command_req_send(struct sbp_state *s, u16 sender_id,
                            const sbp_msg_command_req_t *msg,
                            sbp_write_fn_t write) {
  uint8_t payload[SBP_MAX_PAYLOAD_LEN];
  uint8_t payload_len;
...
s8 sbp_msg_command_resp_send(struct sbp_state *s, u16 sender_id,
                             const sbp_msg_command_resp_t *msg,
                             sbp_write_fn_t write) {
  uint8_t payload[SBP_MAX_PAYLOAD_LEN];
  uint8_t payload_len;
...
bool sbp_msg_command_output_line_set(sbp_msg_command_output_t *msg,
  ...
  return sbp_unterminated_string_set(
      &msg->line, &sbp_msg_command_output_tline_params, new_str);
}
...
bool sbp_msg_command_output_line_printf(sbp_msg_command_output_t *msg,
  ...
  bool ret = sbp_unterminated_string_vprintf(
      &msg->line, &sbp_msg_command_output_tline_params, fmt, ap);
  va_end(ap);
  return ret;
}
...
size_t sbp_msg_network_bandwidth_usage_encoded_len(
  ...
  size_t encoded_len = 0;
  encoded_len +=
      (msg->n_interfaces * sbp_network_usage_encoded_len(&msg->interfaces[0]));
  return encoded_len;
}
...
bool sbp_msg_network_bandwidth_usage_decode_internal(
  ...
  msg->n_interfaces =
      (uint8_t)((ctx->buf_len - ctx->offset) /
                sbp_network_usage_encoded_len(&msg->interfaces[0]));
  for (uint8_t i = 0; i < msg->n_interfaces; i++) {
...
bool sbp_msg_cell_modem_status_decode_internal(
  ...
  msg->n_reserved = (uint8_t)((ctx->buf_len - ctx->offset) /
                              sbp_u8_encoded_len(&msg->reserved[0]));
  for (uint8_t i = 0; i < msg->n_reserved; i++) {
...
s8 sbp_msg_cell_modem_status_send(struct sbp_state *s, u16 sender_id,
                                  const sbp_msg_cell_modem_status_t *msg,
                                  sbp_write_fn_t write) {
  uint8_t payload[SBP_MAX_PAYLOAD_LEN];
  uint8_t payload_len;
...
size_t sbp_msg_specan_dep_encoded_len(const sbp_msg_specan_dep_t *msg) {
  ...
  encoded_len +=
      (msg->n_amplitude_value * sbp_u8_encoded_len(&msg->amplitude_value[0]));
  return encoded_len;
}
...
bool sbp_msg_specan_dep_decode_internal(sbp_decode_ctx_t *ctx,
  ...
  msg->n_amplitude_value =
      (uint8_t)((ctx->buf_len - ctx->offset) /
                sbp_u8_encoded_len(&msg->amplitude_value[0]));
  for (uint8_t i = 0; i < msg->n_amplitude_value; i++) {
...
s8 sbp_msg_specan_send(struct sbp_state *s, u16 sender_id,
...
s8 sbp_msg_front_end_gain_send(struct sbp_state *s, u16 sender_id,
                               const sbp_msg_front_end_gain_t *msg,
                               sbp_write_fn_t write) {
  uint8_t payload[SBP_MAX_PAYLOAD_LEN];
  uint8_t payload_len;
