...
size_t sbp_msg_almanac_encoded_len(const sbp_msg_almanac_t *msg) {
  (void)msg;
  return SBP_MSG_ALMANAC_ENCODED_LEN;
}

SBP_BOOL sbp_msg_almanac_encode_internal(sbp_encode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_almanac_decode_internal(sbp_decode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_set_time_encode_internal(sbp_encode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_set_time_decode_internal(sbp_decode_ctx_t *ctx,
...
size_t sbp_msg_reset_encoded_len(const sbp_msg_reset_t *msg) {
  (void)msg;
  return SBP_MSG_RESET_ENCODED_LEN;
}

SBP_BOOL sbp_msg_reset_encode_internal(sbp_encode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_reset_decode_internal(sbp_decode_ctx_t *ctx,
                                       sbp_msg_reset_t *msg) {
  uint8_t i;
  (void)i;
...
size_t sbp_msg_reset_dep_encoded_len(const sbp_msg_reset_dep_t *msg) {
  (void)msg;
  return SBP_MSG_RESET_DEP_ENCODED_LEN;
}

SBP_BOOL sbp_msg_reset_dep_encode_internal(sbp_encode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_reset_dep_decode_internal(sbp_decode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_cw_results_encode_internal(sbp_encode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_cw_results_decode_internal(sbp_decode_ctx_t *ctx,
...
size_t sbp_msg_cw_start_encoded_len(const sbp_msg_cw_start_t *msg) {
  (void)msg;
  return SBP_MSG_CW_START_ENCODED_LEN;
}

SBP_BOOL sbp_msg_cw_start_encode_internal(sbp_encode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_cw_start_decode_internal(sbp_decode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_reset_filters_encode_internal(
    sbp_encode_ctx_t *ctx, const sbp_msg_reset_filters_t *msg) {
  size_t i;
  (void)i;
...
SBP_BOOL sbp_msg_reset_filters_decode_internal(sbp_decode_ctx_t *ctx,
...
size_t sbp_msg_init_base_dep_encoded_len(const sbp_msg_init_base_dep_t *msg) {
  (void)msg;
  return SBP_MSG_INIT_BASE_DEP_ENCODED_LEN;
}

SBP_BOOL sbp_msg_init_base_dep_encode_internal(
    sbp_encode_ctx_t *ctx, const sbp_msg_init_base_dep_t *msg) {
  (void)ctx;
  (void)msg;
  return SBP_TRUE;
}
...
SBP_BOOL sbp_msg_init_base_dep_decode_internal(sbp_decode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_thread_state_encode_internal(
    sbp_encode_ctx_t *ctx, const sbp_msg_thread_state_t *msg) {
  size_t i;
  (void)i;
  for (i = 0; i < SBP_MSG_THREAD_STATE_NAME_MAX; i++) {
...
SBP_BOOL sbp_msg_thread_state_decode_internal(sbp_decode_ctx_t *ctx,
...
int sbp_msg_thread_state_cmp(const sbp_msg_thread_state_t *a,
  ...
  for (i = 0; ret == 0 && i < SBP_MSG_THREAD_STATE_NAME_MAX; i++) {
...
SBP_BOOL sbp_uart_channel_encode_internal(sbp_encode_ctx_t *ctx,
...
SBP_BOOL sbp_uart_channel_decode_internal(sbp_decode_ctx_t *ctx,
...
SBP_BOOL sbp_period_encode_internal(sbp_encode_ctx_t *ctx,
...
SBP_BOOL sbp_period_decode_internal(sbp_decode_ctx_t *ctx, sbp_period_t *msg) {
  uint8_t i;
  (void)i;
...
SBP_BOOL sbp_latency_encode_internal(sbp_encode_ctx_t *ctx,
...
SBP_BOOL sbp_latency_decode_internal(sbp_decode_ctx_t *ctx,
                                     sbp_latency_t *msg) {
  uint8_t i;
  (void)i;
  if (!sbp_s32_decode(ctx, &msg->avg)) {
...
SBP_BOOL sbp_msg_uart_state_encode_internal(sbp_encode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_uart_state_decode_internal(sbp_decode_ctx_t *ctx,
...
size_t sbp_msg_uart_state_depa_encoded_len(
  ...
  (void)msg;
  return SBP_MSG_UART_STATE_DEPA_ENCODED_LEN;
}

SBP_BOOL sbp_msg_uart_state_depa_encode_internal(
...
SBP_BOOL sbp_msg_uart_state_depa_decode_internal(
    sbp_decode_ctx_t *ctx, sbp_msg_uart_state_depa_t *msg) {
  uint8_t i;
  (void)i;
  if (!sbp_uart_channel_decode_internal(ctx, &msg->uart_a)) {
    return SBP_FALSE;
...
size_t sbp_msg_iar_state_encoded_len(const sbp_msg_iar_state_t *msg) {
  (void)msg;
  return SBP_MSG_IAR_STATE_ENCODED_LEN;
}

SBP_BOOL sbp_msg_iar_state_encode_internal(sbp_encode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_iar_state_decode_internal(sbp_decode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_mask_satellite_encode_internal(
...
SBP_BOOL sbp_msg_mask_satellite_decode_internal(sbp_decode_ctx_t *ctx,
...
size_t sbp_msg_mask_satellite_dep_encoded_len(
  ...
  (void)msg;
  return SBP_MSG_MASK_SATELLITE_DEP_ENCODED_LEN;
}

SBP_BOOL sbp_msg_mask_satellite_dep_encode_internal(
...
SBP_BOOL sbp_msg_mask_satellite_dep_decode_internal(
...
SBP_BOOL sbp_msg_device_monitor_encode_internal(
...
SBP_BOOL sbp_msg_device_monitor_decode_internal(sbp_decode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_command_req_command_valid(const sbp_msg_command_req_t *msg) {
...
SBP_BOOL sbp_msg_command_req_command_set(sbp_msg_command_req_t *msg,
                                         const char *new_str,
                                         SBP_BOOL should_trunc,
                                         size_t *n_written) {
...
SBP_BOOL sbp_msg_command_req_command_set_raw(sbp_msg_command_req_t *msg,
                                             const char *new_buf,
                                             size_t new_buf_len,
                                             SBP_BOOL should_trunc,
                                             size_t *n_written) {
...
SBP_BOOL sbp_msg_command_req_command_printf(sbp_msg_command_req_t *msg,
                                            SBP_BOOL should_trunc,
  ...
  va_list ap;
  va_start(ap, fmt);
  ret = sbp_null_terminated_string_vprintf(&msg->command,
                                           SBP_MSG_COMMAND_REQ_COMMAND_MAX,
...
SBP_BOOL sbp_msg_command_req_command_vprintf(sbp_msg_command_req_t *msg,
                                             SBP_BOOL should_trunc,
                                             size_t *n_written, const char *fmt,
                                             va_list ap) {
...
SBP_BOOL sbp_msg_command_req_command_append_printf(sbp_msg_command_req_t *msg,
                                                   SBP_BOOL should_trunc,
                                                   size_t *n_written,
                                                   const char *fmt, ...) {
  SBP_BOOL ret;
  va_list ap;
  va_start(ap, fmt);
  ret = sbp_null_terminated_string_append_vprintf(
      &msg->command, SBP_MSG_COMMAND_REQ_COMMAND_MAX, should_trunc, n_written,
      fmt, ap);
  va_end(ap);
  return ret;
...
SBP_BOOL sbp_msg_command_req_command_append_vprintf(sbp_msg_command_req_t *msg,
                                                    SBP_BOOL should_trunc,
                                                    size_t *n_written,
                                                    const char *fmt,
                                                    va_list ap) {
...
SBP_BOOL sbp_msg_command_req_encode_internal(sbp_encode_ctx_t *ctx,
                                             const sbp_msg_command_req_t *msg) {
  size_t i;
  (void)i;
...
SBP_BOOL sbp_msg_command_req_decode_internal(sbp_decode_ctx_t *ctx,
...
size_t sbp_msg_command_resp_encoded_len(const sbp_msg_command_resp_t *msg) {
  (void)msg;
  return SBP_MSG_COMMAND_RESP_ENCODED_LEN;
}

SBP_BOOL sbp_msg_command_resp_encode_internal(
    sbp_encode_ctx_t *ctx, const sbp_msg_command_resp_t *msg) {
  size_t i;
  (void)i;
  if (!sbp_u32_encode(ctx, &msg->sequence)) {
    return SBP_FALSE;
...
SBP_BOOL sbp_msg_command_resp_decode_internal(sbp_decode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_command_output_line_valid(
...
SBP_BOOL sbp_msg_command_output_line_set(sbp_msg_command_output_t *msg,
                                         const char *new_str,
                                         SBP_BOOL should_trunc,
                                         size_t *n_written) {
...
SBP_BOOL sbp_msg_command_output_line_set_raw(sbp_msg_command_output_t *msg,
                                             const char *new_buf,
                                             size_t new_buf_len,
                                             SBP_BOOL should_trunc,
                                             size_t *n_written) {
...
SBP_BOOL sbp_msg_command_output_line_printf(sbp_msg_command_output_t *msg,
                                            SBP_BOOL should_trunc,
                                            size_t *n_written, const char *fmt,
                                            ...) {
  SBP_BOOL ret;
  va_list ap;
  va_start(ap, fmt);
  ret = sbp_unterminated_string_vprintf(&msg->line,
                                        SBP_MSG_COMMAND_OUTPUT_LINE_MAX,
                                        should_trunc, n_written, fmt, ap);
  va_end(ap);
  return ret;
...
SBP_BOOL sbp_msg_command_output_line_vprintf(sbp_msg_command_output_t *msg,
                                             SBP_BOOL should_trunc,
                                             size_t *n_written, const char *fmt,
                                             va_list ap) {
...
SBP_BOOL sbp_msg_command_output_line_append_printf(
    sbp_msg_command_output_t *msg, SBP_BOOL should_trunc, size_t *n_written,
    const char *fmt, ...) {
  SBP_BOOL ret;
  va_list ap;
  va_start(ap, fmt);
...
SBP_BOOL sbp_msg_command_output_line_append_vprintf(
    sbp_msg_command_output_t *msg, SBP_BOOL should_trunc, size_t *n_written,
...
SBP_BOOL sbp_msg_command_output_encode_internal(
...
SBP_BOOL sbp_msg_command_output_decode_internal(sbp_decode_ctx_t *ctx,
...
size_t sbp_msg_network_state_req_encoded_len(
  ...
  (void)msg;
  return SBP_MSG_NETWORK_STATE_REQ_ENCODED_LEN;
}

SBP_BOOL sbp_msg_network_state_req_encode_internal(
...
SBP_BOOL sbp_msg_network_state_req_decode_internal(
...
SBP_BOOL sbp_msg_network_state_resp_encode_internal(
    sbp_encode_ctx_t *ctx, const sbp_msg_network_state_resp_t *msg) {
  size_t i;
  (void)i;
  for (i = 0; i < SBP_MSG_NETWORK_STATE_RESP_IPV4_ADDRESS_MAX; i++) {
  ...
  for (i = 0; i < SBP_MSG_NETWORK_STATE_RESP_IPV6_ADDRESS_MAX; i++) {
  ...
  for (i = 0; i < SBP_MSG_NETWORK_STATE_RESP_INTERFACE_NAME_MAX; i++) {
...
SBP_BOOL sbp_msg_network_state_resp_decode_internal(
...
int sbp_msg_network_state_resp_cmp(const sbp_msg_network_state_resp_t *a,
  ...
  for (i = 0; ret == 0 && i < SBP_MSG_NETWORK_STATE_RESP_IPV4_ADDRESS_MAX;
       i++) {
  ...
  for (i = 0; ret == 0 && i < SBP_MSG_NETWORK_STATE_RESP_IPV6_ADDRESS_MAX;
       i++) {
  ...
  for (i = 0; ret == 0 && i < SBP_MSG_NETWORK_STATE_RESP_INTERFACE_NAME_MAX;
       i++) {
...
SBP_BOOL sbp_network_usage_encode_internal(sbp_encode_ctx_t *ctx,
  ...
  for (i = 0; i < SBP_NETWORK_USAGE_INTERFACE_NAME_MAX; i++) {
    if (!sbp_char_encode(ctx, &msg->interface_name[i])) {
      return SBP_FALSE;
    }
  }
...
SBP_BOOL sbp_network_usage_decode_internal(sbp_decode_ctx_t *ctx,
...
int sbp_network_usage_cmp(const sbp_network_usage_t *a,
  ...
  for (i = 0; ret == 0 && i < SBP_NETWORK_USAGE_INTERFACE_NAME_MAX; i++) {
    ret = sbp_char_cmp(&a->interface_name[i], &b->interface_name[i]);
  }
  if (ret != 0) {
    return ret;
...
SBP_BOOL sbp_msg_network_bandwidth_usage_encode_internal(
    sbp_encode_ctx_t *ctx, const sbp_msg_network_bandwidth_usage_t *msg) {
  size_t i;
  (void)i;
  for (i = 0; i < msg->n_interfaces; i++) {
...
SBP_BOOL sbp_msg_network_bandwidth_usage_decode_internal(
...
int sbp_msg_network_bandwidth_usage_cmp(
  ...
  for (i = 0; ret == 0 && i < a->n_interfaces; i++) {
...
SBP_BOOL sbp_msg_cell_modem_status_encode_internal(
...
SBP_BOOL sbp_msg_cell_modem_status_decode_internal(
...
int sbp_msg_cell_modem_status_cmp(const sbp_msg_cell_modem_status_t *a,
  ...
  for (i = 0; ret == 0 && i < a->n_reserved; i++) {
...
SBP_BOOL sbp_msg_specan_dep_encode_internal(sbp_encode_ctx_t *ctx,
  ...
  for (i = 0; i < msg->n_amplitude_value; i++) {
...
SBP_BOOL sbp_msg_specan_dep_decode_internal(sbp_decode_ctx_t *ctx,
...
int sbp_msg_specan_dep_cmp(const sbp_msg_specan_dep_t *a,
  ...
  for (i = 0; ret == 0 && i < a->n_amplitude_value; i++) {
...
SBP_BOOL sbp_msg_specan_encode_internal(sbp_encode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_specan_decode_internal(sbp_decode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_front_end_gain_encode_internal(
    sbp_encode_ctx_t *ctx, const sbp_msg_front_end_gain_t *msg) {
  size_t i;
  (void)i;
  for (i = 0; i < SBP_MSG_FRONT_END_GAIN_RF_GAIN_MAX; i++) {
    if (!sbp_s8_encode(ctx, &msg->rf_gain[i])) {
      return SBP_FALSE;
    }
  }
  for (i = 0; i < SBP_MSG_FRONT_END_GAIN_IF_GAIN_MAX; i++) {
...
SBP_BOOL sbp_msg_front_end_gain_decode_internal(sbp_decode_ctx_t *ctx,
...
int sbp_msg_front_end_gain_cmp(const sbp_msg_front_end_gain_t *a,
  ...
  for (i = 0; ret == 0 && i < SBP_MSG_FRONT_END_GAIN_RF_GAIN_MAX; i++) {
  ...
  for (i = 0; ret == 0 && i < SBP_MSG_FRONT_END_GAIN_IF_GAIN_MAX; i++) {
