...
SBP_BOOL sbp_msg_fileio_read_req_filename_valid(
...
SBP_BOOL sbp_msg_fileio_read_req_filename_set(sbp_msg_fileio_read_req_t *msg,
                                              const char *new_str,
...
SBP_BOOL sbp_msg_fileio_read_req_filename_set_raw(
    sbp_msg_fileio_read_req_t *msg, const char *new_buf, size_t new_buf_len,
...
SBP_BOOL sbp_msg_fileio_read_req_filename_printf(sbp_msg_fileio_read_req_t *msg,
                                                 SBP_BOOL should_trunc,
                                                 size_t *n_written,
                                                 const char *fmt, ...) {
  SBP_BOOL ret;
  va_list ap;
  va_start(ap, fmt);
  ret = sbp_null_terminated_string_vprintf(&msg->filename,
                                           SBP_MSG_FILEIO_READ_REQ_FILENAME_MAX,
...
SBP_BOOL sbp_msg_fileio_read_req_filename_vprintf(
    sbp_msg_fileio_read_req_t *msg, SBP_BOOL should_trunc, size_t *n_written,
...
SBP_BOOL sbp_msg_fileio_read_req_filename_append_printf(
    sbp_msg_fileio_read_req_t *msg, SBP_BOOL should_trunc, size_t *n_written,
    const char *fmt, ...) {
  SBP_BOOL ret;
  va_list ap;
...
SBP_BOOL sbp_msg_fileio_read_req_filename_append_vprintf(
    sbp_msg_fileio_read_req_t *msg, SBP_BOOL should_trunc, size_t *n_written,
    const char *fmt, va_list ap) {
...
SBP_BOOL sbp_msg_fileio_read_req_encode_internal(
...
SBP_BOOL sbp_msg_fileio_read_req_decode_internal(
    sbp_decode_ctx_t *ctx, sbp_msg_fileio_read_req_t *msg) {
  uint8_t i;
  (void)i;
...
SBP_BOOL sbp_msg_fileio_read_resp_encode_internal(
...
SBP_BOOL sbp_msg_fileio_read_resp_decode_internal(
    sbp_decode_ctx_t *ctx, sbp_msg_fileio_read_resp_t *msg) {
  uint8_t i;
  (void)i;
  if (!sbp_u32_decode(ctx, &msg->sequence)) {
    return SBP_FALSE;
...
SBP_BOOL sbp_msg_fileio_read_dir_req_dirname_valid(
...
SBP_BOOL sbp_msg_fileio_read_dir_req_dirname_set(
    sbp_msg_fileio_read_dir_req_t *msg, const char *new_str,
    SBP_BOOL should_trunc, size_t *n_written) {
...
SBP_BOOL sbp_msg_fileio_read_dir_req_dirname_set_raw(
...
SBP_BOOL sbp_msg_fileio_read_dir_req_dirname_printf(
    sbp_msg_fileio_read_dir_req_t *msg, SBP_BOOL should_trunc,
    size_t *n_written, const char *fmt, ...) {
  SBP_BOOL ret;
  va_list ap;
  va_start(ap, fmt);
  ret = sbp_null_terminated_string_vprintf(
      &msg->dirname, SBP_MSG_FILEIO_READ_DIR_REQ_DIRNAME_MAX, should_trunc,
      n_written, fmt, ap);
  va_end(ap);
  return ret;
...
SBP_BOOL sbp_msg_fileio_read_dir_req_dirname_vprintf(
    sbp_msg_fileio_read_dir_req_t *msg, SBP_BOOL should_trunc,
...
SBP_BOOL sbp_msg_fileio_read_dir_req_dirname_append_printf(
    sbp_msg_fileio_read_dir_req_t *msg, SBP_BOOL should_trunc,
    size_t *n_written, const char *fmt, ...) {
  SBP_BOOL ret;
  va_list ap;
...
SBP_BOOL sbp_msg_fileio_read_dir_req_dirname_append_vprintf(
    sbp_msg_fileio_read_dir_req_t *msg, SBP_BOOL should_trunc,
    size_t *n_written, const char *fmt, va_list ap) {
  return sbp_null_terminated_string_append_vprintf(
      &msg->dirname, SBP_MSG_FILEIO_READ_DIR_REQ_DIRNAME_MAX, should_trunc,
...
SBP_BOOL sbp_msg_fileio_read_dir_req_encode_internal(
...
SBP_BOOL sbp_msg_fileio_read_dir_req_decode_internal(
...
SBP_BOOL sbp_msg_fileio_read_dir_resp_contents_valid(
...
SBP_BOOL sbp_msg_fileio_read_dir_resp_contents_add_section(
...
SBP_BOOL sbp_msg_fileio_read_dir_resp_contents_add_section_printf(
...
SBP_BOOL sbp_msg_fileio_read_dir_resp_contents_add_section_vprintf(
    sbp_msg_fileio_read_dir_resp_t *msg, const char *fmt, va_list ap) {
  return sbp_multipart_string_add_section_vprintf(
      &msg->contents, SBP_MSG_FILEIO_READ_DIR_RESP_CONTENTS_MAX, fmt, ap);
}

SBP_BOOL sbp_msg_fileio_read_dir_resp_contents_append(
...
SBP_BOOL sbp_msg_fileio_read_dir_resp_contents_append_printf(
    sbp_msg_fileio_read_dir_resp_t *msg, const char *fmt, ...) {
  SBP_BOOL ret;
  va_list ap;
  va_start(ap, fmt);
...
SBP_BOOL sbp_msg_fileio_read_dir_resp_contents_append_vprintf(
    sbp_msg_fileio_read_dir_resp_t *msg, const char *fmt, va_list ap) {
...
SBP_BOOL sbp_msg_fileio_read_dir_resp_encode_internal(
...
SBP_BOOL sbp_msg_fileio_read_dir_resp_decode_internal(
...
SBP_BOOL sbp_msg_fileio_remove_filename_valid(
...
SBP_BOOL sbp_msg_fileio_remove_filename_set(sbp_msg_fileio_remove_t *msg,
                                            const char *new_str,
                                            SBP_BOOL should_trunc,
                                            size_t *n_written) {
  return sbp_null_terminated_string_set(&msg->filename,
...
SBP_BOOL sbp_msg_fileio_remove_filename_set_raw(sbp_msg_fileio_remove_t *msg,
                                                const char *new_buf,
                                                size_t new_buf_len,
                                                SBP_BOOL should_trunc,
                                                size_t *n_written) {
...
SBP_BOOL sbp_msg_fileio_remove_filename_printf(sbp_msg_fileio_remove_t *msg,
                                               SBP_BOOL should_trunc,
                                               size_t *n_written,
                                               const char *fmt, ...) {
  SBP_BOOL ret;
...
SBP_BOOL sbp_msg_fileio_remove_filename_vprintf(sbp_msg_fileio_remove_t *msg,
                                                SBP_BOOL should_trunc,
                                                size_t *n_written,
                                                const char *fmt, va_list ap) {
...
SBP_BOOL sbp_msg_fileio_remove_filename_append_printf(
    sbp_msg_fileio_remove_t *msg, SBP_BOOL should_trunc, size_t *n_written,
    const char *fmt, ...) {
  SBP_BOOL ret;
  va_list ap;
  va_start(ap, fmt);
...
SBP_BOOL sbp_msg_fileio_remove_filename_append_vprintf(
    sbp_msg_fileio_remove_t *msg, SBP_BOOL should_trunc, size_t *n_written,
    const char *fmt, va_list ap) {
  return sbp_null_terminated_string_append_vprintf(
      &msg->filename, SBP_MSG_FILEIO_REMOVE_FILENAME_MAX, should_trunc,
...
SBP_BOOL sbp_msg_fileio_remove_encode_internal(
    sbp_encode_ctx_t *ctx, const sbp_msg_fileio_remove_t *msg) {
  size_t i;
  (void)i;
  if (!sbp_null_terminated_string_encode(
...
SBP_BOOL sbp_msg_fileio_remove_decode_internal(sbp_decode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_fileio_write_req_filename_valid(
...
SBP_BOOL sbp_msg_fileio_write_req_filename_set(sbp_msg_fileio_write_req_t *msg,
                                               const char *new_str,
                                               SBP_BOOL should_trunc,
                                               size_t *n_written) {
  return sbp_null_terminated_string_set(&msg->filename,
...
SBP_BOOL sbp_msg_fileio_write_req_filename_set_raw(
...
SBP_BOOL sbp_msg_fileio_write_req_filename_printf(
    sbp_msg_fileio_write_req_t *msg, SBP_BOOL should_trunc, size_t *n_written,
    const char *fmt, ...) {
  SBP_BOOL ret;
  va_list ap;
  va_start(ap, fmt);
...
SBP_BOOL sbp_msg_fileio_write_req_filename_vprintf(
    sbp_msg_fileio_write_req_t *msg, SBP_BOOL should_trunc, size_t *n_written,
    const char *fmt, va_list ap) {
  return sbp_null_terminated_string_vprintf(
      &msg->filename, SBP_MSG_FILEIO_WRITE_REQ_FILENAME_MAX, should_trunc,
...
SBP_BOOL sbp_msg_fileio_write_req_filename_append_printf(
    sbp_msg_fileio_write_req_t *msg, SBP_BOOL should_trunc, size_t *n_written,
    const char *fmt, ...) {
  SBP_BOOL ret;
  va_list ap;
...
SBP_BOOL sbp_msg_fileio_write_req_filename_append_vprintf(
    sbp_msg_fileio_write_req_t *msg, SBP_BOOL should_trunc, size_t *n_written,
    const char *fmt, va_list ap) {
  return sbp_null_terminated_string_append_vprintf(
      &msg->filename, SBP_MSG_FILEIO_WRITE_REQ_FILENAME_MAX, should_trunc,
...
SBP_BOOL sbp_msg_fileio_write_req_encode_internal(
...
SBP_BOOL sbp_msg_fileio_write_req_decode_internal(
    sbp_decode_ctx_t *ctx, sbp_msg_fileio_write_req_t *msg) {
  uint8_t i;
  (void)i;
  if (!sbp_u32_decode(ctx, &msg->sequence)) {
    return SBP_FALSE;
...
SBP_BOOL sbp_msg_fileio_write_resp_encode_internal(
...
SBP_BOOL sbp_msg_fileio_write_resp_decode_internal(
...
size_t sbp_msg_fileio_config_req_encoded_len(
  ...
  (void)msg;
  return SBP_MSG_FILEIO_CONFIG_REQ_ENCODED_LEN;
}

SBP_BOOL sbp_msg_fileio_config_req_encode_internal(
...
SBP_BOOL sbp_msg_fileio_config_req_decode_internal(
...
SBP_BOOL sbp_msg_fileio_config_resp_encode_internal(
...
SBP_BOOL sbp_msg_fileio_config_resp_decode_internal(
