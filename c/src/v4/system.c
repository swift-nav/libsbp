...
SBP_BOOL sbp_msg_startup_encode_internal(sbp_encode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_startup_decode_internal(sbp_decode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_dgnss_status_source_valid(const sbp_msg_dgnss_status_t *msg) {
...
SBP_BOOL sbp_msg_dgnss_status_source_set(sbp_msg_dgnss_status_t *msg,
                                         const char *new_str,
...
SBP_BOOL sbp_msg_dgnss_status_source_set_raw(sbp_msg_dgnss_status_t *msg,
                                             const char *new_buf,
                                             size_t new_buf_len,
                                             SBP_BOOL should_trunc,
                                             size_t *n_written) {
...
SBP_BOOL sbp_msg_dgnss_status_source_printf(sbp_msg_dgnss_status_t *msg,
                                            SBP_BOOL should_trunc,
  ...
  va_list ap;
  va_start(ap, fmt);
  ret = sbp_unterminated_string_vprintf(&msg->source,
                                        SBP_MSG_DGNSS_STATUS_SOURCE_MAX,
...
SBP_BOOL sbp_msg_dgnss_status_source_vprintf(sbp_msg_dgnss_status_t *msg,
                                             SBP_BOOL should_trunc,
                                             size_t *n_written, const char *fmt,
                                             va_list ap) {
...
SBP_BOOL sbp_msg_dgnss_status_source_append_printf(sbp_msg_dgnss_status_t *msg,
                                                   SBP_BOOL should_trunc,
                                                   size_t *n_written,
                                                   const char *fmt, ...) {
  SBP_BOOL ret;
...
SBP_BOOL sbp_msg_dgnss_status_source_append_vprintf(sbp_msg_dgnss_status_t *msg,
                                                    SBP_BOOL should_trunc,
                                                    size_t *n_written,
                                                    const char *fmt,
                                                    va_list ap) {
...
SBP_BOOL sbp_msg_dgnss_status_encode_internal(
    sbp_encode_ctx_t *ctx, const sbp_msg_dgnss_status_t *msg) {
  size_t i;
  (void)i;
...
SBP_BOOL sbp_msg_dgnss_status_decode_internal(sbp_decode_ctx_t *ctx,
...
size_t sbp_msg_heartbeat_encoded_len(const sbp_msg_heartbeat_t *msg) {
  (void)msg;
  return SBP_MSG_HEARTBEAT_ENCODED_LEN;
}

SBP_BOOL sbp_msg_heartbeat_encode_internal(sbp_encode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_heartbeat_decode_internal(sbp_decode_ctx_t *ctx,
...
SBP_BOOL sbp_sub_system_report_encode_internal(
    sbp_encode_ctx_t *ctx, const sbp_sub_system_report_t *msg) {
  size_t i;
  (void)i;
...
SBP_BOOL sbp_sub_system_report_decode_internal(sbp_decode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_status_report_encode_internal(
    sbp_encode_ctx_t *ctx, const sbp_msg_status_report_t *msg) {
  size_t i;
  (void)i;
...
SBP_BOOL sbp_msg_status_report_decode_internal(sbp_decode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_ins_status_encode_internal(sbp_encode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_ins_status_decode_internal(sbp_decode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_csac_telemetry_telemetry_valid(
...
SBP_BOOL sbp_msg_csac_telemetry_telemetry_set(sbp_msg_csac_telemetry_t *msg,
                                              const char *new_str,
                                              SBP_BOOL should_trunc,
                                              size_t *n_written) {
...
SBP_BOOL sbp_msg_csac_telemetry_telemetry_set_raw(sbp_msg_csac_telemetry_t *msg,
                                                  const char *new_buf,
                                                  size_t new_buf_len,
                                                  SBP_BOOL should_trunc,
                                                  size_t *n_written) {
...
SBP_BOOL sbp_msg_csac_telemetry_telemetry_printf(sbp_msg_csac_telemetry_t *msg,
                                                 SBP_BOOL should_trunc,
                                                 size_t *n_written,
                                                 const char *fmt, ...) {
  SBP_BOOL ret;
  va_list ap;
  va_start(ap, fmt);
  ret = sbp_unterminated_string_vprintf(&msg->telemetry,
                                        SBP_MSG_CSAC_TELEMETRY_TELEMETRY_MAX,
                                        should_trunc, n_written, fmt, ap);
  va_end(ap);
  return ret;
...
SBP_BOOL sbp_msg_csac_telemetry_telemetry_vprintf(sbp_msg_csac_telemetry_t *msg,
                                                  SBP_BOOL should_trunc,
                                                  size_t *n_written,
...
SBP_BOOL sbp_msg_csac_telemetry_telemetry_append_printf(
    sbp_msg_csac_telemetry_t *msg, SBP_BOOL should_trunc, size_t *n_written,
    const char *fmt, ...) {
  SBP_BOOL ret;
  va_list ap;
  va_start(ap, fmt);
...
SBP_BOOL sbp_msg_csac_telemetry_telemetry_append_vprintf(
    sbp_msg_csac_telemetry_t *msg, SBP_BOOL should_trunc, size_t *n_written,
    const char *fmt, va_list ap) {
  return sbp_unterminated_string_append_vprintf(
      &msg->telemetry, SBP_MSG_CSAC_TELEMETRY_TELEMETRY_MAX, should_trunc,
...
SBP_BOOL sbp_msg_csac_telemetry_encode_internal(
...
SBP_BOOL sbp_msg_csac_telemetry_decode_internal(sbp_decode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_csac_telemetry_labels_telemetry_labels_valid(
...
SBP_BOOL sbp_msg_csac_telemetry_labels_telemetry_labels_set(
...
SBP_BOOL sbp_msg_csac_telemetry_labels_telemetry_labels_set_raw(
...
SBP_BOOL sbp_msg_csac_telemetry_labels_telemetry_labels_printf(
...
SBP_BOOL sbp_msg_csac_telemetry_labels_telemetry_labels_vprintf(
    sbp_msg_csac_telemetry_labels_t *msg, SBP_BOOL should_trunc,
...
SBP_BOOL sbp_msg_csac_telemetry_labels_telemetry_labels_append_printf(
    sbp_msg_csac_telemetry_labels_t *msg, SBP_BOOL should_trunc,
    size_t *n_written, const char *fmt, ...) {
  SBP_BOOL ret;
  va_list ap;
...
SBP_BOOL sbp_msg_csac_telemetry_labels_telemetry_labels_append_vprintf(
    sbp_msg_csac_telemetry_labels_t *msg, SBP_BOOL should_trunc,
    size_t *n_written, const char *fmt, va_list ap) {
  return sbp_unterminated_string_append_vprintf(
      &msg->telemetry_labels,
...
SBP_BOOL sbp_msg_csac_telemetry_labels_encode_internal(
...
SBP_BOOL sbp_msg_csac_telemetry_labels_decode_internal(
...
size_t sbp_msg_ins_updates_encoded_len(const sbp_msg_ins_updates_t *msg) {
  (void)msg;
  return SBP_MSG_INS_UPDATES_ENCODED_LEN;
}

SBP_BOOL sbp_msg_ins_updates_encode_internal(sbp_encode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_ins_updates_decode_internal(sbp_decode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_gnss_time_offset_encode_internal(
...
SBP_BOOL sbp_msg_gnss_time_offset_decode_internal(
    sbp_decode_ctx_t *ctx, sbp_msg_gnss_time_offset_t *msg) {
  uint8_t i;
  (void)i;
...
size_t sbp_msg_pps_time_encoded_len(const sbp_msg_pps_time_t *msg) {
  (void)msg;
  return SBP_MSG_PPS_TIME_ENCODED_LEN;
}

SBP_BOOL sbp_msg_pps_time_encode_internal(sbp_encode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_pps_time_decode_internal(sbp_decode_ctx_t *ctx,
...
size_t sbp_msg_sensor_aid_event_encoded_len(
    const sbp_msg_sensor_aid_event_t *msg) {
  (void)msg;
  return SBP_MSG_SENSOR_AID_EVENT_ENCODED_LEN;
}

SBP_BOOL sbp_msg_sensor_aid_event_encode_internal(
    sbp_encode_ctx_t *ctx, const sbp_msg_sensor_aid_event_t *msg) {
  size_t i;
  (void)i;
  ...
  if (!sbp_u16_encode(ctx, &msg->sensor_id)) {
    return SBP_FALSE;
  }
  if (!sbp_u8_encode(ctx, &msg->sensor_state)) {
    return SBP_FALSE;
  }
  if (!sbp_u8_encode(ctx, &msg->n_available_meas)) {
    return SBP_FALSE;
  }
  if (!sbp_u8_encode(ctx, &msg->n_attempted_meas)) {
    return SBP_FALSE;
  }
  if (!sbp_u8_encode(ctx, &msg->n_accepted_meas)) {
    return SBP_FALSE;
  }
  if (!sbp_u32_encode(ctx, &msg->flags)) {
    return SBP_FALSE;
...
s8 sbp_msg_sensor_aid_event_encode(uint8_t *buf, uint8_t len,
                                   uint8_t *n_written,
                                   const sbp_msg_sensor_aid_event_t *msg) {
  sbp_encode_ctx_t ctx;
  ctx.buf = buf;
  ctx.buf_len = len;
  ctx.offset = 0;
  if (!sbp_msg_sensor_aid_event_encode_internal(&ctx, msg)) {
    return SBP_ENCODE_ERROR;
  }
  if (n_written != NULL) {
    *n_written = (uint8_t)ctx.offset;
...
SBP_BOOL sbp_msg_sensor_aid_event_decode_internal(
    sbp_decode_ctx_t *ctx, sbp_msg_sensor_aid_event_t *msg) {
  uint8_t i;
  (void)i;
  ...
  if (!sbp_u16_decode(ctx, &msg->sensor_id)) {
    return SBP_FALSE;
  }
  if (!sbp_u8_decode(ctx, &msg->sensor_state)) {
    return SBP_FALSE;
  }
  if (!sbp_u8_decode(ctx, &msg->n_available_meas)) {
    return SBP_FALSE;
  }
  if (!sbp_u8_decode(ctx, &msg->n_attempted_meas)) {
    return SBP_FALSE;
  }
  if (!sbp_u8_decode(ctx, &msg->n_accepted_meas)) {
    return SBP_FALSE;
  }
  if (!sbp_u32_decode(ctx, &msg->flags)) {
    return SBP_FALSE;
...
s8 sbp_msg_sensor_aid_event_decode(const uint8_t *buf, uint8_t len,
                                   uint8_t *n_read,
  ...
  ctx.buf_len = len;
  ctx.offset = 0;
  if (!sbp_msg_sensor_aid_event_decode_internal(&ctx, msg)) {
    return SBP_DECODE_ERROR;
  }
  if (n_read != NULL) {
    *n_read = (uint8_t)ctx.offset;
...
s8 sbp_msg_sensor_aid_event_send(sbp_state_t *s, u16 sender_id,
                                 const sbp_msg_sensor_aid_event_t *msg,
                                 sbp_write_fn_t write) {
  uint8_t payload[SBP_MAX_PAYLOAD_LEN];
  uint8_t payload_len;
  s8 ret = sbp_msg_sensor_aid_event_encode(payload, sizeof(payload),
                                           &payload_len, msg);
  if (ret != SBP_OK) {
    return ret;
  }
...
int sbp_msg_sensor_aid_event_cmp(const sbp_msg_sensor_aid_event_t *a,
                                 const sbp_msg_sensor_aid_event_t *b) {
  int ret = 0;
  uint8_t i;
  (void)i;
  ...
  ret = sbp_u16_cmp(&a->sensor_id, &b->sensor_id);
  if (ret != 0) {
    return ret;
  }

  ret = sbp_u8_cmp(&a->sensor_state, &b->sensor_state);
  if (ret != 0) {
    return ret;
  }

  ret = sbp_u8_cmp(&a->n_available_meas, &b->n_available_meas);
  if (ret != 0) {
    return ret;
  }

  ret = sbp_u8_cmp(&a->n_attempted_meas, &b->n_attempted_meas);
  if (ret != 0) {
    return ret;
  }

  ret = sbp_u8_cmp(&a->n_accepted_meas, &b->n_accepted_meas);
  if (ret != 0) {
    return ret;
  }
...
SBP_BOOL sbp_msg_group_meta_encode_internal(sbp_encode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_group_meta_decode_internal(sbp_decode_ctx_t *ctx,
...
int sbp_msg_group_meta_cmp(const sbp_msg_group_meta_t *a,
  ...
  ret = sbp_u8_cmp(&a->n_group_msgs, &b->n_group_msgs);
  for (i = 0; ret == 0 && i < a->n_group_msgs; i++) {
