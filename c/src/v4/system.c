...
uint8_t sbp_msg_dgnss_status_source_packed_len(
...
const char *sbp_msg_dgnss_status_source_get(
    const sbp_unterminated_string_t *s) {
...
int sbp_msg_dgnss_status_cmp(const sbp_msg_dgnss_status_t *a,
  ...
  ret = sbp_msg_dgnss_status_source_strcmp(&a->source, &b->source);
  if (ret != 0) {
    return ret;
  }
  return ret;
...
int sbp_msg_csac_telemetry_telemetry_strcmp(
...
uint8_t sbp_msg_csac_telemetry_telemetry_packed_len(
    const sbp_unterminated_string_t *s) {
  return sbp_unterminated_string_packed_len(
      s, &sbp_msg_csac_telemetry_ttelemetry_params);
}
...
int sbp_msg_csac_telemetry_cmp(const sbp_msg_csac_telemetry_t *a,
  ...
  ret = sbp_msg_csac_telemetry_telemetry_strcmp(&a->telemetry, &b->telemetry);
  if (ret != 0) {
    return ret;
  }
  return ret;
...
uint8_t sbp_msg_csac_telemetry_labels_telemetry_labels_packed_len(
    const sbp_unterminated_string_t *s) {
  return sbp_unterminated_string_packed_len(
      s, &sbp_msg_csac_telemetry_labels_ttelemetry_labels_params);
}
...
int sbp_msg_csac_telemetry_labels_cmp(
  ...
  ret = sbp_msg_csac_telemetry_labels_telemetry_labels_strcmp(
