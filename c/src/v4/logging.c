...
SBP_BOOL sbp_msg_log_text_valid(const sbp_msg_log_t *msg) {
...
SBP_BOOL sbp_msg_log_text_set(sbp_msg_log_t *msg, const char *new_str,
...
SBP_BOOL sbp_msg_log_text_set_raw(sbp_msg_log_t *msg, const char *new_buf,
                                  size_t new_buf_len, SBP_BOOL should_trunc,
                                  size_t *n_written) {
...
SBP_BOOL sbp_msg_log_text_printf(sbp_msg_log_t *msg, SBP_BOOL should_trunc,
                                 size_t *n_written, const char *fmt, ...) {
  SBP_BOOL ret;
  va_list ap;
  va_start(ap, fmt);
  ret = sbp_unterminated_string_vprintf(&msg->text, SBP_MSG_LOG_TEXT_MAX,
                                        should_trunc, n_written, fmt, ap);
  va_end(ap);
  return ret;
}

SBP_BOOL sbp_msg_log_text_vprintf(sbp_msg_log_t *msg, SBP_BOOL should_trunc,
                                  size_t *n_written, const char *fmt,
                                  va_list ap) {
...
SBP_BOOL sbp_msg_log_text_append_printf(sbp_msg_log_t *msg,
...
SBP_BOOL sbp_msg_log_text_append_vprintf(sbp_msg_log_t *msg,
                                         SBP_BOOL should_trunc,
                                         size_t *n_written, const char *fmt,
                                         va_list ap) {
...
SBP_BOOL sbp_msg_log_encode_internal(sbp_encode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_log_decode_internal(sbp_decode_ctx_t *ctx,
                                     sbp_msg_log_t *msg) {
  uint8_t i;
  (void)i;
...
SBP_BOOL sbp_msg_fwd_encode_internal(sbp_encode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_fwd_decode_internal(sbp_decode_ctx_t *ctx,
                                     sbp_msg_fwd_t *msg) {
  uint8_t i;
  (void)i;
...
int sbp_msg_fwd_cmp(const sbp_msg_fwd_t *a, const sbp_msg_fwd_t *b) {
  ...
  for (i = 0; ret == 0 && i < a->n_fwd_payload; i++) {
...
SBP_BOOL sbp_msg_print_dep_text_valid(const sbp_msg_print_dep_t *msg) {
...
SBP_BOOL sbp_msg_print_dep_text_set(sbp_msg_print_dep_t *msg,
                                    const char *new_str, SBP_BOOL should_trunc,
                                    size_t *n_written) {
  return sbp_unterminated_string_set(&msg->text, SBP_MSG_PRINT_DEP_TEXT_MAX,
                                     should_trunc, n_written, new_str);
}

SBP_BOOL sbp_msg_print_dep_text_set_raw(sbp_msg_print_dep_t *msg,
...
SBP_BOOL sbp_msg_print_dep_text_printf(sbp_msg_print_dep_t *msg,
                                       SBP_BOOL should_trunc, size_t *n_written,
                                       const char *fmt, ...) {
  SBP_BOOL ret;
  va_list ap;
  va_start(ap, fmt);
  ret = sbp_unterminated_string_vprintf(&msg->text, SBP_MSG_PRINT_DEP_TEXT_MAX,
                                        should_trunc, n_written, fmt, ap);
  va_end(ap);
  return ret;
}

SBP_BOOL sbp_msg_print_dep_text_vprintf(sbp_msg_print_dep_t *msg,
                                        SBP_BOOL should_trunc,
                                        size_t *n_written, const char *fmt,
                                        va_list ap) {
...
SBP_BOOL sbp_msg_print_dep_text_append_printf(sbp_msg_print_dep_t *msg,
                                              SBP_BOOL should_trunc,
                                              size_t *n_written,
                                              const char *fmt, ...) {
  SBP_BOOL ret;
...
SBP_BOOL sbp_msg_print_dep_text_append_vprintf(sbp_msg_print_dep_t *msg,
                                               SBP_BOOL should_trunc,
                                               size_t *n_written,
...
SBP_BOOL sbp_msg_print_dep_encode_internal(sbp_encode_ctx_t *ctx,
...
SBP_BOOL sbp_msg_print_dep_decode_internal(sbp_decode_ctx_t *ctx,
