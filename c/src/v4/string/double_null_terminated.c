                                ...
                                size_t max_encoded_len)
{
  ...
  uint8_t cmp_len = max_encoded_len;
...
size_t sbp_double_null_terminated_string_space_remaining(const sbp_string_t *s,
                                             size_t max_encoded_len)
{
  if (!sbp_double_null_terminated_string_valid(s, params) || s->encoded_len == 0) return (uint8_t)(max_encoded_len - 2);
  return (uint8_t)(max_encoded_len - s->encoded_len);
}
...
{
  maybe_init(s, params);
  size_t new_str_len = sbp_strnlen(str, max_encoded_len);
  if (new_str_len == max_encoded_len) return false;
  ...
  if (final_len > max_encoded_len) return false;
                                              ...
                                              va_list ap)
{
  ...
  size_t max_write = (size_t)max_encoded_len - (size_t)s->encoded_len;
                                 ...
                                 const char *new_str)
{
  ...
  size_t max_copy_len = (size_t)(max_encoded_len - s->encoded_len + 1);
                                         ...
                                         va_list ap)
{
  ...
  size_t max_write = (size_t)(max_encoded_len - s->encoded_len + 1);
  size_t max_buf_len = (size_t)(max_encoded_len - s->encoded_len + 1);
...
bool sbp_double_null_terminated_string_decode(sbp_string_t *s, size_t max_encoded_len, sbp_decode_ctx_t *ctx)
{
  ...
  if (copy_len > max_encoded_len) return false;
  memset(s, 0, sizeof(*s));
