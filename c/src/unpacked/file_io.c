...
static const sbp_sequence_string_params_t sbp_msg_fileio_read_dir_resp_tcontents_params = 
{
  .max_packed_len = 251
  ,.terminator = 255
};
...
{
  sbp_sequence_string_init(s, &sbp_msg_fileio_read_dir_resp_tcontents_params);
}

  bool sbp_msg_fileio_read_dir_resp_t_contents_valid(const sbp_sequence_string_t *s)
{
  return sbp_sequence_string_valid(s, &sbp_msg_fileio_read_dir_resp_tcontents_params);
}

  int sbp_msg_fileio_read_dir_resp_t_contents_strcmp(const sbp_sequence_string_t *a, const sbp_sequence_string_t *b)
{
  return sbp_sequence_string_strcmp(a, b, &sbp_msg_fileio_read_dir_resp_tcontents_params);
}

  uint8_t sbp_msg_fileio_read_dir_resp_t_contents_packed_len(const sbp_sequence_string_t *s)
{
  return sbp_sequence_string_packed_len(s, &sbp_msg_fileio_read_dir_resp_tcontents_params);
}

  uint8_t sbp_msg_fileio_read_dir_resp_t_contents_space_remaining(const sbp_sequence_string_t *s)
{
  return sbp_sequence_string_space_remaining(s, &sbp_msg_fileio_read_dir_resp_tcontents_params);
      }
  uint8_t sbp_msg_fileio_read_dir_resp_t_contents_count_sections(const sbp_sequence_string_t *s)
{
  return sbp_sequence_string_count_sections(s, &sbp_msg_fileio_read_dir_resp_tcontents_params);
}

  bool sbp_msg_fileio_read_dir_resp_t_contents_add_section(sbp_sequence_string_t *s, const char *new_str)
{
  return sbp_sequence_string_add_section(s, &sbp_msg_fileio_read_dir_resp_tcontents_params, new_str);
}

  bool sbp_msg_fileio_read_dir_resp_t_contents_add_section_printf(sbp_sequence_string_t *s, const char *fmt, ...) 
{
  va_list ap;
  va_start(ap, fmt);
  bool ret = sbp_sequence_string_add_section_vprintf(s, &sbp_msg_fileio_read_dir_resp_tcontents_params, fmt, ap);
  va_end(ap);
  return ret;
}
...
{
  return sbp_sequence_string_add_section_vprintf(s, &sbp_msg_fileio_read_dir_resp_tcontents_params, fmt, ap);
}

  bool sbp_msg_fileio_read_dir_resp_t_contents_append(sbp_sequence_string_t *s, const char *str)
{
  return sbp_sequence_string_append(s, &sbp_msg_fileio_read_dir_resp_tcontents_params, str);
}

  bool sbp_msg_fileio_read_dir_resp_t_contents_append_printf(sbp_sequence_string_t *s, const char *fmt, ...) 
{
  va_list ap;
  va_start(ap, fmt);
  bool ret = sbp_sequence_string_append_vprintf(s, &sbp_msg_fileio_read_dir_resp_tcontents_params, fmt, ap);
  va_end(ap);
  return ret;
}
...
{
  return sbp_sequence_string_append_vprintf(s, &sbp_msg_fileio_read_dir_resp_tcontents_params, fmt, ap);
}

  const char *sbp_msg_fileio_read_dir_resp_t_contents_get_section(sbp_sequence_string_t *s, uint8_t section)
{
  return sbp_sequence_string_get_section(s, &sbp_msg_fileio_read_dir_resp_tcontents_params, section);
}

  uint8_t sbp_msg_fileio_read_dir_resp_t_contents_section_strlen(sbp_sequence_string_t *s, uint8_t section)
{
  return sbp_sequence_string_section_strlen(s, &sbp_msg_fileio_read_dir_resp_tcontents_params, section);
}

size_t sbp_packed_size_sbp_msg_fileio_read_dir_resp_t(const sbp_msg_fileio_read_dir_resp_t *msg) {
  size_t packed_size = 0;
  packed_size += sbp_packed_size_u32(&msg->sequence);
  packed_size += sbp_sequence_string_packed_len(&msg->contents, &sbp_msg_fileio_read_dir_resp_tcontents_params);
  return packed_size;
}
...
{
  if (!pack_u32(ctx, &msg->sequence)) { return false; }
  if (!sbp_sequence_string_pack(&msg->contents, &sbp_msg_fileio_read_dir_resp_tcontents_params, ctx)) { return false; }
  return true;
}
...
{
  if (!unpack_u32(ctx, &msg->sequence)) { return false; }
  if (!sbp_sequence_string_unpack(&msg->contents, &sbp_msg_fileio_read_dir_resp_tcontents_params, ctx)) { return false; }
  return true;
}
...
int sbp_cmp_sbp_msg_fileio_read_dir_resp_t(const sbp_msg_fileio_read_dir_resp_t *a, const sbp_msg_fileio_read_dir_resp_t *b) {
  ...
  ret = sbp_sequence_string_strcmp(&a->contents, &b->contents, &sbp_msg_fileio_read_dir_resp_tcontents_params);
  if (ret != 0) { return ret; }
  return ret;
}
