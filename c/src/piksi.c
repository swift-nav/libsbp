...
#include <libsbp/internal/piksi.h>
...
s8 sbp_msg_almanac_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgAlmanac, sender_id, payload_len,
                                      payload, write);
}
...
s8 sbp_msg_set_time_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgSetTime, sender_id, payload_len,
                                      payload, write);
}
...
s8 sbp_msg_reset_send(sbp_state_t *s, u16 sender_id, const sbp_msg_reset_t *msg,
  ...
  return sbp_internal_forward_payload(s, SbpMsgReset, sender_id, payload_len,
                                      payload, write);
}
...
s8 sbp_msg_reset_dep_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgResetDep, sender_id, payload_len,
                                      payload, write);
}
...
s8 sbp_msg_cw_results_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgCwResults, sender_id,
...
s8 sbp_msg_cw_start_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgCwStart, sender_id, payload_len,
                                      payload, write);
}
...
s8 sbp_msg_reset_filters_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgResetFilters, sender_id,
                                      payload_len, payload, write);
}
...
s8 sbp_msg_init_base_dep_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgInitBaseDep, sender_id,
                                      payload_len, payload, write);
}
...
s8 sbp_msg_thread_state_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgThreadState, sender_id,
                                      payload_len, payload, write);
}
...
s8 sbp_msg_uart_state_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgUartState, sender_id,
                                      payload_len, payload, write);
}
...
s8 sbp_msg_uart_state_depa_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgUartStateDepa, sender_id,
                                      payload_len, payload, write);
}
...
s8 sbp_msg_iar_state_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgIarState, sender_id, payload_len,
                                      payload, write);
}
...
s8 sbp_msg_mask_satellite_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgMaskSatellite, sender_id,
                                      payload_len, payload, write);
}
...
s8 sbp_msg_mask_satellite_dep_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgMaskSatelliteDep, sender_id,
                                      payload_len, payload, write);
}
...
s8 sbp_msg_device_monitor_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgDeviceMonitor, sender_id,
                                      payload_len, payload, write);
}
...
s8 sbp_msg_command_req_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgCommandReq, sender_id,
                                      payload_len, payload, write);
}
...
s8 sbp_msg_command_resp_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgCommandResp, sender_id,
                                      payload_len, payload, write);
}
...
s8 sbp_msg_command_output_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgCommandOutput, sender_id,
                                      payload_len, payload, write);
}
...
s8 sbp_msg_network_state_req_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgNetworkStateReq, sender_id,
                                      payload_len, payload, write);
}
...
s8 sbp_msg_network_state_resp_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgNetworkStateResp, sender_id,
                                      payload_len, payload, write);
}
...
s8 sbp_msg_network_bandwidth_usage_send(
  ...
  return sbp_internal_forward_payload(s, SbpMsgNetworkBandwidthUsage, sender_id,
                                      payload_len, payload, write);
}
...
int sbp_msg_network_bandwidth_usage_cmp(
  ...
  for (uint8_t i = 0; i < a->n_interfaces; i++) {
...
s8 sbp_msg_cell_modem_status_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgCellModemStatus, sender_id,
                                      payload_len, payload, write);
}
...
int sbp_msg_cell_modem_status_cmp(const sbp_msg_cell_modem_status_t *a,
  ...
  for (uint8_t i = 0; i < a->n_reserved; i++) {
...
s8 sbp_msg_specan_dep_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgSpecanDep, sender_id,
                                      payload_len, payload, write);
}
...
int sbp_msg_specan_dep_cmp(const sbp_msg_specan_dep_t *a,
  ...
  for (uint8_t i = 0; i < a->n_amplitude_value; i++) {
...
s8 sbp_msg_specan_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgSpecan, sender_id, payload_len,
                                      payload, write);
}
...
s8 sbp_msg_front_end_gain_send(sbp_state_t *s, u16 sender_id,
  ...
  return sbp_internal_forward_payload(s, SbpMsgFrontEndGain, sender_id,
                                      payload_len, payload, write);
}
