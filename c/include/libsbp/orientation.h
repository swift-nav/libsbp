...
#define SBP_BASELINE_HEADING_FLAGS_FIX_MODE_GET(flags) \
  (((flags) >> SBP_BASELINE_HEADING_FLAGS_FIX_MODE_SHIFT) & SBP_BASELINE_HEADING_FLAGS_FIX_MODE_MASK)
#define SBP_BASELINE_HEADING_FLAGS_FIX_MODE_SET(flags, val) \
  do \
  { \
    ((flags) |= \
     (((val) & (SBP_BASELINE_HEADING_FLAGS_FIX_MODE_MASK)) << (SBP_BASELINE_HEADING_FLAGS_FIX_MODE_SHIFT))); \
  } while (0)
...
#define SBP_ORIENT_QUAT_FLAGS_INS_NAVIGATION_MODE_GET(flags) \
  (((flags) >> SBP_ORIENT_QUAT_FLAGS_INS_NAVIGATION_MODE_SHIFT) & SBP_ORIENT_QUAT_FLAGS_INS_NAVIGATION_MODE_MASK)
...
{
  (void)msg;
  return 0 + sizeof(msg->tow) + sizeof(msg->w) + sizeof(msg->x) + sizeof(msg->y) + sizeof(msg->z) +
         sizeof(msg->w_accuracy) + sizeof(msg->x_accuracy) + sizeof(msg->y_accuracy) + sizeof(msg->z_accuracy) +
         sizeof(msg->flags);
}
...
#define SBP_ORIENT_EULER_FLAGS_INS_NAVIGATION_MODE_GET(flags) \
  (((flags) >> SBP_ORIENT_EULER_FLAGS_INS_NAVIGATION_MODE_SHIFT) & SBP_ORIENT_EULER_FLAGS_INS_NAVIGATION_MODE_MASK)
...
{
  (void)msg;
  return 0 + sizeof(msg->tow) + sizeof(msg->roll) + sizeof(msg->pitch) + sizeof(msg->yaw) + sizeof(msg->roll_accuracy) +
         sizeof(msg->pitch_accuracy) + sizeof(msg->yaw_accuracy) + sizeof(msg->flags);
}
...
#define SBP_ANGULAR_RATE_FLAGS_INS_NAVIGATION_MODE_GET(flags) \
  (((flags) >> SBP_ANGULAR_RATE_FLAGS_INS_NAVIGATION_MODE_SHIFT) & SBP_ANGULAR_RATE_FLAGS_INS_NAVIGATION_MODE_MASK)
...
{
  (void)msg;
  return 0 + sizeof(msg->tow) + sizeof(msg->x) + sizeof(msg->y) + sizeof(msg->z) + sizeof(msg->flags);
}
