...
#define SBP_STARTUP_CAUSE_CAUSE_OF_STARTUP_GET(flags)      \
  (((flags) >> SBP_STARTUP_CAUSE_CAUSE_OF_STARTUP_SHIFT) & \
   SBP_STARTUP_CAUSE_CAUSE_OF_STARTUP_MASK)
#define SBP_STARTUP_CAUSE_CAUSE_OF_STARTUP_SET(flags, val)           \
  do {                                                               \
    ((flags) |= (((val) & (SBP_STARTUP_CAUSE_CAUSE_OF_STARTUP_MASK)) \
                 << (SBP_STARTUP_CAUSE_CAUSE_OF_STARTUP_SHIFT)));    \
  } while (0)
...
#define SBP_STARTUP_STARTUP_TYPE__GET(flags)      \
  (((flags) >> SBP_STARTUP_STARTUP_TYPE__SHIFT) & \
   SBP_STARTUP_STARTUP_TYPE__MASK)
#define SBP_STARTUP_STARTUP_TYPE__SET(flags, val)           \
  do {                                                      \
    ((flags) |= (((val) & (SBP_STARTUP_STARTUP_TYPE__MASK)) \
                 << (SBP_STARTUP_STARTUP_TYPE__SHIFT)));    \
  } while (0)
...
static inline size_t sbp_packed_size_sbp_msg_startup_t(
    const sbp_msg_startup_t *msg) {
  (void)msg;
  return 0 + sizeof(msg->cause) + sizeof(msg->startup_type) +
         sizeof(msg->reserved);
}

static inline bool sbp_pack_sbp_msg_startup_t(u8 *buf, size_t len,
                                              const sbp_msg_startup_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
...
static inline bool sbp_unpack_sbp_msg_startup_t(const u8 *buf, size_t len,
...
#define SBP_DGNSS_STATUS_FLAGS_DIFFERENTIAL_TYPE_GET(flags)      \
  (((flags) >> SBP_DGNSS_STATUS_FLAGS_DIFFERENTIAL_TYPE_SHIFT) & \
   SBP_DGNSS_STATUS_FLAGS_DIFFERENTIAL_TYPE_MASK)
#define SBP_DGNSS_STATUS_FLAGS_DIFFERENTIAL_TYPE_SET(flags, val)           \
  do {                                                                     \
    ((flags) |= (((val) & (SBP_DGNSS_STATUS_FLAGS_DIFFERENTIAL_TYPE_MASK)) \
                 << (SBP_DGNSS_STATUS_FLAGS_DIFFERENTIAL_TYPE_SHIFT)));    \
  } while (0)
...
static inline bool sbp_pack_sbp_msg_dgnss_status_t(
    u8 *buf, size_t len, const sbp_msg_dgnss_status_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_unpack_sbp_msg_dgnss_status_t(
    const u8 *buf, size_t len, sbp_msg_dgnss_status_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
#define SBP_HEARTBEAT_FLAGS_EXTERNAL_ANTENNA_PRESENT_GET(flags)      \
  (((flags) >> SBP_HEARTBEAT_FLAGS_EXTERNAL_ANTENNA_PRESENT_SHIFT) & \
   SBP_HEARTBEAT_FLAGS_EXTERNAL_ANTENNA_PRESENT_MASK)
...
#define SBP_HEARTBEAT_FLAGS_EXTERNAL_ANTENNA_PRESENT_NO_EXTERNAL_ANTENNA_DETECTED \
  (0)
#define SBP_HEARTBEAT_FLAGS_EXTERNAL_ANTENNA_PRESENT_EXTERNAL_ANTENNA_IS_PRESENT \
  (1)
...
#define SBP_HEARTBEAT_FLAGS_EXTERNAL_ANTENNA_SHORT_GET(flags)      \
  (((flags) >> SBP_HEARTBEAT_FLAGS_EXTERNAL_ANTENNA_SHORT_SHIFT) & \
   SBP_HEARTBEAT_FLAGS_EXTERNAL_ANTENNA_SHORT_MASK)
...
#define SBP_HEARTBEAT_FLAGS_SBP_MAJOR_PROTOCOL_VERSION_NUMBER_SET(flags, val) \
  do {                                                                        \
    ((flags) |=                                                               \
     (((val) & (SBP_HEARTBEAT_FLAGS_SBP_MAJOR_PROTOCOL_VERSION_NUMBER_MASK))  \
...
#define SBP_HEARTBEAT_FLAGS_SBP_MINOR_PROTOCOL_VERSION_NUMBER_SET(flags, val) \
  do {                                                                        \
    ((flags) |=                                                               \
     (((val) & (SBP_HEARTBEAT_FLAGS_SBP_MINOR_PROTOCOL_VERSION_NUMBER_MASK))  \
...
#define SBP_HEARTBEAT_FLAGS_SWIFTNAP_ERROR_GET(flags)      \
  (((flags) >> SBP_HEARTBEAT_FLAGS_SWIFTNAP_ERROR_SHIFT) & \
   SBP_HEARTBEAT_FLAGS_SWIFTNAP_ERROR_MASK)
#define SBP_HEARTBEAT_FLAGS_SWIFTNAP_ERROR_SET(flags, val)           \
  do {                                                               \
    ((flags) |= (((val) & (SBP_HEARTBEAT_FLAGS_SWIFTNAP_ERROR_MASK)) \
                 << (SBP_HEARTBEAT_FLAGS_SWIFTNAP_ERROR_SHIFT)));    \
  } while (0)

#define SBP_HEARTBEAT_FLAGS_SWIFTNAP_ERROR_SYSTEM_HEALTHY (0)
#define SBP_HEARTBEAT_FLAGS_SWIFTNAP_ERROR_AN_ERROR_HAS_OCCURRED_IN_THE_SWIFTNAP \
  (1)
...
#define SBP_HEARTBEAT_FLAGS_IO_ERROR_GET(flags)      \
  (((flags) >> SBP_HEARTBEAT_FLAGS_IO_ERROR_SHIFT) & \
   SBP_HEARTBEAT_FLAGS_IO_ERROR_MASK)
#define SBP_HEARTBEAT_FLAGS_IO_ERROR_SET(flags, val)           \
  do {                                                         \
    ((flags) |= (((val) & (SBP_HEARTBEAT_FLAGS_IO_ERROR_MASK)) \
                 << (SBP_HEARTBEAT_FLAGS_IO_ERROR_SHIFT)));    \
  } while (0)
...
#define SBP_HEARTBEAT_FLAGS_SYSTEM_ERROR_FLAG_GET(flags)      \
  (((flags) >> SBP_HEARTBEAT_FLAGS_SYSTEM_ERROR_FLAG_SHIFT) & \
   SBP_HEARTBEAT_FLAGS_SYSTEM_ERROR_FLAG_MASK)
#define SBP_HEARTBEAT_FLAGS_SYSTEM_ERROR_FLAG_SET(flags, val)           \
  do {                                                                  \
    ((flags) |= (((val) & (SBP_HEARTBEAT_FLAGS_SYSTEM_ERROR_FLAG_MASK)) \
                 << (SBP_HEARTBEAT_FLAGS_SYSTEM_ERROR_FLAG_SHIFT)));    \
  } while (0)
...
static inline size_t sbp_packed_size_sbp_msg_heartbeat_t(
    const sbp_msg_heartbeat_t *msg) {
  (void)msg;
  return 0 + sizeof(msg->flags);
}

static inline bool sbp_pack_sbp_msg_heartbeat_t(
    u8 *buf, size_t len, const sbp_msg_heartbeat_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_unpack_sbp_msg_heartbeat_t(const u8 *buf, size_t len,
...
#define SBP_STATUS_REPORT_REPORTING_SYSTEM_SYSTEM_GET(flags)      \
  (((flags) >> SBP_STATUS_REPORT_REPORTING_SYSTEM_SYSTEM_SHIFT) & \
   SBP_STATUS_REPORT_REPORTING_SYSTEM_SYSTEM_MASK)
...
#define SBP_STATUS_REPORT_SBP_VERSION_SBP_MAJOR_PROTOCOL_VERSION_NUMBER_MASK \
  (0x1ff)
#define SBP_STATUS_REPORT_SBP_VERSION_SBP_MAJOR_PROTOCOL_VERSION_NUMBER_SHIFT \
  (8u)
#define SBP_STATUS_REPORT_SBP_VERSION_SBP_MAJOR_PROTOCOL_VERSION_NUMBER_GET( \
    flags)                                                                   \
  (((flags) >>                                                               \
...
#define SBP_STATUS_REPORT_SBP_VERSION_SBP_MAJOR_PROTOCOL_VERSION_NUMBER_SET(        \
    flags, val)                                                                     \
  do {                                                                              \
    ((flags) |=                                                                     \
     (((val) &                                                                      \
...
#define SBP_STATUS_REPORT_SBP_VERSION_SBP_MINOR_PROTOCOL_VERSION_NUMBER_MASK \
  (0xff)
#define SBP_STATUS_REPORT_SBP_VERSION_SBP_MINOR_PROTOCOL_VERSION_NUMBER_SHIFT \
  (0u)
#define SBP_STATUS_REPORT_SBP_VERSION_SBP_MINOR_PROTOCOL_VERSION_NUMBER_GET( \
    flags)                                                                   \
  (((flags) >>                                                               \
...
#define SBP_STATUS_REPORT_SBP_VERSION_SBP_MINOR_PROTOCOL_VERSION_NUMBER_SET(        \
    flags, val)                                                                     \
  do {                                                                              \
    ((flags) |=                                                                     \
     (((val) &                                                                      \
...
#define SBP_STATUS_REPORT_STATUS_COMPONENT_SUBSYSTEM_GET(flags)      \
  (((flags) >> SBP_STATUS_REPORT_STATUS_COMPONENT_SUBSYSTEM_SHIFT) & \
   SBP_STATUS_REPORT_STATUS_COMPONENT_SUBSYSTEM_MASK)
...
#define SBP_STATUS_REPORT_STATUS_COMPONENT_SUBSYSTEM_DIFFERENTIAL_GNSS_ENGINE \
  (3)
...
#define SBP_STATUS_REPORT_STATUS_GENERIC_GENERIC_GET(flags)      \
  (((flags) >> SBP_STATUS_REPORT_STATUS_GENERIC_GENERIC_SHIFT) & \
   SBP_STATUS_REPORT_STATUS_GENERIC_GENERIC_MASK)
#define SBP_STATUS_REPORT_STATUS_GENERIC_GENERIC_SET(flags, val)           \
  do {                                                                     \
    ((flags) |= (((val) & (SBP_STATUS_REPORT_STATUS_GENERIC_GENERIC_MASK)) \
                 << (SBP_STATUS_REPORT_STATUS_GENERIC_GENERIC_SHIFT)));    \
  } while (0)
...
static inline size_t sbp_packed_size_sbp_msg_status_report_t(
    const sbp_msg_status_report_t *msg) {
  (void)msg;
  return 0 + sizeof(msg->reporting_system) + sizeof(msg->sbp_version) +
         sizeof(msg->sequence) + sizeof(msg->uptime) +
         (msg->n_status *
          (0 + sizeof(msg->status[0].component) +
           sizeof(msg->status[0].generic) + sizeof(msg->status[0].specific)));
}

static inline bool sbp_pack_sbp_msg_status_report_t(
    u8 *buf, size_t len, const sbp_msg_status_report_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
  ...
  offset += 4;
  for (size_t msgstatus_idx = 0; msgstatus_idx < (size_t)msg->n_status;
       msgstatus_idx++) {
    if (offset + 2 > len) {
      return false;
    }
...
static inline bool sbp_unpack_sbp_msg_status_report_t(
    const u8 *buf, size_t len, sbp_msg_status_report_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
  ...
  for (size_t msgstatus_idx = 0; msgstatus_idx < msg->n_status;
       msgstatus_idx++) {
    if (offset + 2 > len) {
      return false;
    }
    memcpy(&msg->status[msgstatus_idx].component, buf + offset, 2);
    msg->status[msgstatus_idx].component =
        le16toh(msg->status[msgstatus_idx].component);
    offset += 2;
...
#define SBP_INS_STATUS_FLAGS_INS_TYPE_GET(flags)      \
  (((flags) >> SBP_INS_STATUS_FLAGS_INS_TYPE_SHIFT) & \
   SBP_INS_STATUS_FLAGS_INS_TYPE_MASK)
#define SBP_INS_STATUS_FLAGS_INS_TYPE_SET(flags, val)           \
  do {                                                          \
    ((flags) |= (((val) & (SBP_INS_STATUS_FLAGS_INS_TYPE_MASK)) \
                 << (SBP_INS_STATUS_FLAGS_INS_TYPE_SHIFT)));    \
  } while (0)
...
#define SBP_INS_STATUS_FLAGS_MOTION_STATE_GET(flags)      \
  (((flags) >> SBP_INS_STATUS_FLAGS_MOTION_STATE_SHIFT) & \
   SBP_INS_STATUS_FLAGS_MOTION_STATE_MASK)
#define SBP_INS_STATUS_FLAGS_MOTION_STATE_SET(flags, val)           \
  do {                                                              \
    ((flags) |= (((val) & (SBP_INS_STATUS_FLAGS_MOTION_STATE_MASK)) \
                 << (SBP_INS_STATUS_FLAGS_MOTION_STATE_SHIFT)));    \
  } while (0)
...
#define SBP_INS_STATUS_FLAGS_ODOMETRY_SYNCH_GET(flags)      \
  (((flags) >> SBP_INS_STATUS_FLAGS_ODOMETRY_SYNCH_SHIFT) & \
   SBP_INS_STATUS_FLAGS_ODOMETRY_SYNCH_MASK)
#define SBP_INS_STATUS_FLAGS_ODOMETRY_SYNCH_SET(flags, val)           \
  do {                                                                \
    ((flags) |= (((val) & (SBP_INS_STATUS_FLAGS_ODOMETRY_SYNCH_MASK)) \
                 << (SBP_INS_STATUS_FLAGS_ODOMETRY_SYNCH_SHIFT)));    \
  } while (0)
...
#define SBP_INS_STATUS_FLAGS_ODOMETRY_STATUS_GET(flags)      \
  (((flags) >> SBP_INS_STATUS_FLAGS_ODOMETRY_STATUS_SHIFT) & \
   SBP_INS_STATUS_FLAGS_ODOMETRY_STATUS_MASK)
#define SBP_INS_STATUS_FLAGS_ODOMETRY_STATUS_SET(flags, val)           \
  do {                                                                 \
    ((flags) |= (((val) & (SBP_INS_STATUS_FLAGS_ODOMETRY_STATUS_MASK)) \
                 << (SBP_INS_STATUS_FLAGS_ODOMETRY_STATUS_SHIFT)));    \
  } while (0)

#define SBP_INS_STATUS_FLAGS_ODOMETRY_STATUS_NO_ODOMETRY (0)
#define SBP_INS_STATUS_FLAGS_ODOMETRY_STATUS_ODOMETRY_RECEIVED_WITHIN_LAST_SECOND \
  (1)
#define SBP_INS_STATUS_FLAGS_ODOMETRY_STATUS_ODOMETRY_NOT_RECEIVED_WITHIN_LAST_SECOND \
  (2)
...
#define SBP_INS_STATUS_FLAGS_INS_ERROR_GET(flags)      \
  (((flags) >> SBP_INS_STATUS_FLAGS_INS_ERROR_SHIFT) & \
   SBP_INS_STATUS_FLAGS_INS_ERROR_MASK)
#define SBP_INS_STATUS_FLAGS_INS_ERROR_SET(flags, val)           \
  do {                                                           \
    ((flags) |= (((val) & (SBP_INS_STATUS_FLAGS_INS_ERROR_MASK)) \
                 << (SBP_INS_STATUS_FLAGS_INS_ERROR_SHIFT)));    \
  } while (0)
...
#define SBP_INS_STATUS_FLAGS_GNSS_FIX_GET(flags)      \
  (((flags) >> SBP_INS_STATUS_FLAGS_GNSS_FIX_SHIFT) & \
   SBP_INS_STATUS_FLAGS_GNSS_FIX_MASK)
#define SBP_INS_STATUS_FLAGS_GNSS_FIX_SET(flags, val)           \
  do {                                                          \
    ((flags) |= (((val) & (SBP_INS_STATUS_FLAGS_GNSS_FIX_MASK)) \
                 << (SBP_INS_STATUS_FLAGS_GNSS_FIX_SHIFT)));    \
  } while (0)
...
#define SBP_INS_STATUS_FLAGS_MODE_GET(flags)      \
  (((flags) >> SBP_INS_STATUS_FLAGS_MODE_SHIFT) & \
   SBP_INS_STATUS_FLAGS_MODE_MASK)
#define SBP_INS_STATUS_FLAGS_MODE_SET(flags, val)           \
  do {                                                      \
    ((flags) |= (((val) & (SBP_INS_STATUS_FLAGS_MODE_MASK)) \
                 << (SBP_INS_STATUS_FLAGS_MODE_SHIFT)));    \
  } while (0)
...
static inline size_t sbp_packed_size_sbp_msg_ins_status_t(
    const sbp_msg_ins_status_t *msg) {
  (void)msg;
  return 0 + sizeof(msg->flags);
}

static inline bool sbp_pack_sbp_msg_ins_status_t(
    u8 *buf, size_t len, const sbp_msg_ins_status_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_unpack_sbp_msg_ins_status_t(const u8 *buf, size_t len,
...
static inline bool sbp_pack_sbp_msg_csac_telemetry_t(
    u8 *buf, size_t len, const sbp_msg_csac_telemetry_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_unpack_sbp_msg_csac_telemetry_t(
    const u8 *buf, size_t len, sbp_msg_csac_telemetry_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_pack_sbp_msg_csac_telemetry_labels_t(
    u8 *buf, size_t len, const sbp_msg_csac_telemetry_labels_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_unpack_sbp_msg_csac_telemetry_labels_t(
    const u8 *buf, size_t len, sbp_msg_csac_telemetry_labels_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
#define SBP_INS_UPDATES_GNSSPOS_NUMBER_OF_ATTEMPTED_GNSS_POSITION_UPDATES_SINCE_LAST_MESSAGE_MASK \
  (0xf)
#define SBP_INS_UPDATES_GNSSPOS_NUMBER_OF_ATTEMPTED_GNSS_POSITION_UPDATES_SINCE_LAST_MESSAGE_SHIFT \
  (4u)
#define SBP_INS_UPDATES_GNSSPOS_NUMBER_OF_ATTEMPTED_GNSS_POSITION_UPDATES_SINCE_LAST_MESSAGE_GET( \
    flags)                                                                                        \
  (((flags) >>                                                                                    \
...
#define SBP_INS_UPDATES_GNSSPOS_NUMBER_OF_ATTEMPTED_GNSS_POSITION_UPDATES_SINCE_LAST_MESSAGE_SET(        \
    flags, val)                                                                                          \
  do {                                                                                                   \
    ((flags) |=                                                                                          \
     (((val) &                                                                                           \
...
#define SBP_INS_UPDATES_GNSSPOS_NUMBER_OF_REJECTED_GNSS_POSITION_UPDATES_SINCE_LAST_MESSAGE_MASK \
  (0xf)
#define SBP_INS_UPDATES_GNSSPOS_NUMBER_OF_REJECTED_GNSS_POSITION_UPDATES_SINCE_LAST_MESSAGE_SHIFT \
  (0u)
#define SBP_INS_UPDATES_GNSSPOS_NUMBER_OF_REJECTED_GNSS_POSITION_UPDATES_SINCE_LAST_MESSAGE_GET( \
    flags)                                                                                       \
  (((flags) >>                                                                                   \
...
#define SBP_INS_UPDATES_GNSSPOS_NUMBER_OF_REJECTED_GNSS_POSITION_UPDATES_SINCE_LAST_MESSAGE_SET(        \
    flags, val)                                                                                         \
  do {                                                                                                  \
    ((flags) |=                                                                                         \
     (((val) &                                                                                          \
...
#define SBP_INS_UPDATES_GNSSVEL_NUMBER_OF_ATTEMPTED_GNSS_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_MASK \
  (0xf)
#define SBP_INS_UPDATES_GNSSVEL_NUMBER_OF_ATTEMPTED_GNSS_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_SHIFT \
  (4u)
#define SBP_INS_UPDATES_GNSSVEL_NUMBER_OF_ATTEMPTED_GNSS_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_GET( \
    flags)                                                                                        \
  (((flags) >>                                                                                    \
...
#define SBP_INS_UPDATES_GNSSVEL_NUMBER_OF_ATTEMPTED_GNSS_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_SET(        \
    flags, val)                                                                                          \
  do {                                                                                                   \
    ((flags) |=                                                                                          \
     (((val) &                                                                                           \
...
#define SBP_INS_UPDATES_GNSSVEL_NUMBER_OF_REJECTED_GNSS_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_MASK \
  (0xf)
#define SBP_INS_UPDATES_GNSSVEL_NUMBER_OF_REJECTED_GNSS_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_SHIFT \
  (0u)
#define SBP_INS_UPDATES_GNSSVEL_NUMBER_OF_REJECTED_GNSS_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_GET( \
    flags)                                                                                       \
  (((flags) >>                                                                                   \
...
#define SBP_INS_UPDATES_GNSSVEL_NUMBER_OF_REJECTED_GNSS_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_SET(        \
    flags, val)                                                                                         \
  do {                                                                                                  \
    ((flags) |=                                                                                         \
     (((val) &                                                                                          \
...
#define SBP_INS_UPDATES_WHEELTICKS_NUMBER_OF_ATTEMPTED_WHEELTICK_UPDATES_SINCE_LAST_MESSAGE_MASK \
  (0xf)
#define SBP_INS_UPDATES_WHEELTICKS_NUMBER_OF_ATTEMPTED_WHEELTICK_UPDATES_SINCE_LAST_MESSAGE_SHIFT \
  (4u)
#define SBP_INS_UPDATES_WHEELTICKS_NUMBER_OF_ATTEMPTED_WHEELTICK_UPDATES_SINCE_LAST_MESSAGE_GET( \
    flags)                                                                                       \
  (((flags) >>                                                                                   \
...
#define SBP_INS_UPDATES_WHEELTICKS_NUMBER_OF_ATTEMPTED_WHEELTICK_UPDATES_SINCE_LAST_MESSAGE_SET(        \
    flags, val)                                                                                         \
  do {                                                                                                  \
    ((flags) |=                                                                                         \
     (((val) &                                                                                          \
...
#define SBP_INS_UPDATES_WHEELTICKS_NUMBER_OF_REJECTED_WHEELTICK_UPDATES_SINCE_LAST_MESSAGE_MASK \
  (0xf)
#define SBP_INS_UPDATES_WHEELTICKS_NUMBER_OF_REJECTED_WHEELTICK_UPDATES_SINCE_LAST_MESSAGE_SHIFT \
  (0u)
#define SBP_INS_UPDATES_WHEELTICKS_NUMBER_OF_REJECTED_WHEELTICK_UPDATES_SINCE_LAST_MESSAGE_GET( \
    flags)                                                                                      \
  (((flags) >>                                                                                  \
...
#define SBP_INS_UPDATES_WHEELTICKS_NUMBER_OF_REJECTED_WHEELTICK_UPDATES_SINCE_LAST_MESSAGE_SET(        \
    flags, val)                                                                                        \
  do {                                                                                                 \
    ((flags) |=                                                                                        \
     (((val) &                                                                                         \
...
#define SBP_INS_UPDATES_SPEED_NUMBER_OF_ATTEMPTED_SPEED_UPDATES_SINCE_LAST_MESSAGE_MASK \
  (0xf)
#define SBP_INS_UPDATES_SPEED_NUMBER_OF_ATTEMPTED_SPEED_UPDATES_SINCE_LAST_MESSAGE_SHIFT \
  (4u)
#define SBP_INS_UPDATES_SPEED_NUMBER_OF_ATTEMPTED_SPEED_UPDATES_SINCE_LAST_MESSAGE_GET( \
    flags)                                                                              \
  (((flags) >>                                                                          \
...
#define SBP_INS_UPDATES_SPEED_NUMBER_OF_ATTEMPTED_SPEED_UPDATES_SINCE_LAST_MESSAGE_SET(        \
    flags, val)                                                                                \
  do {                                                                                         \
    ((flags) |=                                                                                \
     (((val) &                                                                                 \
...
#define SBP_INS_UPDATES_SPEED_NUMBER_OF_REJECTED_SPEED_UPDATES_SINCE_LAST_MESSAGE_MASK \
  (0xf)
#define SBP_INS_UPDATES_SPEED_NUMBER_OF_REJECTED_SPEED_UPDATES_SINCE_LAST_MESSAGE_SHIFT \
  (0u)
#define SBP_INS_UPDATES_SPEED_NUMBER_OF_REJECTED_SPEED_UPDATES_SINCE_LAST_MESSAGE_GET( \
    flags)                                                                             \
  (((flags) >>                                                                         \
...
#define SBP_INS_UPDATES_SPEED_NUMBER_OF_REJECTED_SPEED_UPDATES_SINCE_LAST_MESSAGE_SET(        \
    flags, val)                                                                               \
  do {                                                                                        \
    ((flags) |=                                                                               \
     (((val) &                                                                                \
...
#define SBP_INS_UPDATES_NHC_NUMBER_OF_ATTEMPTED_NHC_UPDATES_SINCE_LAST_MESSAGE_MASK \
  (0xf)
#define SBP_INS_UPDATES_NHC_NUMBER_OF_ATTEMPTED_NHC_UPDATES_SINCE_LAST_MESSAGE_SHIFT \
  (4u)
#define SBP_INS_UPDATES_NHC_NUMBER_OF_ATTEMPTED_NHC_UPDATES_SINCE_LAST_MESSAGE_GET( \
    flags)                                                                          \
  (((flags) >>                                                                      \
...
#define SBP_INS_UPDATES_NHC_NUMBER_OF_ATTEMPTED_NHC_UPDATES_SINCE_LAST_MESSAGE_SET(        \
    flags, val)                                                                            \
  do {                                                                                     \
    ((flags) |=                                                                            \
     (((val) &                                                                             \
...
#define SBP_INS_UPDATES_NHC_NUMBER_OF_REJECTED_NHC_UPDATES_SINCE_LAST_MESSAGE_MASK \
  (0xf)
#define SBP_INS_UPDATES_NHC_NUMBER_OF_REJECTED_NHC_UPDATES_SINCE_LAST_MESSAGE_SHIFT \
  (0u)
#define SBP_INS_UPDATES_NHC_NUMBER_OF_REJECTED_NHC_UPDATES_SINCE_LAST_MESSAGE_GET( \
    flags)                                                                         \
  (((flags) >>                                                                     \
...
#define SBP_INS_UPDATES_NHC_NUMBER_OF_REJECTED_NHC_UPDATES_SINCE_LAST_MESSAGE_SET(        \
    flags, val)                                                                           \
  do {                                                                                    \
    ((flags) |=                                                                           \
     (((val) &                                                                            \
...
#define SBP_INS_UPDATES_ZEROVEL_NUMBER_OF_ATTEMPTED_ZERO_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_MASK \
  (0xf)
#define SBP_INS_UPDATES_ZEROVEL_NUMBER_OF_ATTEMPTED_ZERO_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_SHIFT \
  (4u)
#define SBP_INS_UPDATES_ZEROVEL_NUMBER_OF_ATTEMPTED_ZERO_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_GET( \
    flags)                                                                                        \
  (((flags) >>                                                                                    \
...
#define SBP_INS_UPDATES_ZEROVEL_NUMBER_OF_ATTEMPTED_ZERO_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_SET(        \
    flags, val)                                                                                          \
  do {                                                                                                   \
    ((flags) |=                                                                                          \
     (((val) &                                                                                           \
...
#define SBP_INS_UPDATES_ZEROVEL_NUMBER_OF_REJECTED_ZERO_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_MASK \
  (0xf)
#define SBP_INS_UPDATES_ZEROVEL_NUMBER_OF_REJECTED_ZERO_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_SHIFT \
  (0u)
#define SBP_INS_UPDATES_ZEROVEL_NUMBER_OF_REJECTED_ZERO_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_GET( \
    flags)                                                                                       \
  (((flags) >>                                                                                   \
...
#define SBP_INS_UPDATES_ZEROVEL_NUMBER_OF_REJECTED_ZERO_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_SET(        \
    flags, val)                                                                                         \
  do {                                                                                                  \
    ((flags) |=                                                                                         \
     (((val) &                                                                                          \
...
static inline size_t sbp_packed_size_sbp_msg_ins_updates_t(
    const sbp_msg_ins_updates_t *msg) {
  (void)msg;
  return 0 + sizeof(msg->tow) + sizeof(msg->gnsspos) + sizeof(msg->gnssvel) +
         sizeof(msg->wheelticks) + sizeof(msg->speed) + sizeof(msg->nhc) +
         sizeof(msg->zerovel);
}

static inline bool sbp_pack_sbp_msg_ins_updates_t(
    u8 *buf, size_t len, const sbp_msg_ins_updates_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_unpack_sbp_msg_ins_updates_t(
    const u8 *buf, size_t len, sbp_msg_ins_updates_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline size_t sbp_packed_size_sbp_msg_gnss_time_offset_t(
    const sbp_msg_gnss_time_offset_t *msg) {
  (void)msg;
  return 0 + sizeof(msg->weeks) + sizeof(msg->milliseconds) +
         sizeof(msg->microseconds) + sizeof(msg->flags);
}

static inline bool sbp_pack_sbp_msg_gnss_time_offset_t(
    u8 *buf, size_t len, const sbp_msg_gnss_time_offset_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_unpack_sbp_msg_gnss_time_offset_t(
    const u8 *buf, size_t len, sbp_msg_gnss_time_offset_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
 ...
 * It also lists the atomic contents (i.e. types of messages included) of the
 * Solution Group.
 */
...
#define SBP_GROUP_META_FLAGS_SOLUTION_GROUP_TYPE_GET(flags)      \
  (((flags) >> SBP_GROUP_META_FLAGS_SOLUTION_GROUP_TYPE_SHIFT) & \
   SBP_GROUP_META_FLAGS_SOLUTION_GROUP_TYPE_MASK)
#define SBP_GROUP_META_FLAGS_SOLUTION_GROUP_TYPE_SET(flags, val)           \
  do {                                                                     \
    ((flags) |= (((val) & (SBP_GROUP_META_FLAGS_SOLUTION_GROUP_TYPE_MASK)) \
                 << (SBP_GROUP_META_FLAGS_SOLUTION_GROUP_TYPE_SHIFT)));    \
  } while (0)
...
static inline size_t sbp_packed_size_sbp_msg_group_meta_t(
...
static inline bool sbp_pack_sbp_msg_group_meta_t(
    u8 *buf, size_t len, const sbp_msg_group_meta_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
  ...
  offset += 1;
  for (size_t msggroup_msgs_idx = 0;
       msggroup_msgs_idx < (size_t)msg->n_group_msgs; msggroup_msgs_idx++) {
    if (offset + 2 > len) {
      return false;
    }
...
static inline bool sbp_unpack_sbp_msg_group_meta_t(const u8 *buf, size_t len,
  ...
  for (size_t msggroup_msgs_idx = 0; msggroup_msgs_idx < msg->n_group_msgs;
       msggroup_msgs_idx++) {
    if (offset + 2 > len) {
      return false;
    }
    memcpy(&msg->group_msgs[msggroup_msgs_idx], buf + offset, 2);
    msg->group_msgs[msggroup_msgs_idx] =
        le16toh(msg->group_msgs[msggroup_msgs_idx]);
    offset += 2;
  }
  return true;
}
