...
static inline size_t sbp_packed_size_sbp_msg_acq_result_t(
    const sbp_msg_acq_result_t *msg) {
  (void)msg;
  return 0 + sizeof(msg->cn0) + sizeof(msg->cp) + sizeof(msg->cf) +
         (0 + sizeof(msg->sid.sat) + sizeof(msg->sid.code));
}

static inline bool sbp_pack_sbp_msg_acq_result_t(
    u8 *buf, size_t len, const sbp_msg_acq_result_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
  (void)msg;
  if (sbp_packed_size_sbp_msg_acq_result_t(msg) > len) {
    return false;
  }
...
static inline bool sbp_unpack_sbp_msg_acq_result_t(const u8 *buf, size_t len,
...
static inline size_t sbp_packed_size_sbp_msg_acq_result_dep_c_t(
...
static inline bool sbp_pack_sbp_msg_acq_result_dep_c_t(
    u8 *buf, size_t len, const sbp_msg_acq_result_dep_c_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
  (void)msg;
  if (sbp_packed_size_sbp_msg_acq_result_dep_c_t(msg) > len) {
    return false;
  }
...
static inline bool sbp_unpack_sbp_msg_acq_result_dep_c_t(
    const u8 *buf, size_t len, sbp_msg_acq_result_dep_c_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline size_t sbp_packed_size_sbp_msg_acq_result_dep_b_t(
    const sbp_msg_acq_result_dep_b_t *msg) {
  (void)msg;
  return 0 + sizeof(msg->snr) + sizeof(msg->cp) + sizeof(msg->cf) +
         (0 + sizeof(msg->sid.sat) + sizeof(msg->sid.code) +
          sizeof(msg->sid.reserved));
}

static inline bool sbp_pack_sbp_msg_acq_result_dep_b_t(
    u8 *buf, size_t len, const sbp_msg_acq_result_dep_b_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
  (void)msg;
  if (sbp_packed_size_sbp_msg_acq_result_dep_b_t(msg) > len) {
    return false;
  }
...
static inline bool sbp_unpack_sbp_msg_acq_result_dep_b_t(
    const u8 *buf, size_t len, sbp_msg_acq_result_dep_b_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline size_t sbp_packed_size_sbp_msg_acq_result_dep_a_t(
...
static inline bool sbp_pack_sbp_msg_acq_result_dep_a_t(
    u8 *buf, size_t len, const sbp_msg_acq_result_dep_a_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
  (void)msg;
  if (sbp_packed_size_sbp_msg_acq_result_dep_a_t(msg) > len) {
    return false;
  }
...
static inline bool sbp_unpack_sbp_msg_acq_result_dep_a_t(
    const u8 *buf, size_t len, sbp_msg_acq_result_dep_a_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline size_t sbp_packed_size_sbp_msg_acq_sv_profile_t(
    const sbp_msg_acq_sv_profile_t *msg) {
  (void)msg;
  return 0 +
         (msg->n_acq_sv_profile * (0 + sizeof(msg->acq_sv_profile[0].job_type) +
                                   sizeof(msg->acq_sv_profile[0].status) +
                                   sizeof(msg->acq_sv_profile[0].cn0) +
                                   sizeof(msg->acq_sv_profile[0].int_time) +
                                   (0 + sizeof(msg->acq_sv_profile[0].sid.sat) +
...
static inline bool sbp_pack_sbp_msg_acq_sv_profile_t(
    u8 *buf, size_t len, const sbp_msg_acq_sv_profile_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
  (void)msg;
  if (sbp_packed_size_sbp_msg_acq_sv_profile_t(msg) > len) {
    return false;
  }

  for (size_t msgacq_sv_profile_idx = 0;
       msgacq_sv_profile_idx < (size_t)msg->n_acq_sv_profile;
       msgacq_sv_profile_idx++) {
    if (offset + 1 > len) {
      return false;
    }
    u8 msgacq_sv_profilemsgacq_sv_profile_idxjob_type =
        msg->acq_sv_profile[msgacq_sv_profile_idx].job_type;
    ...
    u8 msgacq_sv_profilemsgacq_sv_profile_idxstatus =
        msg->acq_sv_profile[msgacq_sv_profile_idx].status;
    ...
    u16 msgacq_sv_profilemsgacq_sv_profile_idxcn0 =
        msg->acq_sv_profile[msgacq_sv_profile_idx].cn0;
    msgacq_sv_profilemsgacq_sv_profile_idxcn0 =
        htole16(msgacq_sv_profilemsgacq_sv_profile_idxcn0);
    ...
    u8 msgacq_sv_profilemsgacq_sv_profile_idxint_time =
        msg->acq_sv_profile[msgacq_sv_profile_idx].int_time;
    ...
    u8 msgacq_sv_profilemsgacq_sv_profile_idxsidsat =
        msg->acq_sv_profile[msgacq_sv_profile_idx].sid.sat;
    ...
    u8 msgacq_sv_profilemsgacq_sv_profile_idxsidcode =
        msg->acq_sv_profile[msgacq_sv_profile_idx].sid.code;
    ...
    u16 msgacq_sv_profilemsgacq_sv_profile_idxbin_width =
        msg->acq_sv_profile[msgacq_sv_profile_idx].bin_width;
    msgacq_sv_profilemsgacq_sv_profile_idxbin_width =
        htole16(msgacq_sv_profilemsgacq_sv_profile_idxbin_width);
    ...
    u32 msgacq_sv_profilemsgacq_sv_profile_idxtimestamp =
        msg->acq_sv_profile[msgacq_sv_profile_idx].timestamp;
    msgacq_sv_profilemsgacq_sv_profile_idxtimestamp =
        htole32(msgacq_sv_profilemsgacq_sv_profile_idxtimestamp);
    ...
    u32 msgacq_sv_profilemsgacq_sv_profile_idxtime_spent =
        msg->acq_sv_profile[msgacq_sv_profile_idx].time_spent;
    msgacq_sv_profilemsgacq_sv_profile_idxtime_spent =
        htole32(msgacq_sv_profilemsgacq_sv_profile_idxtime_spent);
    ...
    s32 msgacq_sv_profilemsgacq_sv_profile_idxcf_min =
        msg->acq_sv_profile[msgacq_sv_profile_idx].cf_min;
    msgacq_sv_profilemsgacq_sv_profile_idxcf_min =
        htole32(msgacq_sv_profilemsgacq_sv_profile_idxcf_min);
    ...
    s32 msgacq_sv_profilemsgacq_sv_profile_idxcf_max =
        msg->acq_sv_profile[msgacq_sv_profile_idx].cf_max;
    msgacq_sv_profilemsgacq_sv_profile_idxcf_max =
        htole32(msgacq_sv_profilemsgacq_sv_profile_idxcf_max);
    ...
    s32 msgacq_sv_profilemsgacq_sv_profile_idxcf =
        msg->acq_sv_profile[msgacq_sv_profile_idx].cf;
    msgacq_sv_profilemsgacq_sv_profile_idxcf =
        htole32(msgacq_sv_profilemsgacq_sv_profile_idxcf);
    ...
    u32 msgacq_sv_profilemsgacq_sv_profile_idxcp =
        msg->acq_sv_profile[msgacq_sv_profile_idx].cp;
    msgacq_sv_profilemsgacq_sv_profile_idxcp =
        htole32(msgacq_sv_profilemsgacq_sv_profile_idxcp);
...
static inline bool sbp_unpack_sbp_msg_acq_sv_profile_t(
    const u8 *buf, size_t len, sbp_msg_acq_sv_profile_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
  ...
  for (size_t msgacq_sv_profile_idx = 0;
       msgacq_sv_profile_idx < msg->n_acq_sv_profile; msgacq_sv_profile_idx++) {
    if (offset + 1 > len) {
      return false;
    }
    memcpy(&msg->acq_sv_profile[msgacq_sv_profile_idx].job_type, buf + offset,
           1);
    offset += 1;
    ...
    msg->acq_sv_profile[msgacq_sv_profile_idx].cn0 =
        le16toh(msg->acq_sv_profile[msgacq_sv_profile_idx].cn0);
    offset += 2;

    if (offset + 1 > len) {
      return false;
    }
    memcpy(&msg->acq_sv_profile[msgacq_sv_profile_idx].int_time, buf + offset,
           1);
    offset += 1;
    ...
    memcpy(&msg->acq_sv_profile[msgacq_sv_profile_idx].sid.sat, buf + offset,
           1);
    offset += 1;
    ...
    memcpy(&msg->acq_sv_profile[msgacq_sv_profile_idx].sid.code, buf + offset,
           1);
    offset += 1;
    ...
    memcpy(&msg->acq_sv_profile[msgacq_sv_profile_idx].bin_width, buf + offset,
           2);
    msg->acq_sv_profile[msgacq_sv_profile_idx].bin_width =
        le16toh(msg->acq_sv_profile[msgacq_sv_profile_idx].bin_width);
    offset += 2;

    if (offset + 4 > len) {
      return false;
    }
    memcpy(&msg->acq_sv_profile[msgacq_sv_profile_idx].timestamp, buf + offset,
           4);
    msg->acq_sv_profile[msgacq_sv_profile_idx].timestamp =
        le32toh(msg->acq_sv_profile[msgacq_sv_profile_idx].timestamp);
    offset += 4;

    if (offset + 4 > len) {
      return false;
    }
    memcpy(&msg->acq_sv_profile[msgacq_sv_profile_idx].time_spent, buf + offset,
           4);
    msg->acq_sv_profile[msgacq_sv_profile_idx].time_spent =
        le32toh(msg->acq_sv_profile[msgacq_sv_profile_idx].time_spent);
    offset += 4;
    ...
    msg->acq_sv_profile[msgacq_sv_profile_idx].cf_min =
        le32toh(msg->acq_sv_profile[msgacq_sv_profile_idx].cf_min);
    offset += 4;
    ...
    msg->acq_sv_profile[msgacq_sv_profile_idx].cf_max =
        le32toh(msg->acq_sv_profile[msgacq_sv_profile_idx].cf_max);
    offset += 4;
    ...
    msg->acq_sv_profile[msgacq_sv_profile_idx].cf =
        le32toh(msg->acq_sv_profile[msgacq_sv_profile_idx].cf);
    offset += 4;
    ...
    msg->acq_sv_profile[msgacq_sv_profile_idx].cp =
        le32toh(msg->acq_sv_profile[msgacq_sv_profile_idx].cp);
    offset += 4;
  }
  return true;
}
...
static inline size_t sbp_packed_size_sbp_msg_acq_sv_profile_dep_t(
    const sbp_msg_acq_sv_profile_dep_t *msg) {
  (void)msg;
  return 0 + (msg->n_acq_sv_profile *
              (0 + sizeof(msg->acq_sv_profile[0].job_type) +
               sizeof(msg->acq_sv_profile[0].status) +
               sizeof(msg->acq_sv_profile[0].cn0) +
               sizeof(msg->acq_sv_profile[0].int_time) +
               (0 + sizeof(msg->acq_sv_profile[0].sid.sat) +
...
static inline bool sbp_pack_sbp_msg_acq_sv_profile_dep_t(
    u8 *buf, size_t len, const sbp_msg_acq_sv_profile_dep_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
  (void)msg;
  if (sbp_packed_size_sbp_msg_acq_sv_profile_dep_t(msg) > len) {
    return false;
  }
  ...
  for (size_t msgacq_sv_profile_idx = 0;
    ...
    u16 msgacq_sv_profilemsgacq_sv_profile_idxsidsat =
        msg->acq_sv_profile[msgacq_sv_profile_idx].sid.sat;
    msgacq_sv_profilemsgacq_sv_profile_idxsidsat =
        htole16(msgacq_sv_profilemsgacq_sv_profile_idxsidsat);
    ...
    u8 msgacq_sv_profilemsgacq_sv_profile_idxsidreserved =
        msg->acq_sv_profile[msgacq_sv_profile_idx].sid.reserved;
...
static inline bool sbp_unpack_sbp_msg_acq_sv_profile_dep_t(
    const u8 *buf, size_t len, sbp_msg_acq_sv_profile_dep_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
  ...
  for (size_t msgacq_sv_profile_idx = 0;
    ...
    memcpy(&msg->acq_sv_profile[msgacq_sv_profile_idx].sid.sat, buf + offset,
           2);
    msg->acq_sv_profile[msgacq_sv_profile_idx].sid.sat =
        le16toh(msg->acq_sv_profile[msgacq_sv_profile_idx].sid.sat);
    offset += 2;
    ...
    memcpy(&msg->acq_sv_profile[msgacq_sv_profile_idx].sid.reserved,
           buf + offset, 1);
    offset += 1;
