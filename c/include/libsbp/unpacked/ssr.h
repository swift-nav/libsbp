...
#define SBP_SATELLITEAPC_SID_CODE__GET(flags) \
                             (((flags) >> SBP_SATELLITEAPC_SID_CODE__SHIFT) \
                             & SBP_SATELLITEAPC_SID_CODE__MASK)
#define SBP_SATELLITEAPC_SID_CODE__SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_SATELLITEAPC_SID_CODE__MASK)) \
                             << (SBP_SATELLITEAPC_SID_CODE__SHIFT)));} while(0)
...
#define SBP_SATELLITEAPC_SAT_INFO_SATELLITE_TYPE_GET(flags) \
                             (((flags) >> SBP_SATELLITEAPC_SAT_INFO_SATELLITE_TYPE_SHIFT) \
                             & SBP_SATELLITEAPC_SAT_INFO_SATELLITE_TYPE_MASK)
#define SBP_SATELLITEAPC_SAT_INFO_SATELLITE_TYPE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_SATELLITEAPC_SAT_INFO_SATELLITE_TYPE_MASK)) \
                             << (SBP_SATELLITEAPC_SAT_INFO_SATELLITE_TYPE_SHIFT)));} while(0)
