...
#define sbp_msg_bootloader_handshake_resp_t_version_vprintf(f,ap) sbp_unterminated_string_vprintf(f,251,ap)
...
#define sbp_msg_bootloader_handshake_dep_a_t_handshake_vprintf(f,ap) sbp_unterminated_string_vprintf(f,255,ap)
