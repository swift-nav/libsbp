...
static inline bool sbp_pack_msg(uint8_t *buf, size_t len, uint16_t msg_type, const sbp_msg_t *msg) {
  switch(msg_type) {
    ...
    case SBP_MSG_SSR_GRIDDED_CORRECTION_NO_STD_DEP_A:
      return sbp_pack_sbp_msg_ssr_gridded_correction_no_std_dep_a_t(buf, len, &msg->MSG_SSR_GRIDDED_CORRECTION_NO_STD_DEP_A);
    ...
    case SBP_MSG_PROTECTION_LEVEL_DEP_A:
      return sbp_pack_sbp_msg_protection_level_dep_a_t(buf, len, &msg->MSG_PROTECTION_LEVEL_DEP_A);
    ...
    case SBP_MSG_PPS_TIME:
      return sbp_pack_sbp_msg_pps_time_t(buf, len, &msg->MSG_PPS_TIME);
...
static inline bool sbp_unpack_msg(const uint8_t *buf, size_t len, uint16_t msg_type, sbp_msg_t *msg) {
  switch(msg_type) {
    ...
    case SBP_MSG_SSR_GRIDDED_CORRECTION_NO_STD_DEP_A:
      return sbp_unpack_sbp_msg_ssr_gridded_correction_no_std_dep_a_t(buf, len, &msg->MSG_SSR_GRIDDED_CORRECTION_NO_STD_DEP_A);
    case SBP_MSG_SSR_GRIDDED_CORRECTION_DEP_A:
    ...
    case SBP_MSG_PROTECTION_LEVEL_DEP_A:
      return sbp_unpack_sbp_msg_protection_level_dep_a_t(buf, len, &msg->MSG_PROTECTION_LEVEL_DEP_A);
    case SBP_MSG_PROTECTION_LEVEL:
    ...
    case SBP_MSG_PPS_TIME:
      return sbp_unpack_sbp_msg_pps_time_t(buf, len, &msg->MSG_PPS_TIME);
    case SBP_MSG_GROUP_META:
...
static inline bool sbp_msg_eq(uint16_t msg_type, const sbp_msg_t &a, const sbp_msg_t &b) {
  switch(msg_type) {
    ...
    case SBP_MSG_PROTECTION_LEVEL_DEP_A:
      return a.MSG_PROTECTION_LEVEL_DEP_A == b.MSG_PROTECTION_LEVEL_DEP_A;
    case SBP_MSG_PROTECTION_LEVEL:
    ...
    case SBP_MSG_PPS_TIME:
      return a.MSG_PPS_TIME == b.MSG_PPS_TIME;
    case SBP_MSG_GROUP_META:
