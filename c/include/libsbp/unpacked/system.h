...
#define SBP_STARTUP_CAUSE_CAUSE_OF_STARTUP_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_STARTUP_CAUSE_CAUSE_OF_STARTUP_MASK)) \
                             << (SBP_STARTUP_CAUSE_CAUSE_OF_STARTUP_SHIFT)));} while(0)
...
#define SBP_STARTUP_STARTUP_TYPE__SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_STARTUP_STARTUP_TYPE__MASK)) \
                             << (SBP_STARTUP_STARTUP_TYPE__SHIFT)));} while(0)
...
#define SBP_DGNSS_STATUS_FLAGS_DIFFERENTIAL_TYPE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_DGNSS_STATUS_FLAGS_DIFFERENTIAL_TYPE_MASK)) \
                             << (SBP_DGNSS_STATUS_FLAGS_DIFFERENTIAL_TYPE_SHIFT)));} while(0)
...
#define sbp_msg_dgnss_status_t_source_vprintf(f,ap) sbp_unterminated_string_vprintf(f,251,ap)
...
#define SBP_HEARTBEAT_FLAGS_EXTERNAL_ANTENNA_PRESENT_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_HEARTBEAT_FLAGS_EXTERNAL_ANTENNA_PRESENT_MASK)) \
                             << (SBP_HEARTBEAT_FLAGS_EXTERNAL_ANTENNA_PRESENT_SHIFT)));} while(0)
...
#define SBP_HEARTBEAT_FLAGS_EXTERNAL_ANTENNA_SHORT_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_HEARTBEAT_FLAGS_EXTERNAL_ANTENNA_SHORT_MASK)) \
                             << (SBP_HEARTBEAT_FLAGS_EXTERNAL_ANTENNA_SHORT_SHIFT)));} while(0)
...
#define SBP_HEARTBEAT_FLAGS_SBP_MAJOR_PROTOCOL_VERSION_NUMBER_SET(flags, val) \
                             ...
                             << (SBP_HEARTBEAT_FLAGS_SBP_MAJOR_PROTOCOL_VERSION_NUMBER_SHIFT)));} while(0)
...
#define SBP_HEARTBEAT_FLAGS_SBP_MINOR_PROTOCOL_VERSION_NUMBER_SET(flags, val) \
                             ...
                             << (SBP_HEARTBEAT_FLAGS_SBP_MINOR_PROTOCOL_VERSION_NUMBER_SHIFT)));} while(0)
...
#define SBP_HEARTBEAT_FLAGS_SWIFTNAP_ERROR_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_HEARTBEAT_FLAGS_SWIFTNAP_ERROR_MASK)) \
                             << (SBP_HEARTBEAT_FLAGS_SWIFTNAP_ERROR_SHIFT)));} while(0)
...
#define SBP_HEARTBEAT_FLAGS_IO_ERROR_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_HEARTBEAT_FLAGS_IO_ERROR_MASK)) \
                             << (SBP_HEARTBEAT_FLAGS_IO_ERROR_SHIFT)));} while(0)
...
#define SBP_HEARTBEAT_FLAGS_SYSTEM_ERROR_FLAG_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_HEARTBEAT_FLAGS_SYSTEM_ERROR_FLAG_MASK)) \
                             << (SBP_HEARTBEAT_FLAGS_SYSTEM_ERROR_FLAG_SHIFT)));} while(0)
...
#define SBP_SUBSYSTEMREPORT_COMPONENT_SUBSYSTEM_GET(flags) \
                             (((flags) >> SBP_SUBSYSTEMREPORT_COMPONENT_SUBSYSTEM_SHIFT) \
                             & SBP_SUBSYSTEMREPORT_COMPONENT_SUBSYSTEM_MASK)
#define SBP_SUBSYSTEMREPORT_COMPONENT_SUBSYSTEM_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_SUBSYSTEMREPORT_COMPONENT_SUBSYSTEM_MASK)) \
                             << (SBP_SUBSYSTEMREPORT_COMPONENT_SUBSYSTEM_SHIFT)));} while(0)
...
#define SBP_SUBSYSTEMREPORT_GENERIC_GENERIC_GET(flags) \
                             (((flags) >> SBP_SUBSYSTEMREPORT_GENERIC_GENERIC_SHIFT) \
                             & SBP_SUBSYSTEMREPORT_GENERIC_GENERIC_MASK)
#define SBP_SUBSYSTEMREPORT_GENERIC_GENERIC_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_SUBSYSTEMREPORT_GENERIC_GENERIC_MASK)) \
                             << (SBP_SUBSYSTEMREPORT_GENERIC_GENERIC_SHIFT)));} while(0)
...
#define SBP_STATUS_REPORT_REPORTING_SYSTEM_SYSTEM_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_STATUS_REPORT_REPORTING_SYSTEM_SYSTEM_MASK)) \
                             << (SBP_STATUS_REPORT_REPORTING_SYSTEM_SYSTEM_SHIFT)));} while(0)
...
#define SBP_STATUS_REPORT_SBP_VERSION_SBP_MAJOR_PROTOCOL_VERSION_NUMBER_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_STATUS_REPORT_SBP_VERSION_SBP_MAJOR_PROTOCOL_VERSION_NUMBER_MASK)) \
                             << (SBP_STATUS_REPORT_SBP_VERSION_SBP_MAJOR_PROTOCOL_VERSION_NUMBER_SHIFT)));} while(0)
...
#define SBP_STATUS_REPORT_SBP_VERSION_SBP_MINOR_PROTOCOL_VERSION_NUMBER_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_STATUS_REPORT_SBP_VERSION_SBP_MINOR_PROTOCOL_VERSION_NUMBER_MASK)) \
                             << (SBP_STATUS_REPORT_SBP_VERSION_SBP_MINOR_PROTOCOL_VERSION_NUMBER_SHIFT)));} while(0)
...
#define SBP_STATUS_REPORT_STATUS_COMPONENT_SUBSYSTEM_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_STATUS_REPORT_STATUS_COMPONENT_SUBSYSTEM_MASK)) \
                             << (SBP_STATUS_REPORT_STATUS_COMPONENT_SUBSYSTEM_SHIFT)));} while(0)
...
#define SBP_STATUS_REPORT_STATUS_GENERIC_GENERIC_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_STATUS_REPORT_STATUS_GENERIC_GENERIC_MASK)) \
                             << (SBP_STATUS_REPORT_STATUS_GENERIC_GENERIC_SHIFT)));} while(0)
...
#define SBP_INS_STATUS_FLAGS_INS_TYPE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_INS_STATUS_FLAGS_INS_TYPE_MASK)) \
                             << (SBP_INS_STATUS_FLAGS_INS_TYPE_SHIFT)));} while(0)
...
#define SBP_INS_STATUS_FLAGS_MOTION_STATE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_INS_STATUS_FLAGS_MOTION_STATE_MASK)) \
                             << (SBP_INS_STATUS_FLAGS_MOTION_STATE_SHIFT)));} while(0)
...
#define SBP_INS_STATUS_FLAGS_ODOMETRY_SYNCH_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_INS_STATUS_FLAGS_ODOMETRY_SYNCH_MASK)) \
                             << (SBP_INS_STATUS_FLAGS_ODOMETRY_SYNCH_SHIFT)));} while(0)
...
#define SBP_INS_STATUS_FLAGS_ODOMETRY_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_INS_STATUS_FLAGS_ODOMETRY_STATUS_MASK)) \
                             << (SBP_INS_STATUS_FLAGS_ODOMETRY_STATUS_SHIFT)));} while(0)
...
#define SBP_INS_STATUS_FLAGS_INS_ERROR_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_INS_STATUS_FLAGS_INS_ERROR_MASK)) \
                             << (SBP_INS_STATUS_FLAGS_INS_ERROR_SHIFT)));} while(0)
...
#define SBP_INS_STATUS_FLAGS_GNSS_FIX_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_INS_STATUS_FLAGS_GNSS_FIX_MASK)) \
                             << (SBP_INS_STATUS_FLAGS_GNSS_FIX_SHIFT)));} while(0)
...
#define SBP_INS_STATUS_FLAGS_MODE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_INS_STATUS_FLAGS_MODE_MASK)) \
                             << (SBP_INS_STATUS_FLAGS_MODE_SHIFT)));} while(0)
...
#define sbp_msg_csac_telemetry_t_telemetry_vprintf(f,ap) sbp_unterminated_string_vprintf(f,254,ap)
...
#define sbp_msg_csac_telemetry_labels_t_telemetry_labels_vprintf(f,ap) sbp_unterminated_string_vprintf(f,254,ap)
...
#define SBP_INS_UPDATES_GNSSPOS_NUMBER_OF_ATTEMPTED_GNSS_POSITION_UPDATES_SINCE_LAST_MESSAGE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_INS_UPDATES_GNSSPOS_NUMBER_OF_ATTEMPTED_GNSS_POSITION_UPDATES_SINCE_LAST_MESSAGE_MASK)) \
                             << (SBP_INS_UPDATES_GNSSPOS_NUMBER_OF_ATTEMPTED_GNSS_POSITION_UPDATES_SINCE_LAST_MESSAGE_SHIFT)));} while(0)
...
#define SBP_INS_UPDATES_GNSSPOS_NUMBER_OF_REJECTED_GNSS_POSITION_UPDATES_SINCE_LAST_MESSAGE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_INS_UPDATES_GNSSPOS_NUMBER_OF_REJECTED_GNSS_POSITION_UPDATES_SINCE_LAST_MESSAGE_MASK)) \
                             << (SBP_INS_UPDATES_GNSSPOS_NUMBER_OF_REJECTED_GNSS_POSITION_UPDATES_SINCE_LAST_MESSAGE_SHIFT)));} while(0)
...
#define SBP_INS_UPDATES_GNSSVEL_NUMBER_OF_ATTEMPTED_GNSS_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_INS_UPDATES_GNSSVEL_NUMBER_OF_ATTEMPTED_GNSS_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_MASK)) \
                             << (SBP_INS_UPDATES_GNSSVEL_NUMBER_OF_ATTEMPTED_GNSS_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_SHIFT)));} while(0)
...
#define SBP_INS_UPDATES_GNSSVEL_NUMBER_OF_REJECTED_GNSS_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_INS_UPDATES_GNSSVEL_NUMBER_OF_REJECTED_GNSS_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_MASK)) \
                             << (SBP_INS_UPDATES_GNSSVEL_NUMBER_OF_REJECTED_GNSS_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_SHIFT)));} while(0)
...
#define SBP_INS_UPDATES_WHEELTICKS_NUMBER_OF_ATTEMPTED_WHEELTICK_UPDATES_SINCE_LAST_MESSAGE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_INS_UPDATES_WHEELTICKS_NUMBER_OF_ATTEMPTED_WHEELTICK_UPDATES_SINCE_LAST_MESSAGE_MASK)) \
                             << (SBP_INS_UPDATES_WHEELTICKS_NUMBER_OF_ATTEMPTED_WHEELTICK_UPDATES_SINCE_LAST_MESSAGE_SHIFT)));} while(0)
...
#define SBP_INS_UPDATES_WHEELTICKS_NUMBER_OF_REJECTED_WHEELTICK_UPDATES_SINCE_LAST_MESSAGE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_INS_UPDATES_WHEELTICKS_NUMBER_OF_REJECTED_WHEELTICK_UPDATES_SINCE_LAST_MESSAGE_MASK)) \
                             << (SBP_INS_UPDATES_WHEELTICKS_NUMBER_OF_REJECTED_WHEELTICK_UPDATES_SINCE_LAST_MESSAGE_SHIFT)));} while(0)
...
#define SBP_INS_UPDATES_SPEED_NUMBER_OF_ATTEMPTED_SPEED_UPDATES_SINCE_LAST_MESSAGE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_INS_UPDATES_SPEED_NUMBER_OF_ATTEMPTED_SPEED_UPDATES_SINCE_LAST_MESSAGE_MASK)) \
                             << (SBP_INS_UPDATES_SPEED_NUMBER_OF_ATTEMPTED_SPEED_UPDATES_SINCE_LAST_MESSAGE_SHIFT)));} while(0)
...
#define SBP_INS_UPDATES_SPEED_NUMBER_OF_REJECTED_SPEED_UPDATES_SINCE_LAST_MESSAGE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_INS_UPDATES_SPEED_NUMBER_OF_REJECTED_SPEED_UPDATES_SINCE_LAST_MESSAGE_MASK)) \
                             << (SBP_INS_UPDATES_SPEED_NUMBER_OF_REJECTED_SPEED_UPDATES_SINCE_LAST_MESSAGE_SHIFT)));} while(0)
...
#define SBP_INS_UPDATES_NHC_NUMBER_OF_ATTEMPTED_NHC_UPDATES_SINCE_LAST_MESSAGE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_INS_UPDATES_NHC_NUMBER_OF_ATTEMPTED_NHC_UPDATES_SINCE_LAST_MESSAGE_MASK)) \
                             << (SBP_INS_UPDATES_NHC_NUMBER_OF_ATTEMPTED_NHC_UPDATES_SINCE_LAST_MESSAGE_SHIFT)));} while(0)
...
#define SBP_INS_UPDATES_NHC_NUMBER_OF_REJECTED_NHC_UPDATES_SINCE_LAST_MESSAGE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_INS_UPDATES_NHC_NUMBER_OF_REJECTED_NHC_UPDATES_SINCE_LAST_MESSAGE_MASK)) \
                             << (SBP_INS_UPDATES_NHC_NUMBER_OF_REJECTED_NHC_UPDATES_SINCE_LAST_MESSAGE_SHIFT)));} while(0)
...
#define SBP_INS_UPDATES_ZEROVEL_NUMBER_OF_ATTEMPTED_ZERO_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_INS_UPDATES_ZEROVEL_NUMBER_OF_ATTEMPTED_ZERO_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_MASK)) \
                             << (SBP_INS_UPDATES_ZEROVEL_NUMBER_OF_ATTEMPTED_ZERO_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_SHIFT)));} while(0)
...
#define SBP_INS_UPDATES_ZEROVEL_NUMBER_OF_REJECTED_ZERO_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_INS_UPDATES_ZEROVEL_NUMBER_OF_REJECTED_ZERO_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_MASK)) \
                             << (SBP_INS_UPDATES_ZEROVEL_NUMBER_OF_REJECTED_ZERO_VELOCITY_UPDATES_SINCE_LAST_MESSAGE_SHIFT)));} while(0)
...
#define SBP_MSG_PPS_TIME              0xFF08
	...
	#define SBP_PPS_TIME_FLAGS_RESERVED_SET_TO_ZERO_MASK (0x3f)
#define SBP_PPS_TIME_FLAGS_RESERVED_SET_TO_ZERO_SHIFT (2u)
#define SBP_PPS_TIME_FLAGS_RESERVED_SET_TO_ZERO_GET(flags) \
                             (((flags) >> SBP_PPS_TIME_FLAGS_RESERVED_SET_TO_ZERO_SHIFT) \
                             & SBP_PPS_TIME_FLAGS_RESERVED_SET_TO_ZERO_MASK)
#define SBP_PPS_TIME_FLAGS_RESERVED_SET_TO_ZERO_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_PPS_TIME_FLAGS_RESERVED_SET_TO_ZERO_MASK)) \
                             << (SBP_PPS_TIME_FLAGS_RESERVED_SET_TO_ZERO_SHIFT)));} while(0)
                             

#define SBP_PPS_TIME_FLAGS_TIME_UNCERTAINTY_MASK (0x3)
#define SBP_PPS_TIME_FLAGS_TIME_UNCERTAINTY_SHIFT (0u)
#define SBP_PPS_TIME_FLAGS_TIME_UNCERTAINTY_GET(flags) \
                             (((flags) >> SBP_PPS_TIME_FLAGS_TIME_UNCERTAINTY_SHIFT) \
                             & SBP_PPS_TIME_FLAGS_TIME_UNCERTAINTY_MASK)
#define SBP_PPS_TIME_FLAGS_TIME_UNCERTAINTY_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_PPS_TIME_FLAGS_TIME_UNCERTAINTY_MASK)) \
                             << (SBP_PPS_TIME_FLAGS_TIME_UNCERTAINTY_SHIFT)));} while(0)
                             

#define SBP_PPS_TIME_FLAGS_TIME_UNCERTAINTY_UNKNOWN (0)
#define SBP_PPS_TIME_FLAGS_TIME_UNCERTAINTY__10_MILLISECONDS (1)
#define SBP_PPS_TIME_FLAGS_TIME_UNCERTAINTY__10_MICROSECONDS (2)
#define SBP_PPS_TIME_FLAGS_TIME_UNCERTAINTY__1_MICROSECONDS (3)
typedef struct {
...
#define SBP_GROUP_META_FLAGS_SOLUTION_GROUP_TYPE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_GROUP_META_FLAGS_SOLUTION_GROUP_TYPE_MASK)) \
                             << (SBP_GROUP_META_FLAGS_SOLUTION_GROUP_TYPE_SHIFT)));} while(0)
