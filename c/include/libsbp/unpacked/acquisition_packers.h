...
{
  (void)msg;
  return 0 + sizeof(msg->job_type) + sizeof(msg->status) + sizeof(msg->cn0) + sizeof(msg->int_time) +
         (0 + sizeof(msg->sid.sat) + sizeof(msg->sid.code)) + sizeof(msg->bin_width) + sizeof(msg->timestamp) +
         sizeof(msg->time_spent) + sizeof(msg->cf_min) + sizeof(msg->cf_max) + sizeof(msg->cf) + sizeof(msg->cp);
}
...
static inline bool sbp_pack_sbp_acq_sv_profile_t(u8 *buf, size_t len, const sbp_acq_sv_profile_t *msg)
{
  ...
  (void)len;
  (void)msg;
  if (sbp_packed_size_sbp_acq_sv_profile_t(msg) > len)
  {
    return false;
  }
...
static inline size_t sbp_packed_size_sbp_acq_sv_profile_dep_t(const sbp_acq_sv_profile_dep_t *msg)
{
  (void)msg;
  return 0 + sizeof(msg->job_type) + sizeof(msg->status) + sizeof(msg->cn0) + sizeof(msg->int_time) +
         (0 + sizeof(msg->sid.sat) + sizeof(msg->sid.code) + sizeof(msg->sid.reserved)) + sizeof(msg->bin_width) +
         sizeof(msg->timestamp) + sizeof(msg->time_spent) + sizeof(msg->cf_min) + sizeof(msg->cf_max) +
         sizeof(msg->cf) + sizeof(msg->cp);
}
...
static inline bool sbp_pack_sbp_acq_sv_profile_dep_t(u8 *buf, size_t len, const sbp_acq_sv_profile_dep_t *msg)
{
  ...
  (void)len;
  (void)msg;
  if (sbp_packed_size_sbp_acq_sv_profile_dep_t(msg) > len)
  {
    return false;
  }
