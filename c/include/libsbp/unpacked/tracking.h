...
#define SBP_TRACKINGCHANNELSTATE_SID_CODE__GET(flags) \
                             (((flags) >> SBP_TRACKINGCHANNELSTATE_SID_CODE__SHIFT) \
                             & SBP_TRACKINGCHANNELSTATE_SID_CODE__MASK)
#define SBP_TRACKINGCHANNELSTATE_SID_CODE__SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKINGCHANNELSTATE_SID_CODE__MASK)) \
                             << (SBP_TRACKINGCHANNELSTATE_SID_CODE__SHIFT)));} while(0)
...
#define SBP_MEASUREMENTSTATE_MESID_CODE__GET(flags) \
                             (((flags) >> SBP_MEASUREMENTSTATE_MESID_CODE__SHIFT) \
                             & SBP_MEASUREMENTSTATE_MESID_CODE__MASK)
#define SBP_MEASUREMENTSTATE_MESID_CODE__SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_MEASUREMENTSTATE_MESID_CODE__MASK)) \
                             << (SBP_MEASUREMENTSTATE_MESID_CODE__SHIFT)));} while(0)
...
#define SBP_TRACKINGCHANNELSTATEDEPA_STATE_TRACKING_MODE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKINGCHANNELSTATEDEPA_STATE_TRACKING_MODE_MASK)) \
                             << (SBP_TRACKINGCHANNELSTATEDEPA_STATE_TRACKING_MODE_SHIFT)));} while(0)
...
#define SBP_TRACKINGCHANNELSTATEDEPB_STATE_TRACKING_MODE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKINGCHANNELSTATEDEPB_STATE_TRACKING_MODE_MASK)) \
                             << (SBP_TRACKINGCHANNELSTATEDEPB_STATE_TRACKING_MODE_SHIFT)));} while(0)
...
#define SBP_TRACKINGCHANNELSTATEDEPB_SID_CODE__GET(flags) \
                             (((flags) >> SBP_TRACKINGCHANNELSTATEDEPB_SID_CODE__SHIFT) \
                             & SBP_TRACKINGCHANNELSTATEDEPB_SID_CODE__MASK)
#define SBP_TRACKINGCHANNELSTATEDEPB_SID_CODE__SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKINGCHANNELSTATEDEPB_SID_CODE__MASK)) \
                             << (SBP_TRACKINGCHANNELSTATEDEPB_SID_CODE__SHIFT)));} while(0)
