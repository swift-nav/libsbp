...
static inline bool sbp_pack_sbp_grid_element_no_std_t(u8 *buf, size_t len, const sbp_grid_element_no_std_t *msg) {
  ...
  // NOLINTNEXTLINE
  offset += 1;
			for(size_t msgstec_residuals_idx = 0; msgstec_residuals_idx < (size_t)msg->stec_residuals_count; msgstec_residuals_idx++)
			{
  ...
  if (offset + 1 > len) { return false; }
  u8 msgstec_residualsmsgstec_residuals_idxsv_idconstellation = msg->stec_residuals[msgstec_residuals_idx].sv_id.constellation;
  memcpy(buf + offset, & msgstec_residualsmsgstec_residuals_idxsv_idconstellation , 1);
  // NOLINTNEXTLINE
  offset += 1;
        
  if (offset + 2 > len) { return false; }
  u16 msgstec_residualsmsgstec_residuals_idxresidual = htole16( *(const u16*)&msg->stec_residuals[msgstec_residuals_idx].residual );
...
static inline bool sbp_unpack_sbp_grid_element_no_std_t(const u8 *buf, size_t len, sbp_grid_element_no_std_t *msg) {
  ...
  u16 msgstec_residualsmsgstec_residuals_idxresidual = *(const u16*)&msg->stec_residuals[msgstec_residuals_idx].residual;
...
static inline bool sbp_pack_sbp_msg_ssr_gridded_correction_t(u8 *buf, size_t len, const sbp_msg_ssr_gridded_correction_t *msg) {
  ...
  // NOLINTNEXTLINE
  offset += 1;
			for(size_t msgelementstec_residuals_idx = 0; msgelementstec_residuals_idx < (size_t)msg->element.stec_residuals_count; msgelementstec_residuals_idx++)
			{
