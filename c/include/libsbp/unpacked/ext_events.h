...
#define SBP_EXT_EVENT_FLAGS_TIME_QUALITY_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_EXT_EVENT_FLAGS_TIME_QUALITY_MASK)) \
                             << (SBP_EXT_EVENT_FLAGS_TIME_QUALITY_SHIFT)));} while(0)
...
#define SBP_EXT_EVENT_FLAGS_NEW_LEVEL_OF_PIN_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_EXT_EVENT_FLAGS_NEW_LEVEL_OF_PIN_MASK)) \
                             << (SBP_EXT_EVENT_FLAGS_NEW_LEVEL_OF_PIN_SHIFT)));} while(0)
