...
static inline bool operator==(const sbp_packed_osr_content_t &a, const sbp_packed_osr_content_t &b)
{
  ...
  if (a.iono_std != b.iono_std)
  {
    return false;
  }

  if (a.tropo_std != b.tropo_std)
  {
    return false;
  }

  if (a.range_std != b.range_std)
  {
    return false;
  }
...
static inline bool operator==(const sbp_ephemeris_common_content_t &a, const sbp_ephemeris_common_content_t &b)
{
  ...
  if (a.toe.tow != b.toe.tow)
  {
    return false;
  }

  if (a.toe.wn != b.toe.wn)
  {
    return false;
  }

  if (fabs(a.ura - b.ura) > 0.001)
  {
    return false;
  }

  if (a.fit_interval != b.fit_interval)
  {
    return false;
  }
  ...
  if (a.health_bits != b.health_bits)
  {
    return false;
  }
...
static inline bool operator==(const sbp_gnss_capb_t &a, const sbp_gnss_capb_t &b)
{
  ...
  if (a.gps_active != b.gps_active)
  {
    return false;
  }

  if (a.gps_l2c != b.gps_l2c)
  {
    return false;
  }

  if (a.gps_l5 != b.gps_l5)
  {
    return false;
  }

  if (a.glo_active != b.glo_active)
  {
    return false;
  }

  if (a.glo_l2of != b.glo_l2of)
  {
    return false;
  }

  if (a.glo_l3 != b.glo_l3)
  {
    return false;
  }

  if (a.sbas_active != b.sbas_active)
  {
    return false;
  }

  if (a.sbas_l5 != b.sbas_l5)
  {
    return false;
  }

  if (a.bds_active != b.bds_active)
  {
    return false;
  }

  if (a.bds_d2nav != b.bds_d2nav)
  {
    return false;
  }

  if (a.bds_b2 != b.bds_b2)
  {
    return false;
  }

  if (a.bds_b2a != b.bds_b2a)
  {
    return false;
  }

  if (a.qzss_active != b.qzss_active)
  {
    return false;
  }

  if (a.gal_active != b.gal_active)
  {
    return false;
  }

  if (a.gal_e5 != b.gal_e5)
  {
    return false;
  }
...
static inline bool operator==(const sbp_almanac_common_content_t &a, const sbp_almanac_common_content_t &b)
{
  ...
  if (a.toa.tow != b.toa.tow)
  {
    return false;
  }

  if (a.toa.wn != b.toa.wn)
  {
    return false;
  }
