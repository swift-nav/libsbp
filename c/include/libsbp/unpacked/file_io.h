...
#define sbp_msg_fileio_read_req_t_filename_vprintf(f,ap) sbp_null_terminated_string_vprintf(f,246,ap)
...
#define sbp_msg_fileio_read_dir_req_t_dirname_vprintf(f,ap) sbp_null_terminated_string_vprintf(f,247,ap)
...
#define sbp_msg_fileio_read_dir_resp_t_contents_append_vprintf(f, ap) sbp_sequence_string_append_vprintf(s, 251, 255, )p
...
#define sbp_msg_fileio_remove_t_filename_vprintf(f,ap) sbp_null_terminated_string_vprintf(f,255,ap)
...
#define sbp_msg_fileio_write_req_t_filename_vprintf(f,ap) sbp_null_terminated_string_vprintf(f,247,ap)
