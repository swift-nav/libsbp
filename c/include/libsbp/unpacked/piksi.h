...
#define sbp_msg_command_req_t_command_vprintf(f,ap) sbp_null_terminated_string_vprintf(f,251,ap)
...
#define sbp_msg_command_output_t_line_vprintf(f,ap) sbp_unterminated_string_vprintf(f,251,ap)
