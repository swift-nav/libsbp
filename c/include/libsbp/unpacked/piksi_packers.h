...
static inline bool sbp_pack_sbp_msg_specan_dep_t(u8 *buf, size_t len, const sbp_msg_specan_dep_t *msg) {
  ...
  // NOLINTNEXTLINE
  offset += 4;
			for(size_t msgamplitude_value_idx = 0; msgamplitude_value_idx < (size_t)msg->amplitude_value_count; msgamplitude_value_idx++)
			{
