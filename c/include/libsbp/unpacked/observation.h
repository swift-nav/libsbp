...
#define SBP_PACKEDOBSCONTENT_FLAGS_RAIM_EXCLUSION_GET(flags) \
  (((flags) >> SBP_PACKEDOBSCONTENT_FLAGS_RAIM_EXCLUSION_SHIFT) & SBP_PACKEDOBSCONTENT_FLAGS_RAIM_EXCLUSION_MASK)
#define SBP_PACKEDOBSCONTENT_FLAGS_RAIM_EXCLUSION_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_PACKEDOBSCONTENT_FLAGS_RAIM_EXCLUSION_MASK)) \
                 << (SBP_PACKEDOBSCONTENT_FLAGS_RAIM_EXCLUSION_SHIFT))); \
  } while (0)
...
#define SBP_PACKEDOBSCONTENT_FLAGS_DOPPLER_VALID_GET(flags) \
  (((flags) >> SBP_PACKEDOBSCONTENT_FLAGS_DOPPLER_VALID_SHIFT) & SBP_PACKEDOBSCONTENT_FLAGS_DOPPLER_VALID_MASK)
#define SBP_PACKEDOBSCONTENT_FLAGS_DOPPLER_VALID_SET(flags, val) \
  do \
  { \
    ((flags) |= \
     (((val) & (SBP_PACKEDOBSCONTENT_FLAGS_DOPPLER_VALID_MASK)) << (SBP_PACKEDOBSCONTENT_FLAGS_DOPPLER_VALID_SHIFT))); \
  } while (0)
...
#define SBP_PACKEDOBSCONTENT_FLAGS_HALFCYCLE_AMBIGUITY_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_PACKEDOBSCONTENT_FLAGS_HALFCYCLE_AMBIGUITY_MASK)) \
                 << (SBP_PACKEDOBSCONTENT_FLAGS_HALFCYCLE_AMBIGUITY_SHIFT))); \
  } while (0)
...
#define SBP_PACKEDOBSCONTENT_FLAGS_CARRIER_PHASE_VALID_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_PACKEDOBSCONTENT_FLAGS_CARRIER_PHASE_VALID_MASK)) \
                 << (SBP_PACKEDOBSCONTENT_FLAGS_CARRIER_PHASE_VALID_SHIFT))); \
  } while (0)
...
#define SBP_PACKEDOBSCONTENT_FLAGS_PSEUDORANGE_VALID_GET(flags) \
  (((flags) >> SBP_PACKEDOBSCONTENT_FLAGS_PSEUDORANGE_VALID_SHIFT) & SBP_PACKEDOBSCONTENT_FLAGS_PSEUDORANGE_VALID_MASK)
#define SBP_PACKEDOBSCONTENT_FLAGS_PSEUDORANGE_VALID_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_PACKEDOBSCONTENT_FLAGS_PSEUDORANGE_VALID_MASK)) \
                 << (SBP_PACKEDOBSCONTENT_FLAGS_PSEUDORANGE_VALID_SHIFT))); \
  } while (0)
...
#define SBP_PACKEDOBSCONTENT_SID_CODE__GET(flags) \
  (((flags) >> SBP_PACKEDOBSCONTENT_SID_CODE__SHIFT) & SBP_PACKEDOBSCONTENT_SID_CODE__MASK)
#define SBP_PACKEDOBSCONTENT_SID_CODE__SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_PACKEDOBSCONTENT_SID_CODE__MASK)) << (SBP_PACKEDOBSCONTENT_SID_CODE__SHIFT))); \
  } while (0)
...
#define SBP_PACKEDOSRCONTENT_FLAGS_INVALID_PHASE_CORRECTIONS_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_PACKEDOSRCONTENT_FLAGS_INVALID_PHASE_CORRECTIONS_MASK)) \
                 << (SBP_PACKEDOSRCONTENT_FLAGS_INVALID_PHASE_CORRECTIONS_SHIFT))); \
  } while (0)
...
#define SBP_PACKEDOSRCONTENT_FLAGS_INVALID_CODE_CORRECTIONS_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_PACKEDOSRCONTENT_FLAGS_INVALID_CODE_CORRECTIONS_MASK)) \
                 << (SBP_PACKEDOSRCONTENT_FLAGS_INVALID_CODE_CORRECTIONS_SHIFT))); \
  } while (0)
...
#define SBP_PACKEDOSRCONTENT_FLAGS_FULL_FIXING_FLAG_GET(flags) \
  (((flags) >> SBP_PACKEDOSRCONTENT_FLAGS_FULL_FIXING_FLAG_SHIFT) & SBP_PACKEDOSRCONTENT_FLAGS_FULL_FIXING_FLAG_MASK)
#define SBP_PACKEDOSRCONTENT_FLAGS_FULL_FIXING_FLAG_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_PACKEDOSRCONTENT_FLAGS_FULL_FIXING_FLAG_MASK)) \
                 << (SBP_PACKEDOSRCONTENT_FLAGS_FULL_FIXING_FLAG_SHIFT))); \
  } while (0)
...
#define SBP_PACKEDOSRCONTENT_FLAGS_PARTIAL_FIXING_FLAG_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_PACKEDOSRCONTENT_FLAGS_PARTIAL_FIXING_FLAG_MASK)) \
                 << (SBP_PACKEDOSRCONTENT_FLAGS_PARTIAL_FIXING_FLAG_SHIFT))); \
  } while (0)
...
#define SBP_PACKEDOSRCONTENT_FLAGS_CORRECTION_VALIDITY_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_PACKEDOSRCONTENT_FLAGS_CORRECTION_VALIDITY_MASK)) \
                 << (SBP_PACKEDOSRCONTENT_FLAGS_CORRECTION_VALIDITY_SHIFT))); \
  } while (0)
...
#define SBP_PACKEDOSRCONTENT_SID_CODE__GET(flags) \
  (((flags) >> SBP_PACKEDOSRCONTENT_SID_CODE__SHIFT) & SBP_PACKEDOSRCONTENT_SID_CODE__MASK)
#define SBP_PACKEDOSRCONTENT_SID_CODE__SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_PACKEDOSRCONTENT_SID_CODE__MASK)) << (SBP_PACKEDOSRCONTENT_SID_CODE__SHIFT))); \
  } while (0)
...
#define SBP_EPHEMERISCOMMONCONTENT_SID_CODE__GET(flags) \
  (((flags) >> SBP_EPHEMERISCOMMONCONTENT_SID_CODE__SHIFT) & SBP_EPHEMERISCOMMONCONTENT_SID_CODE__MASK)
#define SBP_EPHEMERISCOMMONCONTENT_SID_CODE__SET(flags, val) \
  do \
  { \
    ((flags) |= \
     (((val) & (SBP_EPHEMERISCOMMONCONTENT_SID_CODE__MASK)) << (SBP_EPHEMERISCOMMONCONTENT_SID_CODE__SHIFT))); \
  } while (0)
...
#define SBP_EPHEMERISCOMMONCONTENTDEPB_SID_CODE__GET(flags) \
  (((flags) >> SBP_EPHEMERISCOMMONCONTENTDEPB_SID_CODE__SHIFT) & SBP_EPHEMERISCOMMONCONTENTDEPB_SID_CODE__MASK)
#define SBP_EPHEMERISCOMMONCONTENTDEPB_SID_CODE__SET(flags, val) \
  do \
  { \
    ((flags) |= \
     (((val) & (SBP_EPHEMERISCOMMONCONTENTDEPB_SID_CODE__MASK)) << (SBP_EPHEMERISCOMMONCONTENTDEPB_SID_CODE__SHIFT))); \
  } while (0)
...
#define SBP_EPHEMERISCOMMONCONTENTDEPA_SID_CODE__GET(flags) \
  (((flags) >> SBP_EPHEMERISCOMMONCONTENTDEPA_SID_CODE__SHIFT) & SBP_EPHEMERISCOMMONCONTENTDEPA_SID_CODE__MASK)
#define SBP_EPHEMERISCOMMONCONTENTDEPA_SID_CODE__SET(flags, val) \
  do \
  { \
    ((flags) |= \
     (((val) & (SBP_EPHEMERISCOMMONCONTENTDEPA_SID_CODE__MASK)) << (SBP_EPHEMERISCOMMONCONTENTDEPA_SID_CODE__SHIFT))); \
  } while (0)
...
#define SBP_PACKEDOBSCONTENTDEPB_SID_CODE__GET(flags) \
  (((flags) >> SBP_PACKEDOBSCONTENTDEPB_SID_CODE__SHIFT) & SBP_PACKEDOBSCONTENTDEPB_SID_CODE__MASK)
#define SBP_PACKEDOBSCONTENTDEPB_SID_CODE__SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_PACKEDOBSCONTENTDEPB_SID_CODE__MASK)) << (SBP_PACKEDOBSCONTENTDEPB_SID_CODE__SHIFT))); \
  } while (0)
...
#define SBP_PACKEDOBSCONTENTDEPC_SID_CODE__GET(flags) \
  (((flags) >> SBP_PACKEDOBSCONTENTDEPC_SID_CODE__SHIFT) & SBP_PACKEDOBSCONTENTDEPC_SID_CODE__MASK)
#define SBP_PACKEDOBSCONTENTDEPC_SID_CODE__SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_PACKEDOBSCONTENTDEPC_SID_CODE__MASK)) << (SBP_PACKEDOBSCONTENTDEPC_SID_CODE__SHIFT))); \
  } while (0)
...
#define SBP_ALMANACCOMMONCONTENT_SID_CODE__GET(flags) \
  (((flags) >> SBP_ALMANACCOMMONCONTENT_SID_CODE__SHIFT) & SBP_ALMANACCOMMONCONTENT_SID_CODE__MASK)
#define SBP_ALMANACCOMMONCONTENT_SID_CODE__SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_ALMANACCOMMONCONTENT_SID_CODE__MASK)) << (SBP_ALMANACCOMMONCONTENT_SID_CODE__SHIFT))); \
  } while (0)
...
#define SBP_ALMANACCOMMONCONTENTDEP_SID_CODE__GET(flags) \
  (((flags) >> SBP_ALMANACCOMMONCONTENTDEP_SID_CODE__SHIFT) & SBP_ALMANACCOMMONCONTENTDEP_SID_CODE__MASK)
#define SBP_ALMANACCOMMONCONTENTDEP_SID_CODE__SET(flags, val) \
  do \
  { \
    ((flags) |= \
     (((val) & (SBP_ALMANACCOMMONCONTENTDEP_SID_CODE__MASK)) << (SBP_ALMANACCOMMONCONTENTDEP_SID_CODE__SHIFT))); \
  } while (0)
...
#define SBP_SVAZEL_SID_CODE__GET(flags) (((flags) >> SBP_SVAZEL_SID_CODE__SHIFT) & SBP_SVAZEL_SID_CODE__MASK)
#define SBP_SVAZEL_SID_CODE__SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_SVAZEL_SID_CODE__MASK)) << (SBP_SVAZEL_SID_CODE__SHIFT))); \
  } while (0)
