...
#define sbp_msg_linux_cpu_state_dep_a_t_cmdline_vprintf(f,ap) sbp_unterminated_string_vprintf(f,236,ap)
...
#define sbp_msg_linux_mem_state_dep_a_t_cmdline_vprintf(f,ap) sbp_unterminated_string_vprintf(f,236,ap)
...
#define sbp_msg_linux_process_socket_counts_t_cmdline_vprintf(f,ap) sbp_unterminated_string_vprintf(f,246,ap)
...
#define sbp_msg_linux_process_socket_queues_t_cmdline_vprintf(f,ap) sbp_unterminated_string_vprintf(f,180,ap)
...
#define sbp_msg_linux_process_fd_count_t_cmdline_vprintf(f,ap) sbp_unterminated_string_vprintf(f,250,ap)
...
#define sbp_msg_linux_process_fd_summary_t_most_opened_append_vprintf(f, ap) sbp_sequence_string_append_vprintf(s, 251, 0, )p
...
#define sbp_msg_linux_cpu_state_t_cmdline_vprintf(f,ap) sbp_unterminated_string_vprintf(f,231,ap)
...
#define sbp_msg_linux_mem_state_t_cmdline_vprintf(f,ap) sbp_unterminated_string_vprintf(f,231,ap)
