...
#define SBP_IMU_RAW_TOW_TIME_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_IMU_RAW_TOW_TIME_STATUS_MASK)) \
                             << (SBP_IMU_RAW_TOW_TIME_STATUS_SHIFT)));} while(0)
...
#define SBP_IMU_RAW_TOW_TIME_SINCE_REFERENCE_EPOCH_IN_MILLISECONDS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_IMU_RAW_TOW_TIME_SINCE_REFERENCE_EPOCH_IN_MILLISECONDS_MASK)) \
                             << (SBP_IMU_RAW_TOW_TIME_SINCE_REFERENCE_EPOCH_IN_MILLISECONDS_SHIFT)));} while(0)
...
#define SBP_IMU_AUX_IMU_TYPE_IMU_TYPE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_IMU_AUX_IMU_TYPE_IMU_TYPE_MASK)) \
                             << (SBP_IMU_AUX_IMU_TYPE_IMU_TYPE_SHIFT)));} while(0)
...
#define SBP_IMU_AUX_IMU_CONF_GYROSCOPE_RANGE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_IMU_AUX_IMU_CONF_GYROSCOPE_RANGE_MASK)) \
                             << (SBP_IMU_AUX_IMU_CONF_GYROSCOPE_RANGE_SHIFT)));} while(0)
...
#define SBP_IMU_AUX_IMU_CONF_ACCELEROMETER_RANGE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_IMU_AUX_IMU_CONF_ACCELEROMETER_RANGE_MASK)) \
                             << (SBP_IMU_AUX_IMU_CONF_ACCELEROMETER_RANGE_SHIFT)));} while(0)
