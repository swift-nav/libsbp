...
#define SBP_SOLUTIONINPUTTYPE_SENSOR_TYPE_SENSOR_USAGE_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_SOLUTIONINPUTTYPE_SENSOR_TYPE_SENSOR_USAGE_MASK)) \
                 << (SBP_SOLUTIONINPUTTYPE_SENSOR_TYPE_SENSOR_USAGE_SHIFT))); \
  } while (0)
...
#define SBP_SOLUTIONINPUTTYPE_SENSOR_TYPE_SENSOR_TYPE_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_SOLUTIONINPUTTYPE_SENSOR_TYPE_SENSOR_TYPE_MASK)) \
                 << (SBP_SOLUTIONINPUTTYPE_SENSOR_TYPE_SENSOR_TYPE_SHIFT))); \
  } while (0)
...
#define SBP_SOLN_META_DEP_A_ALIGNMENT_STATUS_ALIGNMENT_STATUS_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_SOLN_META_DEP_A_ALIGNMENT_STATUS_ALIGNMENT_STATUS_MASK)) \
...
#define SBP_SOLN_META_DEP_A_SOL_IN_SENSOR_TYPE_SENSOR_USAGE_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_SOLN_META_DEP_A_SOL_IN_SENSOR_TYPE_SENSOR_USAGE_MASK)) \
...
#define SBP_SOLN_META_DEP_A_SOL_IN_SENSOR_TYPE_SENSOR_TYPE_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_SOLN_META_DEP_A_SOL_IN_SENSOR_TYPE_SENSOR_TYPE_MASK)) \
...
typedef struct
{
  ...
  /**
   * Array of Metadata describing the sensors potentially involved in the solution. Each element in the array represents
   * a single sensor type and consists of flags containing (meta)data pertaining to that specific single sensor. Refer
   * to each (XX)InputType descriptor in the present doc.
   */
 ...
 * complete in the Fusion Engine, when output solution is the last received valid GNSS solution and its tow is not a
 * TOM.
 */
...
#define SBP_SOLN_META_AGE_GNSS_TIME_STATUS_GET(flags) \
  (((flags) >> SBP_SOLN_META_AGE_GNSS_TIME_STATUS_SHIFT) & SBP_SOLN_META_AGE_GNSS_TIME_STATUS_MASK)
#define SBP_SOLN_META_AGE_GNSS_TIME_STATUS_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_SOLN_META_AGE_GNSS_TIME_STATUS_MASK)) << (SBP_SOLN_META_AGE_GNSS_TIME_STATUS_SHIFT))); \
  } while (0)
...
#define SBP_SOLN_META_AGE_GNSS_AGE_OF_THE_LAST_RECEIVED_VALID_GNSS_SOLUTION_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_SOLN_META_AGE_GNSS_AGE_OF_THE_LAST_RECEIVED_VALID_GNSS_SOLUTION_MASK)) \
...
#define SBP_SOLN_META_SOL_IN_SENSOR_TYPE_SENSOR_USAGE_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_SOLN_META_SOL_IN_SENSOR_TYPE_SENSOR_USAGE_MASK)) \
...
#define SBP_SOLN_META_SOL_IN_SENSOR_TYPE_SENSOR_TYPE_GET(flags) \
  (((flags) >> SBP_SOLN_META_SOL_IN_SENSOR_TYPE_SENSOR_TYPE_SHIFT) & SBP_SOLN_META_SOL_IN_SENSOR_TYPE_SENSOR_TYPE_MASK)
...
#define SBP_GNSSINPUTTYPE_FLAGS_TYPE_OF_GNSS_MEASUREMENT_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_GNSSINPUTTYPE_FLAGS_TYPE_OF_GNSS_MEASUREMENT_MASK)) \
                 << (SBP_GNSSINPUTTYPE_FLAGS_TYPE_OF_GNSS_MEASUREMENT_SHIFT))); \
  } while (0)
...
#define SBP_IMUINPUTTYPE_FLAGS_TIME_STATUS_GET(flags) \
  (((flags) >> SBP_IMUINPUTTYPE_FLAGS_TIME_STATUS_SHIFT) & SBP_IMUINPUTTYPE_FLAGS_TIME_STATUS_MASK)
#define SBP_IMUINPUTTYPE_FLAGS_TIME_STATUS_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_IMUINPUTTYPE_FLAGS_TIME_STATUS_MASK)) << (SBP_IMUINPUTTYPE_FLAGS_TIME_STATUS_SHIFT))); \
  } while (0)
...
#define SBP_IMUINPUTTYPE_FLAGS_IMU_GRADE_GET(flags) \
  (((flags) >> SBP_IMUINPUTTYPE_FLAGS_IMU_GRADE_SHIFT) & SBP_IMUINPUTTYPE_FLAGS_IMU_GRADE_MASK)
#define SBP_IMUINPUTTYPE_FLAGS_IMU_GRADE_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_IMUINPUTTYPE_FLAGS_IMU_GRADE_MASK)) << (SBP_IMUINPUTTYPE_FLAGS_IMU_GRADE_SHIFT))); \
  } while (0)
...
#define SBP_IMUINPUTTYPE_FLAGS_IMU_ARCHITECTURE_GET(flags) \
  (((flags) >> SBP_IMUINPUTTYPE_FLAGS_IMU_ARCHITECTURE_SHIFT) & SBP_IMUINPUTTYPE_FLAGS_IMU_ARCHITECTURE_MASK)
#define SBP_IMUINPUTTYPE_FLAGS_IMU_ARCHITECTURE_SET(flags, val) \
  do \
  { \
    ((flags) |= \
     (((val) & (SBP_IMUINPUTTYPE_FLAGS_IMU_ARCHITECTURE_MASK)) << (SBP_IMUINPUTTYPE_FLAGS_IMU_ARCHITECTURE_SHIFT))); \
  } while (0)
...
#define SBP_ODOINPUTTYPE_FLAGS_RATE_GET(flags) \
  (((flags) >> SBP_ODOINPUTTYPE_FLAGS_RATE_SHIFT) & SBP_ODOINPUTTYPE_FLAGS_RATE_MASK)
#define SBP_ODOINPUTTYPE_FLAGS_RATE_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_ODOINPUTTYPE_FLAGS_RATE_MASK)) << (SBP_ODOINPUTTYPE_FLAGS_RATE_SHIFT))); \
  } while (0)
...
#define SBP_ODOINPUTTYPE_FLAGS_ODOMETER_GRADE_GET(flags) \
  (((flags) >> SBP_ODOINPUTTYPE_FLAGS_ODOMETER_GRADE_SHIFT) & SBP_ODOINPUTTYPE_FLAGS_ODOMETER_GRADE_MASK)
#define SBP_ODOINPUTTYPE_FLAGS_ODOMETER_GRADE_SET(flags, val) \
  do \
  { \
    ((flags) |= \
     (((val) & (SBP_ODOINPUTTYPE_FLAGS_ODOMETER_GRADE_MASK)) << (SBP_ODOINPUTTYPE_FLAGS_ODOMETER_GRADE_SHIFT))); \
  } while (0)
...
#define SBP_ODOINPUTTYPE_FLAGS_ODOMETER_CLASS_GET(flags) \
  (((flags) >> SBP_ODOINPUTTYPE_FLAGS_ODOMETER_CLASS_SHIFT) & SBP_ODOINPUTTYPE_FLAGS_ODOMETER_CLASS_MASK)
#define SBP_ODOINPUTTYPE_FLAGS_ODOMETER_CLASS_SET(flags, val) \
  do \
  { \
    ((flags) |= \
     (((val) & (SBP_ODOINPUTTYPE_FLAGS_ODOMETER_CLASS_MASK)) << (SBP_ODOINPUTTYPE_FLAGS_ODOMETER_CLASS_SHIFT))); \
  } while (0)
