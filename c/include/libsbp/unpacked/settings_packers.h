...
static inline size_t sbp_packed_size_sbp_msg_settings_write_t(const sbp_msg_settings_write_t *msg) {                                
  ...
  return                                                          
	0                                                                          
	  +
      sbp_multipart_string_packed_len(&msg->setting, 255, 3, 3);
}
  ...
  return                                                          
	0                                                                          
	  +
				sizeof( msg->status )                                                                          
	  +
      sbp_multipart_string_packed_len(&msg->setting, 254, 3, 3);
}
...
static inline size_t sbp_packed_size_sbp_msg_settings_read_req_t(const sbp_msg_settings_read_req_t *msg) {                                
  ...
  return                                                          
	0                                                                          
	  +
      sbp_multipart_string_packed_len(&msg->setting, 255, 2, 2);
}
  ...
  return                                                          
	0                                                                          
	  +
				sizeof( msg->index )                                                                          
	  +
      sbp_multipart_string_packed_len(&msg->setting, 253, 3, 4);
}
