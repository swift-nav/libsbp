...
#define SBP_GNSSSIGNAL_CODE__GET(flags) (((flags) >> SBP_GNSSSIGNAL_CODE__SHIFT) & SBP_GNSSSIGNAL_CODE__MASK)
#define SBP_GNSSSIGNAL_CODE__SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_GNSSSIGNAL_CODE__MASK)) << (SBP_GNSSSIGNAL_CODE__SHIFT))); \
  } while (0)
...
#define SBP_GNSSSIGNALDEP_CODE__GET(flags) (((flags) >> SBP_GNSSSIGNALDEP_CODE__SHIFT) & SBP_GNSSSIGNALDEP_CODE__MASK)
#define SBP_GNSSSIGNALDEP_CODE__SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_GNSSSIGNALDEP_CODE__MASK)) << (SBP_GNSSSIGNALDEP_CODE__SHIFT))); \
  } while (0)
