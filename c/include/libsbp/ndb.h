...
#define SBP_NDB_EVENT_EVENT_EVENT_TYPE_GET(flags) \
  (((flags) >> SBP_NDB_EVENT_EVENT_EVENT_TYPE_SHIFT) & SBP_NDB_EVENT_EVENT_EVENT_TYPE_MASK)
#define SBP_NDB_EVENT_EVENT_EVENT_TYPE_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_NDB_EVENT_EVENT_EVENT_TYPE_MASK)) << (SBP_NDB_EVENT_EVENT_EVENT_TYPE_SHIFT))); \
  } while (0)
...
#define SBP_NDB_EVENT_OBJECT_TYPE_EVENT_OBJECT_TYPE_GET(flags) \
  (((flags) >> SBP_NDB_EVENT_OBJECT_TYPE_EVENT_OBJECT_TYPE_SHIFT) & SBP_NDB_EVENT_OBJECT_TYPE_EVENT_OBJECT_TYPE_MASK)
...
#define SBP_NDB_EVENT_RESULT_EVENT_RESULT_GET(flags) \
  (((flags) >> SBP_NDB_EVENT_RESULT_EVENT_RESULT_SHIFT) & SBP_NDB_EVENT_RESULT_EVENT_RESULT_MASK)
#define SBP_NDB_EVENT_RESULT_EVENT_RESULT_SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_NDB_EVENT_RESULT_EVENT_RESULT_MASK)) << (SBP_NDB_EVENT_RESULT_EVENT_RESULT_SHIFT))); \
  } while (0)
...
#define SBP_NDB_EVENT_DATA_SOURCE_DATA_SOURCE_GET(flags) \
  (((flags) >> SBP_NDB_EVENT_DATA_SOURCE_DATA_SOURCE_SHIFT) & SBP_NDB_EVENT_DATA_SOURCE_DATA_SOURCE_MASK)
#define SBP_NDB_EVENT_DATA_SOURCE_DATA_SOURCE_SET(flags, val) \
  do \
  { \
    ((flags) |= \
     (((val) & (SBP_NDB_EVENT_DATA_SOURCE_DATA_SOURCE_MASK)) << (SBP_NDB_EVENT_DATA_SOURCE_DATA_SOURCE_SHIFT))); \
  } while (0)
...
#define SBP_NDB_EVENT_OBJECT_SID_CODE__GET(flags) \
  (((flags) >> SBP_NDB_EVENT_OBJECT_SID_CODE__SHIFT) & SBP_NDB_EVENT_OBJECT_SID_CODE__MASK)
#define SBP_NDB_EVENT_OBJECT_SID_CODE__SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_NDB_EVENT_OBJECT_SID_CODE__MASK)) << (SBP_NDB_EVENT_OBJECT_SID_CODE__SHIFT))); \
  } while (0)
...
#define SBP_NDB_EVENT_SRC_SID_CODE__GET(flags) \
  (((flags) >> SBP_NDB_EVENT_SRC_SID_CODE__SHIFT) & SBP_NDB_EVENT_SRC_SID_CODE__MASK)
#define SBP_NDB_EVENT_SRC_SID_CODE__SET(flags, val) \
  do \
  { \
    ((flags) |= (((val) & (SBP_NDB_EVENT_SRC_SID_CODE__MASK)) << (SBP_NDB_EVENT_SRC_SID_CODE__SHIFT))); \
  } while (0)
...
static inline bool operator==(const sbp_msg_ndb_event_t &a, const sbp_msg_ndb_event_t &b)
{
  ...
  if (a.object_sid.sat != b.object_sid.sat)
  {
    return false;
  }

  if (a.object_sid.code != b.object_sid.code)
  {
    return false;
  }

  if (a.src_sid.sat != b.src_sid.sat)
  {
    return false;
  }

  if (a.src_sid.code != b.src_sid.code)
  {
    return false;
  }

  if (a.original_sender != b.original_sender)
  {
    return false;
  }
