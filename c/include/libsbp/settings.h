...
static inline size_t sbp_packed_size_sbp_msg_settings_save_t(
    const sbp_msg_settings_save_t *msg) {
  (void)msg;
  return 0;
}

static inline bool sbp_pack_sbp_msg_settings_save_t(
    u8 *buf, size_t len, const sbp_msg_settings_save_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_unpack_sbp_msg_settings_save_t(
    const u8 *buf, size_t len, sbp_msg_settings_save_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_pack_sbp_msg_settings_write_t(
    u8 *buf, size_t len, const sbp_msg_settings_write_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_unpack_sbp_msg_settings_write_t(
    const u8 *buf, size_t len, sbp_msg_settings_write_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
#define SBP_SETTINGS_WRITE_RESP_STATUS_WRITE_STATUS_REJECTED_VALUE_UNPARSABLE_OR_OUT_OF_RANGE \
  (1)
#define SBP_SETTINGS_WRITE_RESP_STATUS_WRITE_STATUS_REJECTED_REQUESTED_SETTING_DOES_NOT_EXIST \
  (2)
#define SBP_SETTINGS_WRITE_RESP_STATUS_WRITE_STATUS_REJECTED_SETTING_NAME_COULD_NOT_BE_PARSED \
  (3)
#define SBP_SETTINGS_WRITE_RESP_STATUS_WRITE_STATUS_REJECTED_SETTING_IS_READ_ONLY \
  (4)
#define SBP_SETTINGS_WRITE_RESP_STATUS_WRITE_STATUS_REJECTED_MODIFICATION_IS_TEMPORARILY_DISABLED \
  (5)
#define SBP_SETTINGS_WRITE_RESP_STATUS_WRITE_STATUS_REJECTED_UNSPECIFIED_ERROR \
  (6)
typedef struct {
  /**
   * Write status
...
static inline bool sbp_pack_sbp_msg_settings_write_resp_t(
    u8 *buf, size_t len, const sbp_msg_settings_write_resp_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_unpack_sbp_msg_settings_write_resp_t(
    const u8 *buf, size_t len, sbp_msg_settings_write_resp_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_pack_sbp_msg_settings_read_req_t(
    u8 *buf, size_t len, const sbp_msg_settings_read_req_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_unpack_sbp_msg_settings_read_req_t(
    const u8 *buf, size_t len, sbp_msg_settings_read_req_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_pack_sbp_msg_settings_read_resp_t(
    u8 *buf, size_t len, const sbp_msg_settings_read_resp_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_unpack_sbp_msg_settings_read_resp_t(
    const u8 *buf, size_t len, sbp_msg_settings_read_resp_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline size_t sbp_packed_size_sbp_msg_settings_read_by_index_req_t(
    const sbp_msg_settings_read_by_index_req_t *msg) {
  (void)msg;
  return 0 + sizeof(msg->index);
}

static inline bool sbp_pack_sbp_msg_settings_read_by_index_req_t(
    u8 *buf, size_t len, const sbp_msg_settings_read_by_index_req_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_unpack_sbp_msg_settings_read_by_index_req_t(
    const u8 *buf, size_t len, sbp_msg_settings_read_by_index_req_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_pack_sbp_msg_settings_read_by_index_resp_t(
    u8 *buf, size_t len, const sbp_msg_settings_read_by_index_resp_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_unpack_sbp_msg_settings_read_by_index_resp_t(
    const u8 *buf, size_t len, sbp_msg_settings_read_by_index_resp_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline size_t sbp_packed_size_sbp_msg_settings_read_by_index_done_t(
    const sbp_msg_settings_read_by_index_done_t *msg) {
  (void)msg;
  return 0;
}

static inline bool sbp_pack_sbp_msg_settings_read_by_index_done_t(
    u8 *buf, size_t len, const sbp_msg_settings_read_by_index_done_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_unpack_sbp_msg_settings_read_by_index_done_t(
    const u8 *buf, size_t len, sbp_msg_settings_read_by_index_done_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_pack_sbp_msg_settings_register_t(
    u8 *buf, size_t len, const sbp_msg_settings_register_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_unpack_sbp_msg_settings_register_t(
    const u8 *buf, size_t len, sbp_msg_settings_register_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
#define SBP_SETTINGS_REGISTER_RESP_STATUS_REGISTER_STATUS_ACCEPTED_REQUESTED_DEFAULT_VALUE_RETURNED \
  (0)
...
#define SBP_SETTINGS_REGISTER_RESP_STATUS_REGISTER_STATUS_REJECTED_SETTING_ALREADY_REGISTERED_VALUE_FROM_MEMORY_RETURNED \
  (2)
#define SBP_SETTINGS_REGISTER_RESP_STATUS_REGISTER_STATUS_REJECTED_MALFORMED_MESSAGE \
  (3)
typedef struct {
  /**
   * Register status
...
static inline bool sbp_pack_sbp_msg_settings_register_resp_t(
    u8 *buf, size_t len, const sbp_msg_settings_register_resp_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
...
static inline bool sbp_unpack_sbp_msg_settings_register_resp_t(
    const u8 *buf, size_t len, sbp_msg_settings_register_resp_t *msg) {
  size_t offset = 0;
  (void)offset;
  (void)buf;
  (void)len;
