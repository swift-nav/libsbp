...
#define SBP_TRACKING_STATE_DETAILED_DEP_A_SID_CODE__SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_A_SID_CODE__MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_A_SID_CODE__SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_A_SYNC_FLAGS_SYNCHRONIZATION_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_A_SYNC_FLAGS_SYNCHRONIZATION_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_A_SYNC_FLAGS_SYNCHRONIZATION_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_A_SYNC_FLAGS_SYNCHRONIZATION_STATUS_SUB_FRAME_SYNCHRONIZATION_MESSAGE_SYNCHRONIZATION (3)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_A_TOW_FLAGS_WEEK_NUMBER_VALIDITY_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_A_TOW_FLAGS_WEEK_NUMBER_VALIDITY_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_A_TOW_FLAGS_WEEK_NUMBER_VALIDITY_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_A_TOW_FLAGS_TOW_STATUS_SET(flags, val) \
                             ...
                             << (SBP_TRACKING_STATE_DETAILED_DEP_A_TOW_FLAGS_TOW_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_A_TRACK_FLAGS_FLL_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_A_TRACK_FLAGS_FLL_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_A_TRACK_FLAGS_FLL_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_A_TRACK_FLAGS_PLL_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_A_TRACK_FLAGS_PLL_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_A_TRACK_FLAGS_PLL_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_A_TRACK_FLAGS_TRACKING_LOOP_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_A_TRACK_FLAGS_TRACKING_LOOP_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_A_TRACK_FLAGS_TRACKING_LOOP_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_A_NAV_FLAGS_ALMANAC_AVAILABILITY_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_A_NAV_FLAGS_ALMANAC_AVAILABILITY_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_A_NAV_FLAGS_ALMANAC_AVAILABILITY_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_A_NAV_FLAGS_EPHEMERIS_AVAILABILITY_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_A_NAV_FLAGS_EPHEMERIS_AVAILABILITY_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_A_NAV_FLAGS_EPHEMERIS_AVAILABILITY_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_A_NAV_FLAGS_HEALTH_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_A_NAV_FLAGS_HEALTH_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_A_NAV_FLAGS_HEALTH_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_A_PSET_FLAGS_PARAMETER_SETS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_A_PSET_FLAGS_PARAMETER_SETS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_A_PSET_FLAGS_PARAMETER_SETS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_A_MISC_FLAGS_CLOCK_VALIDITY_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_A_MISC_FLAGS_CLOCK_VALIDITY_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_A_MISC_FLAGS_CLOCK_VALIDITY_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_A_MISC_FLAGS_PSEUDORANGE_VALIDITY_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_A_MISC_FLAGS_PSEUDORANGE_VALIDITY_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_A_MISC_FLAGS_PSEUDORANGE_VALIDITY_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_A_MISC_FLAGS_ACCELERATION_VALIDITY_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_A_MISC_FLAGS_ACCELERATION_VALIDITY_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_A_MISC_FLAGS_ACCELERATION_VALIDITY_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_A_MISC_FLAGS_CARRIER_HALF_CYCLE_AMBIGUITY_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_A_MISC_FLAGS_CARRIER_HALF_CYCLE_AMBIGUITY_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_A_MISC_FLAGS_CARRIER_HALF_CYCLE_AMBIGUITY_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_A_MISC_FLAGS_TRACKING_CHANNEL_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_A_MISC_FLAGS_TRACKING_CHANNEL_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_A_MISC_FLAGS_TRACKING_CHANNEL_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_SID_CODE__SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_SID_CODE__MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_SID_CODE__SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_SYNC_FLAGS_SYNCHRONIZATION_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_SYNC_FLAGS_SYNCHRONIZATION_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_SYNC_FLAGS_SYNCHRONIZATION_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_SYNC_FLAGS_SYNCHRONIZATION_STATUS_SUB_FRAME_SYNCHRONIZATION_MESSAGE_SYNCHRONIZATION (3)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_TOW_FLAGS_WEEK_NUMBER_VALIDITY_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_TOW_FLAGS_WEEK_NUMBER_VALIDITY_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_TOW_FLAGS_WEEK_NUMBER_VALIDITY_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_TOW_FLAGS_TOW_STATUS_SET(flags, val) \
                             ...
                             << (SBP_TRACKING_STATE_DETAILED_DEP_TOW_FLAGS_TOW_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_TRACK_FLAGS_FLL_STATUS_SET(flags, val) \
                             ...
                             << (SBP_TRACKING_STATE_DETAILED_DEP_TRACK_FLAGS_FLL_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_TRACK_FLAGS_PLL_STATUS_SET(flags, val) \
                             ...
                             << (SBP_TRACKING_STATE_DETAILED_DEP_TRACK_FLAGS_PLL_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_TRACK_FLAGS_TRACKING_LOOP_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_TRACK_FLAGS_TRACKING_LOOP_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_TRACK_FLAGS_TRACKING_LOOP_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_NAV_FLAGS_ALMANAC_AVAILABILITY_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_NAV_FLAGS_ALMANAC_AVAILABILITY_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_NAV_FLAGS_ALMANAC_AVAILABILITY_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_NAV_FLAGS_EPHEMERIS_AVAILABILITY_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_NAV_FLAGS_EPHEMERIS_AVAILABILITY_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_NAV_FLAGS_EPHEMERIS_AVAILABILITY_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_NAV_FLAGS_HEALTH_STATUS_SET(flags, val) \
                             ...
                             << (SBP_TRACKING_STATE_DETAILED_DEP_NAV_FLAGS_HEALTH_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_PSET_FLAGS_PARAMETER_SETS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_PSET_FLAGS_PARAMETER_SETS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_PSET_FLAGS_PARAMETER_SETS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_MISC_FLAGS_CLOCK_VALIDITY_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_MISC_FLAGS_CLOCK_VALIDITY_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_MISC_FLAGS_CLOCK_VALIDITY_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_MISC_FLAGS_PSEUDORANGE_VALIDITY_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_MISC_FLAGS_PSEUDORANGE_VALIDITY_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_MISC_FLAGS_PSEUDORANGE_VALIDITY_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_MISC_FLAGS_ACCELERATION_VALIDITY_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_MISC_FLAGS_ACCELERATION_VALIDITY_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_MISC_FLAGS_ACCELERATION_VALIDITY_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_MISC_FLAGS_CARRIER_HALF_CYCLE_AMBIGUITY_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_MISC_FLAGS_CARRIER_HALF_CYCLE_AMBIGUITY_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_MISC_FLAGS_CARRIER_HALF_CYCLE_AMBIGUITY_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DETAILED_DEP_MISC_FLAGS_TRACKING_CHANNEL_STATUS_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DETAILED_DEP_MISC_FLAGS_TRACKING_CHANNEL_STATUS_MASK)) \
                             << (SBP_TRACKING_STATE_DETAILED_DEP_MISC_FLAGS_TRACKING_CHANNEL_STATUS_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_STATES_SID_CODE__SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_STATES_SID_CODE__MASK)) \
                             << (SBP_TRACKING_STATE_STATES_SID_CODE__SHIFT)));} while(0)
...
#define SBP_MEASUREMENT_STATE_STATES_MESID_CODE__SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_MEASUREMENT_STATE_STATES_MESID_CODE__MASK)) \
                             << (SBP_MEASUREMENT_STATE_STATES_MESID_CODE__SHIFT)));} while(0)
...
#define SBP_TRACKING_IQ_SID_CODE__SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_IQ_SID_CODE__MASK)) \
                             << (SBP_TRACKING_IQ_SID_CODE__SHIFT)));} while(0)
...
#define SBP_TRACKING_IQ_DEP_B_SID_CODE__SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_IQ_DEP_B_SID_CODE__MASK)) \
                             << (SBP_TRACKING_IQ_DEP_B_SID_CODE__SHIFT)));} while(0)
...
#define SBP_TRACKING_IQ_DEP_A_SID_CODE__SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_IQ_DEP_A_SID_CODE__MASK)) \
                             << (SBP_TRACKING_IQ_DEP_A_SID_CODE__SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DEP_A_STATES_STATE_TRACKING_MODE_SET(flags, val) \
                             ...
                             << (SBP_TRACKING_STATE_DEP_A_STATES_STATE_TRACKING_MODE_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DEP_B_STATES_STATE_TRACKING_MODE_SET(flags, val) \
                             ...
                             << (SBP_TRACKING_STATE_DEP_B_STATES_STATE_TRACKING_MODE_SHIFT)));} while(0)
...
#define SBP_TRACKING_STATE_DEP_B_STATES_SID_CODE__SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_TRACKING_STATE_DEP_B_STATES_SID_CODE__MASK)) \
                             << (SBP_TRACKING_STATE_DEP_B_STATES_SID_CODE__SHIFT)));} while(0)
