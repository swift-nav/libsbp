...
#define SBP_SSR_ORBIT_CLOCK_SID_CODE__SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_SSR_ORBIT_CLOCK_SID_CODE__MASK)) \
                             << (SBP_SSR_ORBIT_CLOCK_SID_CODE__SHIFT)));} while(0)
...
#define SBP_SSR_CODE_BIASES_SID_CODE__SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_SSR_CODE_BIASES_SID_CODE__MASK)) \
                             << (SBP_SSR_CODE_BIASES_SID_CODE__SHIFT)));} while(0)
...
static inline bool sbp_unpack_sbp_msg_ssr_code_biases_t(const u8 *buf, size_t len, sbp_msg_ssr_code_biases_t *msg) {
  ...
  msg->biases[msgbiases_idx].value = le16toh( msg->biases[msgbiases_idx].value );
  offset += 2;
		}
  return true;
}
...
#define SBP_SSR_PHASE_BIASES_SID_CODE__SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_SSR_PHASE_BIASES_SID_CODE__MASK)) \
                             << (SBP_SSR_PHASE_BIASES_SID_CODE__SHIFT)));} while(0)
...
static inline bool sbp_pack_sbp_msg_ssr_stec_correction_t(u8 *buf, size_t len, const sbp_msg_ssr_stec_correction_t *msg) {
  ...
  if (offset + 1 > len) { return false; }
  u8 msgstec_sat_listmsgstec_sat_list_idxsv_idconstellation = msg->stec_sat_list[msgstec_sat_list_idx].sv_id.constellation;
  memcpy(buf + offset, & msgstec_sat_listmsgstec_sat_list_idxsv_idconstellation , 1);
  offset += 1;
        
  if (offset + 1 > len) { return false; }
  u8 msgstec_sat_listmsgstec_sat_list_idxstec_quality_indicator = msg->stec_sat_list[msgstec_sat_list_idx].stec_quality_indicator;
  ...
  if (offset + 2 > len) { return false; }
  s16 msgstec_sat_listmsgstec_sat_list_idxstec_coeffmsgstec_sat_listmsgstec_sat_list_idxstec_coeff_idx = msg->stec_sat_list[msgstec_sat_list_idx].stec_coeff[msgstec_sat_listmsgstec_sat_list_idxstec_coeff_idx];
  msgstec_sat_listmsgstec_sat_list_idxstec_coeffmsgstec_sat_listmsgstec_sat_list_idxstec_coeff_idx = htole16( msgstec_sat_listmsgstec_sat_list_idxstec_coeffmsgstec_sat_listmsgstec_sat_list_idxstec_coeff_idx );
  memcpy(buf + offset, & msgstec_sat_listmsgstec_sat_list_idxstec_coeffmsgstec_sat_listmsgstec_sat_list_idxstec_coeff_idx , 2);
  offset += 2;
			}
			}
  return true;
...
static inline bool sbp_unpack_sbp_msg_ssr_stec_correction_t(const u8 *buf, size_t len, sbp_msg_ssr_stec_correction_t *msg) {
  ...
  if (offset + 2 > len) { return false; }
  memcpy(&msg->stec_sat_list[msgstec_sat_list_idx].stec_coeff[msgstec_sat_listmsgstec_sat_list_idxstec_coeff_idx], buf + offset, 2);
  msg->stec_sat_list[msgstec_sat_list_idx].stec_coeff[msgstec_sat_listmsgstec_sat_list_idxstec_coeff_idx] = le16toh( msg->stec_sat_list[msgstec_sat_list_idx].stec_coeff[msgstec_sat_listmsgstec_sat_list_idxstec_coeff_idx] );
  offset += 2;
		}
		}
  return true;
...
static inline bool sbp_pack_sbp_msg_ssr_gridded_correction_t(u8 *buf, size_t len, const sbp_msg_ssr_gridded_correction_t *msg) {
  ...
  if (offset + 2 > len) { return false; }
  s16 msgelementtropo_delay_correctionhydro = msg->element.tropo_delay_correction.hydro;
  msgelementtropo_delay_correctionhydro = htole16( msgelementtropo_delay_correctionhydro );
  ...
  if (offset + 1 > len) { return false; }
  u8 msgelementstec_residualsmsgelementstec_residuals_idxsv_idsatId = msg->element.stec_residuals[msgelementstec_residuals_idx].sv_id.satId;
  memcpy(buf + offset, & msgelementstec_residualsmsgelementstec_residuals_idxsv_idsatId , 1);
  offset += 1;
        
  if (offset + 1 > len) { return false; }
  u8 msgelementstec_residualsmsgelementstec_residuals_idxsv_idconstellation = msg->element.stec_residuals[msgelementstec_residuals_idx].sv_id.constellation;
  memcpy(buf + offset, & msgelementstec_residualsmsgelementstec_residuals_idxsv_idconstellation , 1);
  offset += 1;
        
  if (offset + 2 > len) { return false; }
  s16 msgelementstec_residualsmsgelementstec_residuals_idxresidual = msg->element.stec_residuals[msgelementstec_residuals_idx].residual;
  msgelementstec_residualsmsgelementstec_residuals_idxresidual = htole16( msgelementstec_residualsmsgelementstec_residuals_idxresidual );
  memcpy(buf + offset, & msgelementstec_residualsmsgelementstec_residuals_idxresidual , 2);
  offset += 2;
        
  if (offset + 1 > len) { return false; }
  u8 msgelementstec_residualsmsgelementstec_residuals_idxstddev = msg->element.stec_residuals[msgelementstec_residuals_idx].stddev;
...
static inline bool sbp_unpack_sbp_msg_ssr_gridded_correction_t(const u8 *buf, size_t len, sbp_msg_ssr_gridded_correction_t *msg) {
  ...
  msg->element.tropo_delay_correction.hydro = le16toh( msg->element.tropo_delay_correction.hydro );
  offset += 2;
  ...
  msg->element.stec_residuals[msgelementstec_residuals_idx].residual = le16toh( msg->element.stec_residuals[msgelementstec_residuals_idx].residual );
  offset += 2;
...
#define SBP_SSR_SATELLITE_APC_APC_SID_CODE__GET(flags) \
                             (((flags) >> SBP_SSR_SATELLITE_APC_APC_SID_CODE__SHIFT) \
                             & SBP_SSR_SATELLITE_APC_APC_SID_CODE__MASK)
#define SBP_SSR_SATELLITE_APC_APC_SID_CODE__SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_SSR_SATELLITE_APC_APC_SID_CODE__MASK)) \
                             << (SBP_SSR_SATELLITE_APC_APC_SID_CODE__SHIFT)));} while(0)
...
#define SBP_SSR_SATELLITE_APC_APC_SAT_INFO_SATELLITE_TYPE_SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_SSR_SATELLITE_APC_APC_SAT_INFO_SATELLITE_TYPE_MASK)) \
                             << (SBP_SSR_SATELLITE_APC_APC_SAT_INFO_SATELLITE_TYPE_SHIFT)));} while(0)
...
static inline bool sbp_pack_sbp_msg_ssr_satellite_apc_t(u8 *buf, size_t len, const sbp_msg_ssr_satellite_apc_t *msg) {
  ...
  if (offset + 2 > len) { return false; }
  u16 msgapcmsgapc_idxsvn = msg->apc[msgapc_idx].svn;
  msgapcmsgapc_idxsvn = htole16( msgapcmsgapc_idxsvn );
  ...
  if (offset + 2 > len) { return false; }
  s16 msgapcmsgapc_idxpcomsgapcmsgapc_idxpco_idx = msg->apc[msgapc_idx].pco[msgapcmsgapc_idxpco_idx];
  msgapcmsgapc_idxpcomsgapcmsgapc_idxpco_idx = htole16( msgapcmsgapc_idxpcomsgapcmsgapc_idxpco_idx );
...
static inline bool sbp_unpack_sbp_msg_ssr_satellite_apc_t(const u8 *buf, size_t len, sbp_msg_ssr_satellite_apc_t *msg) {
  ...
  msg->apc[msgapc_idx].pco[msgapcmsgapc_idxpco_idx] = le16toh( msg->apc[msgapc_idx].pco[msgapcmsgapc_idxpco_idx] );
  offset += 2;
		}
		for (size_t msgapcmsgapc_idxpcv_idx = 0; msgapcmsgapc_idxpcv_idx < 21; msgapcmsgapc_idxpcv_idx++)
		{
...
#define SBP_SSR_ORBIT_CLOCK_DEP_A_SID_CODE__SET(flags, val) \
                             do {((flags) |= \
                             (((val) & (SBP_SSR_ORBIT_CLOCK_DEP_A_SID_CODE__MASK)) \
                             << (SBP_SSR_ORBIT_CLOCK_DEP_A_SID_CODE__SHIFT)));} while(0)
