...
static inline bool sbp_pack_msg(uint8_t *buf, size_t len,
                                const sbp_msg_t *msg) {
  switch (msg->type) {
    case SBP_MSG_TRACKING_STATE_DETAILED_DEP_A:
      return sbp_pack_sbp_msg_tracking_state_detailed_dep_a_t(
          buf, len, &msg->MSG_TRACKING_STATE_DETAILED_DEP_A);
    case SBP_MSG_TRACKING_STATE_DETAILED_DEP:
      return sbp_pack_sbp_msg_tracking_state_detailed_dep_t(
          buf, len, &msg->MSG_TRACKING_STATE_DETAILED_DEP);
    case SBP_MSG_TRACKING_STATE:
      return sbp_pack_sbp_msg_tracking_state_t(buf, len,
                                               &msg->MSG_TRACKING_STATE);
    case SBP_MSG_MEASUREMENT_STATE:
      return sbp_pack_sbp_msg_measurement_state_t(buf, len,
                                                  &msg->MSG_MEASUREMENT_STATE);
    case SBP_MSG_TRACKING_IQ:
      return sbp_pack_sbp_msg_tracking_iq_t(buf, len, &msg->MSG_TRACKING_IQ);
    case SBP_MSG_TRACKING_IQ_DEP_B:
      return sbp_pack_sbp_msg_tracking_iq_dep_b_t(buf, len,
                                                  &msg->MSG_TRACKING_IQ_DEP_B);
    case SBP_MSG_TRACKING_IQ_DEP_A:
      return sbp_pack_sbp_msg_tracking_iq_dep_a_t(buf, len,
                                                  &msg->MSG_TRACKING_IQ_DEP_A);
    case SBP_MSG_TRACKING_STATE_DEP_A:
      return sbp_pack_sbp_msg_tracking_state_dep_a_t(
          buf, len, &msg->MSG_TRACKING_STATE_DEP_A);
    case SBP_MSG_TRACKING_STATE_DEP_B:
      return sbp_pack_sbp_msg_tracking_state_dep_b_t(
          buf, len, &msg->MSG_TRACKING_STATE_DEP_B);
    case SBP_MSG_SETTINGS_SAVE:
      return sbp_pack_sbp_msg_settings_save_t(buf, len,
                                              &msg->MSG_SETTINGS_SAVE);
    case SBP_MSG_SETTINGS_WRITE:
      return sbp_pack_sbp_msg_settings_write_t(buf, len,
                                               &msg->MSG_SETTINGS_WRITE);
    case SBP_MSG_SETTINGS_WRITE_RESP:
      return sbp_pack_sbp_msg_settings_write_resp_t(
          buf, len, &msg->MSG_SETTINGS_WRITE_RESP);
    case SBP_MSG_SETTINGS_READ_REQ:
      return sbp_pack_sbp_msg_settings_read_req_t(buf, len,
                                                  &msg->MSG_SETTINGS_READ_REQ);
    case SBP_MSG_SETTINGS_READ_RESP:
      return sbp_pack_sbp_msg_settings_read_resp_t(
          buf, len, &msg->MSG_SETTINGS_READ_RESP);
    case SBP_MSG_SETTINGS_READ_BY_INDEX_REQ:
      return sbp_pack_sbp_msg_settings_read_by_index_req_t(
          buf, len, &msg->MSG_SETTINGS_READ_BY_INDEX_REQ);
    case SBP_MSG_SETTINGS_READ_BY_INDEX_RESP:
      return sbp_pack_sbp_msg_settings_read_by_index_resp_t(
          buf, len, &msg->MSG_SETTINGS_READ_BY_INDEX_RESP);
    case SBP_MSG_SETTINGS_READ_BY_INDEX_DONE:
      return sbp_pack_sbp_msg_settings_read_by_index_done_t(
          buf, len, &msg->MSG_SETTINGS_READ_BY_INDEX_DONE);
    case SBP_MSG_SETTINGS_REGISTER:
      return sbp_pack_sbp_msg_settings_register_t(buf, len,
                                                  &msg->MSG_SETTINGS_REGISTER);
    case SBP_MSG_SETTINGS_REGISTER_RESP:
      return sbp_pack_sbp_msg_settings_register_resp_t(
          buf, len, &msg->MSG_SETTINGS_REGISTER_RESP);
    case SBP_MSG_SSR_ORBIT_CLOCK:
      return sbp_pack_sbp_msg_ssr_orbit_clock_t(buf, len,
                                                &msg->MSG_SSR_ORBIT_CLOCK);
    case SBP_MSG_SSR_CODE_BIASES:
      return sbp_pack_sbp_msg_ssr_code_biases_t(buf, len,
                                                &msg->MSG_SSR_CODE_BIASES);
    case SBP_MSG_SSR_PHASE_BIASES:
      return sbp_pack_sbp_msg_ssr_phase_biases_t(buf, len,
                                                 &msg->MSG_SSR_PHASE_BIASES);
    case SBP_MSG_SSR_STEC_CORRECTION:
      return sbp_pack_sbp_msg_ssr_stec_correction_t(
          buf, len, &msg->MSG_SSR_STEC_CORRECTION);
    case SBP_MSG_SSR_GRIDDED_CORRECTION:
      return sbp_pack_sbp_msg_ssr_gridded_correction_t(
          buf, len, &msg->MSG_SSR_GRIDDED_CORRECTION);
    case SBP_MSG_SSR_TILE_DEFINITION:
      return sbp_pack_sbp_msg_ssr_tile_definition_t(
          buf, len, &msg->MSG_SSR_TILE_DEFINITION);
    case SBP_MSG_SSR_SATELLITE_APC:
      return sbp_pack_sbp_msg_ssr_satellite_apc_t(buf, len,
                                                  &msg->MSG_SSR_SATELLITE_APC);
    case SBP_MSG_SSR_ORBIT_CLOCK_DEP_A:
      return sbp_pack_sbp_msg_ssr_orbit_clock_dep_a_t(
          buf, len, &msg->MSG_SSR_ORBIT_CLOCK_DEP_A);
    case SBP_MSG_SSR_STEC_CORRECTION_DEP_A:
      return sbp_pack_sbp_msg_ssr_stec_correction_dep_a_t(
          buf, len, &msg->MSG_SSR_STEC_CORRECTION_DEP_A);
    ...
    case SBP_MSG_SSR_GRIDDED_CORRECTION_DEP_A:
      return sbp_pack_sbp_msg_ssr_gridded_correction_dep_a_t(
          buf, len, &msg->MSG_SSR_GRIDDED_CORRECTION_DEP_A);
    case SBP_MSG_SSR_GRID_DEFINITION_DEP_A:
      return sbp_pack_sbp_msg_ssr_grid_definition_dep_a_t(
          buf, len, &msg->MSG_SSR_GRID_DEFINITION_DEP_A);
    ...
    case SBP_MSG_LINUX_CPU_STATE_DEP_A:
      return sbp_pack_sbp_msg_linux_cpu_state_dep_a_t(
          buf, len, &msg->MSG_LINUX_CPU_STATE_DEP_A);
    case SBP_MSG_LINUX_MEM_STATE_DEP_A:
      return sbp_pack_sbp_msg_linux_mem_state_dep_a_t(
          buf, len, &msg->MSG_LINUX_MEM_STATE_DEP_A);
    case SBP_MSG_LINUX_SYS_STATE_DEP_A:
      return sbp_pack_sbp_msg_linux_sys_state_dep_a_t(
          buf, len, &msg->MSG_LINUX_SYS_STATE_DEP_A);
    case SBP_MSG_LINUX_PROCESS_SOCKET_COUNTS:
      return sbp_pack_sbp_msg_linux_process_socket_counts_t(
          buf, len, &msg->MSG_LINUX_PROCESS_SOCKET_COUNTS);
    case SBP_MSG_LINUX_PROCESS_SOCKET_QUEUES:
      return sbp_pack_sbp_msg_linux_process_socket_queues_t(
          buf, len, &msg->MSG_LINUX_PROCESS_SOCKET_QUEUES);
    case SBP_MSG_LINUX_SOCKET_USAGE:
      return sbp_pack_sbp_msg_linux_socket_usage_t(
          buf, len, &msg->MSG_LINUX_SOCKET_USAGE);
    case SBP_MSG_LINUX_PROCESS_FD_COUNT:
      return sbp_pack_sbp_msg_linux_process_fd_count_t(
          buf, len, &msg->MSG_LINUX_PROCESS_FD_COUNT);
    case SBP_MSG_LINUX_PROCESS_FD_SUMMARY:
      return sbp_pack_sbp_msg_linux_process_fd_summary_t(
          buf, len, &msg->MSG_LINUX_PROCESS_FD_SUMMARY);
    case SBP_MSG_LINUX_CPU_STATE:
      return sbp_pack_sbp_msg_linux_cpu_state_t(buf, len,
                                                &msg->MSG_LINUX_CPU_STATE);
    case SBP_MSG_LINUX_MEM_STATE:
      return sbp_pack_sbp_msg_linux_mem_state_t(buf, len,
                                                &msg->MSG_LINUX_MEM_STATE);
    case SBP_MSG_LINUX_SYS_STATE:
      return sbp_pack_sbp_msg_linux_sys_state_t(buf, len,
                                                &msg->MSG_LINUX_SYS_STATE);
    case SBP_MSG_GPS_TIME:
      return sbp_pack_sbp_msg_gps_time_t(buf, len, &msg->MSG_GPS_TIME);
    case SBP_MSG_GPS_TIME_GNSS:
      return sbp_pack_sbp_msg_gps_time_gnss_t(buf, len,
                                              &msg->MSG_GPS_TIME_GNSS);
    case SBP_MSG_UTC_TIME:
      return sbp_pack_sbp_msg_utc_time_t(buf, len, &msg->MSG_UTC_TIME);
    case SBP_MSG_UTC_TIME_GNSS:
      return sbp_pack_sbp_msg_utc_time_gnss_t(buf, len,
                                              &msg->MSG_UTC_TIME_GNSS);
    case SBP_MSG_DOPS:
    ...
    case SBP_MSG_BASELINE_ECEF:
      return sbp_pack_sbp_msg_baseline_ecef_t(buf, len,
                                              &msg->MSG_BASELINE_ECEF);
    ...
    case SBP_MSG_POS_ECEF_GNSS:
      return sbp_pack_sbp_msg_pos_ecef_gnss_t(buf, len,
                                              &msg->MSG_POS_ECEF_GNSS);
    case SBP_MSG_POS_ECEF_COV_GNSS:
      return sbp_pack_sbp_msg_pos_ecef_cov_gnss_t(buf, len,
                                                  &msg->MSG_POS_ECEF_COV_GNSS);
    ...
    case SBP_MSG_POS_LLH_COV_GNSS:
      return sbp_pack_sbp_msg_pos_llh_cov_gnss_t(buf, len,
                                                 &msg->MSG_POS_LLH_COV_GNSS);
    case SBP_MSG_VEL_ECEF_GNSS:
      return sbp_pack_sbp_msg_vel_ecef_gnss_t(buf, len,
                                              &msg->MSG_VEL_ECEF_GNSS);
    case SBP_MSG_VEL_ECEF_COV_GNSS:
      return sbp_pack_sbp_msg_vel_ecef_cov_gnss_t(buf, len,
                                                  &msg->MSG_VEL_ECEF_COV_GNSS);
    ...
    case SBP_MSG_VEL_NED_COV_GNSS:
      return sbp_pack_sbp_msg_vel_ned_cov_gnss_t(buf, len,
                                                 &msg->MSG_VEL_NED_COV_GNSS);
    case SBP_MSG_VEL_BODY:
      return sbp_pack_sbp_msg_vel_body_t(buf, len, &msg->MSG_VEL_BODY);
    case SBP_MSG_AGE_CORRECTIONS:
      return sbp_pack_sbp_msg_age_corrections_t(buf, len,
                                                &msg->MSG_AGE_CORRECTIONS);
    case SBP_MSG_GPS_TIME_DEP_A:
      return sbp_pack_sbp_msg_gps_time_dep_a_t(buf, len,
                                               &msg->MSG_GPS_TIME_DEP_A);
    case SBP_MSG_DOPS_DEP_A:
      return sbp_pack_sbp_msg_dops_dep_a_t(buf, len, &msg->MSG_DOPS_DEP_A);
    case SBP_MSG_POS_ECEF_DEP_A:
      return sbp_pack_sbp_msg_pos_ecef_dep_a_t(buf, len,
                                               &msg->MSG_POS_ECEF_DEP_A);
    case SBP_MSG_POS_LLH_DEP_A:
      return sbp_pack_sbp_msg_pos_llh_dep_a_t(buf, len,
                                              &msg->MSG_POS_LLH_DEP_A);
    case SBP_MSG_BASELINE_ECEF_DEP_A:
      return sbp_pack_sbp_msg_baseline_ecef_dep_a_t(
          buf, len, &msg->MSG_BASELINE_ECEF_DEP_A);
    case SBP_MSG_BASELINE_NED_DEP_A:
      return sbp_pack_sbp_msg_baseline_ned_dep_a_t(
          buf, len, &msg->MSG_BASELINE_NED_DEP_A);
    case SBP_MSG_VEL_ECEF_DEP_A:
      return sbp_pack_sbp_msg_vel_ecef_dep_a_t(buf, len,
                                               &msg->MSG_VEL_ECEF_DEP_A);
    case SBP_MSG_VEL_NED_DEP_A:
      return sbp_pack_sbp_msg_vel_ned_dep_a_t(buf, len,
                                              &msg->MSG_VEL_NED_DEP_A);
    case SBP_MSG_BASELINE_HEADING_DEP_A:
      return sbp_pack_sbp_msg_baseline_heading_dep_a_t(
          buf, len, &msg->MSG_BASELINE_HEADING_DEP_A);
    case SBP_MSG_PROTECTION_LEVEL:
      return sbp_pack_sbp_msg_protection_level_t(buf, len,
                                                 &msg->MSG_PROTECTION_LEVEL);
    case SBP_MSG_FILEIO_READ_REQ:
      return sbp_pack_sbp_msg_fileio_read_req_t(buf, len,
                                                &msg->MSG_FILEIO_READ_REQ);
    case SBP_MSG_FILEIO_READ_RESP:
      return sbp_pack_sbp_msg_fileio_read_resp_t(buf, len,
                                                 &msg->MSG_FILEIO_READ_RESP);
    case SBP_MSG_FILEIO_READ_DIR_REQ:
      return sbp_pack_sbp_msg_fileio_read_dir_req_t(
          buf, len, &msg->MSG_FILEIO_READ_DIR_REQ);
    case SBP_MSG_FILEIO_READ_DIR_RESP:
      return sbp_pack_sbp_msg_fileio_read_dir_resp_t(
          buf, len, &msg->MSG_FILEIO_READ_DIR_RESP);
    case SBP_MSG_FILEIO_REMOVE:
      return sbp_pack_sbp_msg_fileio_remove_t(buf, len,
                                              &msg->MSG_FILEIO_REMOVE);
    case SBP_MSG_FILEIO_WRITE_REQ:
      return sbp_pack_sbp_msg_fileio_write_req_t(buf, len,
                                                 &msg->MSG_FILEIO_WRITE_REQ);
    case SBP_MSG_FILEIO_WRITE_RESP:
      return sbp_pack_sbp_msg_fileio_write_resp_t(buf, len,
                                                  &msg->MSG_FILEIO_WRITE_RESP);
    case SBP_MSG_FILEIO_CONFIG_REQ:
      return sbp_pack_sbp_msg_fileio_config_req_t(buf, len,
                                                  &msg->MSG_FILEIO_CONFIG_REQ);
    case SBP_MSG_FILEIO_CONFIG_RESP:
      return sbp_pack_sbp_msg_fileio_config_resp_t(
          buf, len, &msg->MSG_FILEIO_CONFIG_RESP);
    case SBP_MSG_LOG:
    ...
    case SBP_MSG_BOOTLOADER_HANDSHAKE_REQ:
      return sbp_pack_sbp_msg_bootloader_handshake_req_t(
          buf, len, &msg->MSG_BOOTLOADER_HANDSHAKE_REQ);
    case SBP_MSG_BOOTLOADER_HANDSHAKE_RESP:
      return sbp_pack_sbp_msg_bootloader_handshake_resp_t(
          buf, len, &msg->MSG_BOOTLOADER_HANDSHAKE_RESP);
    case SBP_MSG_BOOTLOADER_JUMP_TO_APP:
      return sbp_pack_sbp_msg_bootloader_jump_to_app_t(
          buf, len, &msg->MSG_BOOTLOADER_JUMP_TO_APP);
    case SBP_MSG_NAP_DEVICE_DNA_REQ:
      return sbp_pack_sbp_msg_nap_device_dna_req_t(
          buf, len, &msg->MSG_NAP_DEVICE_DNA_REQ);
    case SBP_MSG_NAP_DEVICE_DNA_RESP:
      return sbp_pack_sbp_msg_nap_device_dna_resp_t(
          buf, len, &msg->MSG_NAP_DEVICE_DNA_RESP);
    case SBP_MSG_BOOTLOADER_HANDSHAKE_DEP_A:
      return sbp_pack_sbp_msg_bootloader_handshake_dep_a_t(
          buf, len, &msg->MSG_BOOTLOADER_HANDSHAKE_DEP_A);
    ...
    case SBP_MSG_STATUS_REPORT:
      return sbp_pack_sbp_msg_status_report_t(buf, len,
                                              &msg->MSG_STATUS_REPORT);
    case SBP_MSG_INS_STATUS:
      return sbp_pack_sbp_msg_ins_status_t(buf, len, &msg->MSG_INS_STATUS);
    case SBP_MSG_CSAC_TELEMETRY:
      return sbp_pack_sbp_msg_csac_telemetry_t(buf, len,
                                               &msg->MSG_CSAC_TELEMETRY);
    case SBP_MSG_CSAC_TELEMETRY_LABELS:
      return sbp_pack_sbp_msg_csac_telemetry_labels_t(
          buf, len, &msg->MSG_CSAC_TELEMETRY_LABELS);
    case SBP_MSG_INS_UPDATES:
      return sbp_pack_sbp_msg_ins_updates_t(buf, len, &msg->MSG_INS_UPDATES);
    case SBP_MSG_GNSS_TIME_OFFSET:
      return sbp_pack_sbp_msg_gnss_time_offset_t(buf, len,
                                                 &msg->MSG_GNSS_TIME_OFFSET);
    ...
    case SBP_MSG_BASE_POS_ECEF:
      return sbp_pack_sbp_msg_base_pos_ecef_t(buf, len,
                                              &msg->MSG_BASE_POS_ECEF);
    case SBP_MSG_EPHEMERIS_GPS_DEP_E:
      return sbp_pack_sbp_msg_ephemeris_gps_dep_e_t(
          buf, len, &msg->MSG_EPHEMERIS_GPS_DEP_E);
    case SBP_MSG_EPHEMERIS_GPS_DEP_F:
      return sbp_pack_sbp_msg_ephemeris_gps_dep_f_t(
          buf, len, &msg->MSG_EPHEMERIS_GPS_DEP_F);
    case SBP_MSG_EPHEMERIS_GPS:
      return sbp_pack_sbp_msg_ephemeris_gps_t(buf, len,
                                              &msg->MSG_EPHEMERIS_GPS);
    case SBP_MSG_EPHEMERIS_QZSS:
      return sbp_pack_sbp_msg_ephemeris_qzss_t(buf, len,
                                               &msg->MSG_EPHEMERIS_QZSS);
    case SBP_MSG_EPHEMERIS_BDS:
      return sbp_pack_sbp_msg_ephemeris_bds_t(buf, len,
                                              &msg->MSG_EPHEMERIS_BDS);
    case SBP_MSG_EPHEMERIS_GAL_DEP_A:
      return sbp_pack_sbp_msg_ephemeris_gal_dep_a_t(
          buf, len, &msg->MSG_EPHEMERIS_GAL_DEP_A);
    case SBP_MSG_EPHEMERIS_GAL:
      return sbp_pack_sbp_msg_ephemeris_gal_t(buf, len,
                                              &msg->MSG_EPHEMERIS_GAL);
    case SBP_MSG_EPHEMERIS_SBAS_DEP_A:
      return sbp_pack_sbp_msg_ephemeris_sbas_dep_a_t(
          buf, len, &msg->MSG_EPHEMERIS_SBAS_DEP_A);
    case SBP_MSG_EPHEMERIS_GLO_DEP_A:
      return sbp_pack_sbp_msg_ephemeris_glo_dep_a_t(
          buf, len, &msg->MSG_EPHEMERIS_GLO_DEP_A);
    case SBP_MSG_EPHEMERIS_SBAS_DEP_B:
      return sbp_pack_sbp_msg_ephemeris_sbas_dep_b_t(
          buf, len, &msg->MSG_EPHEMERIS_SBAS_DEP_B);
    case SBP_MSG_EPHEMERIS_SBAS:
      return sbp_pack_sbp_msg_ephemeris_sbas_t(buf, len,
                                               &msg->MSG_EPHEMERIS_SBAS);
    case SBP_MSG_EPHEMERIS_GLO_DEP_B:
      return sbp_pack_sbp_msg_ephemeris_glo_dep_b_t(
          buf, len, &msg->MSG_EPHEMERIS_GLO_DEP_B);
    case SBP_MSG_EPHEMERIS_GLO_DEP_C:
      return sbp_pack_sbp_msg_ephemeris_glo_dep_c_t(
          buf, len, &msg->MSG_EPHEMERIS_GLO_DEP_C);
    case SBP_MSG_EPHEMERIS_GLO_DEP_D:
      return sbp_pack_sbp_msg_ephemeris_glo_dep_d_t(
          buf, len, &msg->MSG_EPHEMERIS_GLO_DEP_D);
    case SBP_MSG_EPHEMERIS_GLO:
      return sbp_pack_sbp_msg_ephemeris_glo_t(buf, len,
                                              &msg->MSG_EPHEMERIS_GLO);
    case SBP_MSG_EPHEMERIS_DEP_D:
      return sbp_pack_sbp_msg_ephemeris_dep_d_t(buf, len,
                                                &msg->MSG_EPHEMERIS_DEP_D);
    case SBP_MSG_EPHEMERIS_DEP_A:
      return sbp_pack_sbp_msg_ephemeris_dep_a_t(buf, len,
                                                &msg->MSG_EPHEMERIS_DEP_A);
    case SBP_MSG_EPHEMERIS_DEP_B:
      return sbp_pack_sbp_msg_ephemeris_dep_b_t(buf, len,
                                                &msg->MSG_EPHEMERIS_DEP_B);
    case SBP_MSG_EPHEMERIS_DEP_C:
      return sbp_pack_sbp_msg_ephemeris_dep_c_t(buf, len,
                                                &msg->MSG_EPHEMERIS_DEP_C);
    ...
    case SBP_MSG_SV_CONFIGURATION_GPS_DEP:
      return sbp_pack_sbp_msg_sv_configuration_gps_dep_t(
          buf, len, &msg->MSG_SV_CONFIGURATION_GPS_DEP);
    case SBP_MSG_GNSS_CAPB:
      return sbp_pack_sbp_msg_gnss_capb_t(buf, len, &msg->MSG_GNSS_CAPB);
    case SBP_MSG_GROUP_DELAY_DEP_A:
      return sbp_pack_sbp_msg_group_delay_dep_a_t(buf, len,
                                                  &msg->MSG_GROUP_DELAY_DEP_A);
    case SBP_MSG_GROUP_DELAY_DEP_B:
      return sbp_pack_sbp_msg_group_delay_dep_b_t(buf, len,
                                                  &msg->MSG_GROUP_DELAY_DEP_B);
    case SBP_MSG_GROUP_DELAY:
      return sbp_pack_sbp_msg_group_delay_t(buf, len, &msg->MSG_GROUP_DELAY);
    case SBP_MSG_ALMANAC_GPS_DEP:
      return sbp_pack_sbp_msg_almanac_gps_dep_t(buf, len,
                                                &msg->MSG_ALMANAC_GPS_DEP);
    case SBP_MSG_ALMANAC_GPS:
      return sbp_pack_sbp_msg_almanac_gps_t(buf, len, &msg->MSG_ALMANAC_GPS);
    case SBP_MSG_ALMANAC_GLO_DEP:
      return sbp_pack_sbp_msg_almanac_glo_dep_t(buf, len,
                                                &msg->MSG_ALMANAC_GLO_DEP);
    ...
    case SBP_MSG_RESET_FILTERS:
      return sbp_pack_sbp_msg_reset_filters_t(buf, len,
                                              &msg->MSG_RESET_FILTERS);
    case SBP_MSG_INIT_BASE_DEP:
      return sbp_pack_sbp_msg_init_base_dep_t(buf, len,
                                              &msg->MSG_INIT_BASE_DEP);
    ...
    case SBP_MSG_UART_STATE_DEPA:
      return sbp_pack_sbp_msg_uart_state_depa_t(buf, len,
                                                &msg->MSG_UART_STATE_DEPA);
    case SBP_MSG_IAR_STATE:
      return sbp_pack_sbp_msg_iar_state_t(buf, len, &msg->MSG_IAR_STATE);
    case SBP_MSG_MASK_SATELLITE:
      return sbp_pack_sbp_msg_mask_satellite_t(buf, len,
                                               &msg->MSG_MASK_SATELLITE);
    case SBP_MSG_MASK_SATELLITE_DEP:
      return sbp_pack_sbp_msg_mask_satellite_dep_t(
          buf, len, &msg->MSG_MASK_SATELLITE_DEP);
    case SBP_MSG_DEVICE_MONITOR:
      return sbp_pack_sbp_msg_device_monitor_t(buf, len,
                                               &msg->MSG_DEVICE_MONITOR);
    ...
    case SBP_MSG_COMMAND_OUTPUT:
      return sbp_pack_sbp_msg_command_output_t(buf, len,
                                               &msg->MSG_COMMAND_OUTPUT);
    case SBP_MSG_NETWORK_STATE_REQ:
      return sbp_pack_sbp_msg_network_state_req_t(buf, len,
                                                  &msg->MSG_NETWORK_STATE_REQ);
    case SBP_MSG_NETWORK_STATE_RESP:
      return sbp_pack_sbp_msg_network_state_resp_t(
          buf, len, &msg->MSG_NETWORK_STATE_RESP);
    case SBP_MSG_NETWORK_BANDWIDTH_USAGE:
      return sbp_pack_sbp_msg_network_bandwidth_usage_t(
          buf, len, &msg->MSG_NETWORK_BANDWIDTH_USAGE);
    case SBP_MSG_CELL_MODEM_STATUS:
      return sbp_pack_sbp_msg_cell_modem_status_t(buf, len,
                                                  &msg->MSG_CELL_MODEM_STATUS);
    ...
    case SBP_MSG_FRONT_END_GAIN:
      return sbp_pack_sbp_msg_front_end_gain_t(buf, len,
                                               &msg->MSG_FRONT_END_GAIN);
    case SBP_MSG_FLASH_PROGRAM:
      return sbp_pack_sbp_msg_flash_program_t(buf, len,
                                              &msg->MSG_FLASH_PROGRAM);
    case SBP_MSG_FLASH_DONE:
      return sbp_pack_sbp_msg_flash_done_t(buf, len, &msg->MSG_FLASH_DONE);
    case SBP_MSG_FLASH_READ_REQ:
      return sbp_pack_sbp_msg_flash_read_req_t(buf, len,
                                               &msg->MSG_FLASH_READ_REQ);
    case SBP_MSG_FLASH_READ_RESP:
      return sbp_pack_sbp_msg_flash_read_resp_t(buf, len,
                                                &msg->MSG_FLASH_READ_RESP);
    ...
    case SBP_MSG_STM_FLASH_LOCK_SECTOR:
      return sbp_pack_sbp_msg_stm_flash_lock_sector_t(
          buf, len, &msg->MSG_STM_FLASH_LOCK_SECTOR);
    case SBP_MSG_STM_FLASH_UNLOCK_SECTOR:
      return sbp_pack_sbp_msg_stm_flash_unlock_sector_t(
          buf, len, &msg->MSG_STM_FLASH_UNLOCK_SECTOR);
    case SBP_MSG_STM_UNIQUE_ID_REQ:
      return sbp_pack_sbp_msg_stm_unique_id_req_t(buf, len,
                                                  &msg->MSG_STM_UNIQUE_ID_REQ);
    case SBP_MSG_STM_UNIQUE_ID_RESP:
      return sbp_pack_sbp_msg_stm_unique_id_resp_t(
          buf, len, &msg->MSG_STM_UNIQUE_ID_RESP);
    case SBP_MSG_M25_FLASH_WRITE_STATUS:
      return sbp_pack_sbp_msg_m25_flash_write_status_t(
          buf, len, &msg->MSG_M25_FLASH_WRITE_STATUS);
    ...
    case SBP_MSG_ACQ_RESULT_DEP_C:
      return sbp_pack_sbp_msg_acq_result_dep_c_t(buf, len,
                                                 &msg->MSG_ACQ_RESULT_DEP_C);
    case SBP_MSG_ACQ_RESULT_DEP_B:
      return sbp_pack_sbp_msg_acq_result_dep_b_t(buf, len,
                                                 &msg->MSG_ACQ_RESULT_DEP_B);
    case SBP_MSG_ACQ_RESULT_DEP_A:
      return sbp_pack_sbp_msg_acq_result_dep_a_t(buf, len,
                                                 &msg->MSG_ACQ_RESULT_DEP_A);
    case SBP_MSG_ACQ_SV_PROFILE:
      return sbp_pack_sbp_msg_acq_sv_profile_t(buf, len,
                                               &msg->MSG_ACQ_SV_PROFILE);
    case SBP_MSG_ACQ_SV_PROFILE_DEP:
      return sbp_pack_sbp_msg_acq_sv_profile_dep_t(
          buf, len, &msg->MSG_ACQ_SV_PROFILE_DEP);
    case SBP_MSG_SOLN_META_DEP_A:
      return sbp_pack_sbp_msg_soln_meta_dep_a_t(buf, len,
                                                &msg->MSG_SOLN_META_DEP_A);
    case SBP_MSG_SOLN_META:
      return sbp_pack_sbp_msg_soln_meta_t(buf, len, &msg->MSG_SOLN_META);
    case SBP_MSG_BASELINE_HEADING:
      return sbp_pack_sbp_msg_baseline_heading_t(buf, len,
                                                 &msg->MSG_BASELINE_HEADING);
...
static inline bool sbp_unpack_msg(const uint8_t *buf, size_t len,
                                  sbp_msg_t *msg) {
  switch (msg->type) {
    case SBP_MSG_TRACKING_STATE_DETAILED_DEP_A:
      return sbp_unpack_sbp_msg_tracking_state_detailed_dep_a_t(
          buf, len, &msg->MSG_TRACKING_STATE_DETAILED_DEP_A);
    case SBP_MSG_TRACKING_STATE_DETAILED_DEP:
      return sbp_unpack_sbp_msg_tracking_state_detailed_dep_t(
          buf, len, &msg->MSG_TRACKING_STATE_DETAILED_DEP);
    case SBP_MSG_TRACKING_STATE:
      return sbp_unpack_sbp_msg_tracking_state_t(buf, len,
                                                 &msg->MSG_TRACKING_STATE);
    case SBP_MSG_MEASUREMENT_STATE:
      return sbp_unpack_sbp_msg_measurement_state_t(
          buf, len, &msg->MSG_MEASUREMENT_STATE);
    case SBP_MSG_TRACKING_IQ:
      return sbp_unpack_sbp_msg_tracking_iq_t(buf, len, &msg->MSG_TRACKING_IQ);
    case SBP_MSG_TRACKING_IQ_DEP_B:
      return sbp_unpack_sbp_msg_tracking_iq_dep_b_t(
          buf, len, &msg->MSG_TRACKING_IQ_DEP_B);
    case SBP_MSG_TRACKING_IQ_DEP_A:
      return sbp_unpack_sbp_msg_tracking_iq_dep_a_t(
          buf, len, &msg->MSG_TRACKING_IQ_DEP_A);
    case SBP_MSG_TRACKING_STATE_DEP_A:
      return sbp_unpack_sbp_msg_tracking_state_dep_a_t(
          buf, len, &msg->MSG_TRACKING_STATE_DEP_A);
    case SBP_MSG_TRACKING_STATE_DEP_B:
      return sbp_unpack_sbp_msg_tracking_state_dep_b_t(
          buf, len, &msg->MSG_TRACKING_STATE_DEP_B);
    case SBP_MSG_SETTINGS_SAVE:
      return sbp_unpack_sbp_msg_settings_save_t(buf, len,
                                                &msg->MSG_SETTINGS_SAVE);
    case SBP_MSG_SETTINGS_WRITE:
      return sbp_unpack_sbp_msg_settings_write_t(buf, len,
                                                 &msg->MSG_SETTINGS_WRITE);
    case SBP_MSG_SETTINGS_WRITE_RESP:
      return sbp_unpack_sbp_msg_settings_write_resp_t(
          buf, len, &msg->MSG_SETTINGS_WRITE_RESP);
    case SBP_MSG_SETTINGS_READ_REQ:
      return sbp_unpack_sbp_msg_settings_read_req_t(
          buf, len, &msg->MSG_SETTINGS_READ_REQ);
    case SBP_MSG_SETTINGS_READ_RESP:
      return sbp_unpack_sbp_msg_settings_read_resp_t(
          buf, len, &msg->MSG_SETTINGS_READ_RESP);
    case SBP_MSG_SETTINGS_READ_BY_INDEX_REQ:
      return sbp_unpack_sbp_msg_settings_read_by_index_req_t(
          buf, len, &msg->MSG_SETTINGS_READ_BY_INDEX_REQ);
    case SBP_MSG_SETTINGS_READ_BY_INDEX_RESP:
      return sbp_unpack_sbp_msg_settings_read_by_index_resp_t(
          buf, len, &msg->MSG_SETTINGS_READ_BY_INDEX_RESP);
    case SBP_MSG_SETTINGS_READ_BY_INDEX_DONE:
      return sbp_unpack_sbp_msg_settings_read_by_index_done_t(
          buf, len, &msg->MSG_SETTINGS_READ_BY_INDEX_DONE);
    case SBP_MSG_SETTINGS_REGISTER:
      return sbp_unpack_sbp_msg_settings_register_t(
          buf, len, &msg->MSG_SETTINGS_REGISTER);
    case SBP_MSG_SETTINGS_REGISTER_RESP:
      return sbp_unpack_sbp_msg_settings_register_resp_t(
          buf, len, &msg->MSG_SETTINGS_REGISTER_RESP);
    case SBP_MSG_SSR_ORBIT_CLOCK:
      return sbp_unpack_sbp_msg_ssr_orbit_clock_t(buf, len,
                                                  &msg->MSG_SSR_ORBIT_CLOCK);
    case SBP_MSG_SSR_CODE_BIASES:
      return sbp_unpack_sbp_msg_ssr_code_biases_t(buf, len,
                                                  &msg->MSG_SSR_CODE_BIASES);
    case SBP_MSG_SSR_PHASE_BIASES:
      return sbp_unpack_sbp_msg_ssr_phase_biases_t(buf, len,
                                                   &msg->MSG_SSR_PHASE_BIASES);
    case SBP_MSG_SSR_STEC_CORRECTION:
      return sbp_unpack_sbp_msg_ssr_stec_correction_t(
          buf, len, &msg->MSG_SSR_STEC_CORRECTION);
    case SBP_MSG_SSR_GRIDDED_CORRECTION:
      return sbp_unpack_sbp_msg_ssr_gridded_correction_t(
          buf, len, &msg->MSG_SSR_GRIDDED_CORRECTION);
    case SBP_MSG_SSR_TILE_DEFINITION:
      return sbp_unpack_sbp_msg_ssr_tile_definition_t(
          buf, len, &msg->MSG_SSR_TILE_DEFINITION);
    case SBP_MSG_SSR_SATELLITE_APC:
      return sbp_unpack_sbp_msg_ssr_satellite_apc_t(
          buf, len, &msg->MSG_SSR_SATELLITE_APC);
    case SBP_MSG_SSR_ORBIT_CLOCK_DEP_A:
      return sbp_unpack_sbp_msg_ssr_orbit_clock_dep_a_t(
          buf, len, &msg->MSG_SSR_ORBIT_CLOCK_DEP_A);
    case SBP_MSG_SSR_STEC_CORRECTION_DEP_A:
      return sbp_unpack_sbp_msg_ssr_stec_correction_dep_a_t(
          buf, len, &msg->MSG_SSR_STEC_CORRECTION_DEP_A);
    case SBP_MSG_SSR_GRIDDED_CORRECTION_NO_STD_DEP_A:
      return sbp_unpack_sbp_msg_ssr_gridded_correction_no_std_dep_a_t(
          buf, len, &msg->MSG_SSR_GRIDDED_CORRECTION_NO_STD_DEP_A);
    case SBP_MSG_SSR_GRIDDED_CORRECTION_DEP_A:
      return sbp_unpack_sbp_msg_ssr_gridded_correction_dep_a_t(
          buf, len, &msg->MSG_SSR_GRIDDED_CORRECTION_DEP_A);
    case SBP_MSG_SSR_GRID_DEFINITION_DEP_A:
      return sbp_unpack_sbp_msg_ssr_grid_definition_dep_a_t(
          buf, len, &msg->MSG_SSR_GRID_DEFINITION_DEP_A);
    case SBP_MSG_EXT_EVENT:
    ...
    case SBP_MSG_LINUX_CPU_STATE_DEP_A:
      return sbp_unpack_sbp_msg_linux_cpu_state_dep_a_t(
          buf, len, &msg->MSG_LINUX_CPU_STATE_DEP_A);
    case SBP_MSG_LINUX_MEM_STATE_DEP_A:
      return sbp_unpack_sbp_msg_linux_mem_state_dep_a_t(
          buf, len, &msg->MSG_LINUX_MEM_STATE_DEP_A);
    case SBP_MSG_LINUX_SYS_STATE_DEP_A:
      return sbp_unpack_sbp_msg_linux_sys_state_dep_a_t(
          buf, len, &msg->MSG_LINUX_SYS_STATE_DEP_A);
    case SBP_MSG_LINUX_PROCESS_SOCKET_COUNTS:
      return sbp_unpack_sbp_msg_linux_process_socket_counts_t(
          buf, len, &msg->MSG_LINUX_PROCESS_SOCKET_COUNTS);
    case SBP_MSG_LINUX_PROCESS_SOCKET_QUEUES:
      return sbp_unpack_sbp_msg_linux_process_socket_queues_t(
          buf, len, &msg->MSG_LINUX_PROCESS_SOCKET_QUEUES);
    case SBP_MSG_LINUX_SOCKET_USAGE:
      return sbp_unpack_sbp_msg_linux_socket_usage_t(
          buf, len, &msg->MSG_LINUX_SOCKET_USAGE);
    case SBP_MSG_LINUX_PROCESS_FD_COUNT:
      return sbp_unpack_sbp_msg_linux_process_fd_count_t(
          buf, len, &msg->MSG_LINUX_PROCESS_FD_COUNT);
    case SBP_MSG_LINUX_PROCESS_FD_SUMMARY:
      return sbp_unpack_sbp_msg_linux_process_fd_summary_t(
          buf, len, &msg->MSG_LINUX_PROCESS_FD_SUMMARY);
    case SBP_MSG_LINUX_CPU_STATE:
      return sbp_unpack_sbp_msg_linux_cpu_state_t(buf, len,
                                                  &msg->MSG_LINUX_CPU_STATE);
    case SBP_MSG_LINUX_MEM_STATE:
      return sbp_unpack_sbp_msg_linux_mem_state_t(buf, len,
                                                  &msg->MSG_LINUX_MEM_STATE);
    case SBP_MSG_LINUX_SYS_STATE:
      return sbp_unpack_sbp_msg_linux_sys_state_t(buf, len,
                                                  &msg->MSG_LINUX_SYS_STATE);
    case SBP_MSG_GPS_TIME:
      return sbp_unpack_sbp_msg_gps_time_t(buf, len, &msg->MSG_GPS_TIME);
    case SBP_MSG_GPS_TIME_GNSS:
      return sbp_unpack_sbp_msg_gps_time_gnss_t(buf, len,
                                                &msg->MSG_GPS_TIME_GNSS);
    case SBP_MSG_UTC_TIME:
      return sbp_unpack_sbp_msg_utc_time_t(buf, len, &msg->MSG_UTC_TIME);
    case SBP_MSG_UTC_TIME_GNSS:
      return sbp_unpack_sbp_msg_utc_time_gnss_t(buf, len,
                                                &msg->MSG_UTC_TIME_GNSS);
    case SBP_MSG_DOPS:
    ...
    case SBP_MSG_POS_ECEF_COV:
      return sbp_unpack_sbp_msg_pos_ecef_cov_t(buf, len,
                                               &msg->MSG_POS_ECEF_COV);
    case SBP_MSG_POS_LLH:
    ...
    case SBP_MSG_BASELINE_ECEF:
      return sbp_unpack_sbp_msg_baseline_ecef_t(buf, len,
                                                &msg->MSG_BASELINE_ECEF);
    case SBP_MSG_BASELINE_NED:
      return sbp_unpack_sbp_msg_baseline_ned_t(buf, len,
                                               &msg->MSG_BASELINE_NED);
    case SBP_MSG_VEL_ECEF:
      return sbp_unpack_sbp_msg_vel_ecef_t(buf, len, &msg->MSG_VEL_ECEF);
    case SBP_MSG_VEL_ECEF_COV:
      return sbp_unpack_sbp_msg_vel_ecef_cov_t(buf, len,
                                               &msg->MSG_VEL_ECEF_COV);
    case SBP_MSG_VEL_NED:
    ...
    case SBP_MSG_POS_ECEF_GNSS:
      return sbp_unpack_sbp_msg_pos_ecef_gnss_t(buf, len,
                                                &msg->MSG_POS_ECEF_GNSS);
    case SBP_MSG_POS_ECEF_COV_GNSS:
      return sbp_unpack_sbp_msg_pos_ecef_cov_gnss_t(
          buf, len, &msg->MSG_POS_ECEF_COV_GNSS);
    case SBP_MSG_POS_LLH_GNSS:
      return sbp_unpack_sbp_msg_pos_llh_gnss_t(buf, len,
                                               &msg->MSG_POS_LLH_GNSS);
    case SBP_MSG_POS_LLH_COV_GNSS:
      return sbp_unpack_sbp_msg_pos_llh_cov_gnss_t(buf, len,
                                                   &msg->MSG_POS_LLH_COV_GNSS);
    case SBP_MSG_VEL_ECEF_GNSS:
      return sbp_unpack_sbp_msg_vel_ecef_gnss_t(buf, len,
                                                &msg->MSG_VEL_ECEF_GNSS);
    case SBP_MSG_VEL_ECEF_COV_GNSS:
      return sbp_unpack_sbp_msg_vel_ecef_cov_gnss_t(
          buf, len, &msg->MSG_VEL_ECEF_COV_GNSS);
    case SBP_MSG_VEL_NED_GNSS:
      return sbp_unpack_sbp_msg_vel_ned_gnss_t(buf, len,
                                               &msg->MSG_VEL_NED_GNSS);
    case SBP_MSG_VEL_NED_COV_GNSS:
      return sbp_unpack_sbp_msg_vel_ned_cov_gnss_t(buf, len,
                                                   &msg->MSG_VEL_NED_COV_GNSS);
    case SBP_MSG_VEL_BODY:
      return sbp_unpack_sbp_msg_vel_body_t(buf, len, &msg->MSG_VEL_BODY);
    case SBP_MSG_AGE_CORRECTIONS:
      return sbp_unpack_sbp_msg_age_corrections_t(buf, len,
                                                  &msg->MSG_AGE_CORRECTIONS);
    case SBP_MSG_GPS_TIME_DEP_A:
      return sbp_unpack_sbp_msg_gps_time_dep_a_t(buf, len,
                                                 &msg->MSG_GPS_TIME_DEP_A);
    case SBP_MSG_DOPS_DEP_A:
      return sbp_unpack_sbp_msg_dops_dep_a_t(buf, len, &msg->MSG_DOPS_DEP_A);
    case SBP_MSG_POS_ECEF_DEP_A:
      return sbp_unpack_sbp_msg_pos_ecef_dep_a_t(buf, len,
                                                 &msg->MSG_POS_ECEF_DEP_A);
    case SBP_MSG_POS_LLH_DEP_A:
      return sbp_unpack_sbp_msg_pos_llh_dep_a_t(buf, len,
                                                &msg->MSG_POS_LLH_DEP_A);
    case SBP_MSG_BASELINE_ECEF_DEP_A:
      return sbp_unpack_sbp_msg_baseline_ecef_dep_a_t(
          buf, len, &msg->MSG_BASELINE_ECEF_DEP_A);
    case SBP_MSG_BASELINE_NED_DEP_A:
      return sbp_unpack_sbp_msg_baseline_ned_dep_a_t(
          buf, len, &msg->MSG_BASELINE_NED_DEP_A);
    case SBP_MSG_VEL_ECEF_DEP_A:
      return sbp_unpack_sbp_msg_vel_ecef_dep_a_t(buf, len,
                                                 &msg->MSG_VEL_ECEF_DEP_A);
    case SBP_MSG_VEL_NED_DEP_A:
      return sbp_unpack_sbp_msg_vel_ned_dep_a_t(buf, len,
                                                &msg->MSG_VEL_NED_DEP_A);
    case SBP_MSG_BASELINE_HEADING_DEP_A:
      return sbp_unpack_sbp_msg_baseline_heading_dep_a_t(
          buf, len, &msg->MSG_BASELINE_HEADING_DEP_A);
    case SBP_MSG_PROTECTION_LEVEL:
      return sbp_unpack_sbp_msg_protection_level_t(buf, len,
                                                   &msg->MSG_PROTECTION_LEVEL);
    case SBP_MSG_FILEIO_READ_REQ:
      return sbp_unpack_sbp_msg_fileio_read_req_t(buf, len,
                                                  &msg->MSG_FILEIO_READ_REQ);
    case SBP_MSG_FILEIO_READ_RESP:
      return sbp_unpack_sbp_msg_fileio_read_resp_t(buf, len,
                                                   &msg->MSG_FILEIO_READ_RESP);
    case SBP_MSG_FILEIO_READ_DIR_REQ:
      return sbp_unpack_sbp_msg_fileio_read_dir_req_t(
          buf, len, &msg->MSG_FILEIO_READ_DIR_REQ);
    case SBP_MSG_FILEIO_READ_DIR_RESP:
      return sbp_unpack_sbp_msg_fileio_read_dir_resp_t(
          buf, len, &msg->MSG_FILEIO_READ_DIR_RESP);
    case SBP_MSG_FILEIO_REMOVE:
      return sbp_unpack_sbp_msg_fileio_remove_t(buf, len,
                                                &msg->MSG_FILEIO_REMOVE);
    case SBP_MSG_FILEIO_WRITE_REQ:
      return sbp_unpack_sbp_msg_fileio_write_req_t(buf, len,
                                                   &msg->MSG_FILEIO_WRITE_REQ);
    case SBP_MSG_FILEIO_WRITE_RESP:
      return sbp_unpack_sbp_msg_fileio_write_resp_t(
          buf, len, &msg->MSG_FILEIO_WRITE_RESP);
    case SBP_MSG_FILEIO_CONFIG_REQ:
      return sbp_unpack_sbp_msg_fileio_config_req_t(
          buf, len, &msg->MSG_FILEIO_CONFIG_REQ);
    case SBP_MSG_FILEIO_CONFIG_RESP:
      return sbp_unpack_sbp_msg_fileio_config_resp_t(
          buf, len, &msg->MSG_FILEIO_CONFIG_RESP);
    case SBP_MSG_LOG:
    ...
    case SBP_MSG_BOOTLOADER_HANDSHAKE_REQ:
      return sbp_unpack_sbp_msg_bootloader_handshake_req_t(
          buf, len, &msg->MSG_BOOTLOADER_HANDSHAKE_REQ);
    case SBP_MSG_BOOTLOADER_HANDSHAKE_RESP:
      return sbp_unpack_sbp_msg_bootloader_handshake_resp_t(
          buf, len, &msg->MSG_BOOTLOADER_HANDSHAKE_RESP);
    case SBP_MSG_BOOTLOADER_JUMP_TO_APP:
      return sbp_unpack_sbp_msg_bootloader_jump_to_app_t(
          buf, len, &msg->MSG_BOOTLOADER_JUMP_TO_APP);
    case SBP_MSG_NAP_DEVICE_DNA_REQ:
      return sbp_unpack_sbp_msg_nap_device_dna_req_t(
          buf, len, &msg->MSG_NAP_DEVICE_DNA_REQ);
    case SBP_MSG_NAP_DEVICE_DNA_RESP:
      return sbp_unpack_sbp_msg_nap_device_dna_resp_t(
          buf, len, &msg->MSG_NAP_DEVICE_DNA_RESP);
    case SBP_MSG_BOOTLOADER_HANDSHAKE_DEP_A:
      return sbp_unpack_sbp_msg_bootloader_handshake_dep_a_t(
          buf, len, &msg->MSG_BOOTLOADER_HANDSHAKE_DEP_A);
    case SBP_MSG_STARTUP:
      return sbp_unpack_sbp_msg_startup_t(buf, len, &msg->MSG_STARTUP);
    case SBP_MSG_DGNSS_STATUS:
      return sbp_unpack_sbp_msg_dgnss_status_t(buf, len,
                                               &msg->MSG_DGNSS_STATUS);
    case SBP_MSG_HEARTBEAT:
      return sbp_unpack_sbp_msg_heartbeat_t(buf, len, &msg->MSG_HEARTBEAT);
    case SBP_MSG_STATUS_REPORT:
      return sbp_unpack_sbp_msg_status_report_t(buf, len,
                                                &msg->MSG_STATUS_REPORT);
    case SBP_MSG_INS_STATUS:
      return sbp_unpack_sbp_msg_ins_status_t(buf, len, &msg->MSG_INS_STATUS);
    case SBP_MSG_CSAC_TELEMETRY:
      return sbp_unpack_sbp_msg_csac_telemetry_t(buf, len,
                                                 &msg->MSG_CSAC_TELEMETRY);
    case SBP_MSG_CSAC_TELEMETRY_LABELS:
      return sbp_unpack_sbp_msg_csac_telemetry_labels_t(
          buf, len, &msg->MSG_CSAC_TELEMETRY_LABELS);
    case SBP_MSG_INS_UPDATES:
      return sbp_unpack_sbp_msg_ins_updates_t(buf, len, &msg->MSG_INS_UPDATES);
    case SBP_MSG_GNSS_TIME_OFFSET:
      return sbp_unpack_sbp_msg_gnss_time_offset_t(buf, len,
                                                   &msg->MSG_GNSS_TIME_OFFSET);
    case SBP_MSG_GROUP_META:
    ...
    case SBP_MSG_BASE_POS_LLH:
      return sbp_unpack_sbp_msg_base_pos_llh_t(buf, len,
                                               &msg->MSG_BASE_POS_LLH);
    case SBP_MSG_BASE_POS_ECEF:
      return sbp_unpack_sbp_msg_base_pos_ecef_t(buf, len,
                                                &msg->MSG_BASE_POS_ECEF);
    case SBP_MSG_EPHEMERIS_GPS_DEP_E:
      return sbp_unpack_sbp_msg_ephemeris_gps_dep_e_t(
          buf, len, &msg->MSG_EPHEMERIS_GPS_DEP_E);
    case SBP_MSG_EPHEMERIS_GPS_DEP_F:
      return sbp_unpack_sbp_msg_ephemeris_gps_dep_f_t(
          buf, len, &msg->MSG_EPHEMERIS_GPS_DEP_F);
    case SBP_MSG_EPHEMERIS_GPS:
      return sbp_unpack_sbp_msg_ephemeris_gps_t(buf, len,
                                                &msg->MSG_EPHEMERIS_GPS);
    case SBP_MSG_EPHEMERIS_QZSS:
      return sbp_unpack_sbp_msg_ephemeris_qzss_t(buf, len,
                                                 &msg->MSG_EPHEMERIS_QZSS);
    case SBP_MSG_EPHEMERIS_BDS:
      return sbp_unpack_sbp_msg_ephemeris_bds_t(buf, len,
                                                &msg->MSG_EPHEMERIS_BDS);
    case SBP_MSG_EPHEMERIS_GAL_DEP_A:
      return sbp_unpack_sbp_msg_ephemeris_gal_dep_a_t(
          buf, len, &msg->MSG_EPHEMERIS_GAL_DEP_A);
    case SBP_MSG_EPHEMERIS_GAL:
      return sbp_unpack_sbp_msg_ephemeris_gal_t(buf, len,
                                                &msg->MSG_EPHEMERIS_GAL);
    case SBP_MSG_EPHEMERIS_SBAS_DEP_A:
      return sbp_unpack_sbp_msg_ephemeris_sbas_dep_a_t(
          buf, len, &msg->MSG_EPHEMERIS_SBAS_DEP_A);
    case SBP_MSG_EPHEMERIS_GLO_DEP_A:
      return sbp_unpack_sbp_msg_ephemeris_glo_dep_a_t(
          buf, len, &msg->MSG_EPHEMERIS_GLO_DEP_A);
    case SBP_MSG_EPHEMERIS_SBAS_DEP_B:
      return sbp_unpack_sbp_msg_ephemeris_sbas_dep_b_t(
          buf, len, &msg->MSG_EPHEMERIS_SBAS_DEP_B);
    case SBP_MSG_EPHEMERIS_SBAS:
      return sbp_unpack_sbp_msg_ephemeris_sbas_t(buf, len,
                                                 &msg->MSG_EPHEMERIS_SBAS);
    case SBP_MSG_EPHEMERIS_GLO_DEP_B:
      return sbp_unpack_sbp_msg_ephemeris_glo_dep_b_t(
          buf, len, &msg->MSG_EPHEMERIS_GLO_DEP_B);
    case SBP_MSG_EPHEMERIS_GLO_DEP_C:
      return sbp_unpack_sbp_msg_ephemeris_glo_dep_c_t(
          buf, len, &msg->MSG_EPHEMERIS_GLO_DEP_C);
    case SBP_MSG_EPHEMERIS_GLO_DEP_D:
      return sbp_unpack_sbp_msg_ephemeris_glo_dep_d_t(
          buf, len, &msg->MSG_EPHEMERIS_GLO_DEP_D);
    case SBP_MSG_EPHEMERIS_GLO:
      return sbp_unpack_sbp_msg_ephemeris_glo_t(buf, len,
                                                &msg->MSG_EPHEMERIS_GLO);
    case SBP_MSG_EPHEMERIS_DEP_D:
      return sbp_unpack_sbp_msg_ephemeris_dep_d_t(buf, len,
                                                  &msg->MSG_EPHEMERIS_DEP_D);
    case SBP_MSG_EPHEMERIS_DEP_A:
      return sbp_unpack_sbp_msg_ephemeris_dep_a_t(buf, len,
                                                  &msg->MSG_EPHEMERIS_DEP_A);
    case SBP_MSG_EPHEMERIS_DEP_B:
      return sbp_unpack_sbp_msg_ephemeris_dep_b_t(buf, len,
                                                  &msg->MSG_EPHEMERIS_DEP_B);
    case SBP_MSG_EPHEMERIS_DEP_C:
      return sbp_unpack_sbp_msg_ephemeris_dep_c_t(buf, len,
                                                  &msg->MSG_EPHEMERIS_DEP_C);
    case SBP_MSG_OBS_DEP_A:
    ...
    case SBP_MSG_SV_CONFIGURATION_GPS_DEP:
      return sbp_unpack_sbp_msg_sv_configuration_gps_dep_t(
          buf, len, &msg->MSG_SV_CONFIGURATION_GPS_DEP);
    case SBP_MSG_GNSS_CAPB:
      return sbp_unpack_sbp_msg_gnss_capb_t(buf, len, &msg->MSG_GNSS_CAPB);
    case SBP_MSG_GROUP_DELAY_DEP_A:
      return sbp_unpack_sbp_msg_group_delay_dep_a_t(
          buf, len, &msg->MSG_GROUP_DELAY_DEP_A);
    case SBP_MSG_GROUP_DELAY_DEP_B:
      return sbp_unpack_sbp_msg_group_delay_dep_b_t(
          buf, len, &msg->MSG_GROUP_DELAY_DEP_B);
    case SBP_MSG_GROUP_DELAY:
      return sbp_unpack_sbp_msg_group_delay_t(buf, len, &msg->MSG_GROUP_DELAY);
    case SBP_MSG_ALMANAC_GPS_DEP:
      return sbp_unpack_sbp_msg_almanac_gps_dep_t(buf, len,
                                                  &msg->MSG_ALMANAC_GPS_DEP);
    case SBP_MSG_ALMANAC_GPS:
      return sbp_unpack_sbp_msg_almanac_gps_t(buf, len, &msg->MSG_ALMANAC_GPS);
    case SBP_MSG_ALMANAC_GLO_DEP:
      return sbp_unpack_sbp_msg_almanac_glo_dep_t(buf, len,
                                                  &msg->MSG_ALMANAC_GLO_DEP);
    case SBP_MSG_ALMANAC_GLO:
    ...
    case SBP_MSG_RESET_FILTERS:
      return sbp_unpack_sbp_msg_reset_filters_t(buf, len,
                                                &msg->MSG_RESET_FILTERS);
    case SBP_MSG_INIT_BASE_DEP:
      return sbp_unpack_sbp_msg_init_base_dep_t(buf, len,
                                                &msg->MSG_INIT_BASE_DEP);
    case SBP_MSG_THREAD_STATE:
      return sbp_unpack_sbp_msg_thread_state_t(buf, len,
                                               &msg->MSG_THREAD_STATE);
    case SBP_MSG_UART_STATE:
      return sbp_unpack_sbp_msg_uart_state_t(buf, len, &msg->MSG_UART_STATE);
    case SBP_MSG_UART_STATE_DEPA:
      return sbp_unpack_sbp_msg_uart_state_depa_t(buf, len,
                                                  &msg->MSG_UART_STATE_DEPA);
    case SBP_MSG_IAR_STATE:
      return sbp_unpack_sbp_msg_iar_state_t(buf, len, &msg->MSG_IAR_STATE);
    case SBP_MSG_MASK_SATELLITE:
      return sbp_unpack_sbp_msg_mask_satellite_t(buf, len,
                                                 &msg->MSG_MASK_SATELLITE);
    case SBP_MSG_MASK_SATELLITE_DEP:
      return sbp_unpack_sbp_msg_mask_satellite_dep_t(
          buf, len, &msg->MSG_MASK_SATELLITE_DEP);
    case SBP_MSG_DEVICE_MONITOR:
      return sbp_unpack_sbp_msg_device_monitor_t(buf, len,
                                                 &msg->MSG_DEVICE_MONITOR);
    case SBP_MSG_COMMAND_REQ:
      return sbp_unpack_sbp_msg_command_req_t(buf, len, &msg->MSG_COMMAND_REQ);
    case SBP_MSG_COMMAND_RESP:
      return sbp_unpack_sbp_msg_command_resp_t(buf, len,
                                               &msg->MSG_COMMAND_RESP);
    case SBP_MSG_COMMAND_OUTPUT:
      return sbp_unpack_sbp_msg_command_output_t(buf, len,
                                                 &msg->MSG_COMMAND_OUTPUT);
    case SBP_MSG_NETWORK_STATE_REQ:
      return sbp_unpack_sbp_msg_network_state_req_t(
          buf, len, &msg->MSG_NETWORK_STATE_REQ);
    case SBP_MSG_NETWORK_STATE_RESP:
      return sbp_unpack_sbp_msg_network_state_resp_t(
          buf, len, &msg->MSG_NETWORK_STATE_RESP);
    case SBP_MSG_NETWORK_BANDWIDTH_USAGE:
      return sbp_unpack_sbp_msg_network_bandwidth_usage_t(
          buf, len, &msg->MSG_NETWORK_BANDWIDTH_USAGE);
    case SBP_MSG_CELL_MODEM_STATUS:
      return sbp_unpack_sbp_msg_cell_modem_status_t(
          buf, len, &msg->MSG_CELL_MODEM_STATUS);
    case SBP_MSG_SPECAN_DEP:
    ...
    case SBP_MSG_FRONT_END_GAIN:
      return sbp_unpack_sbp_msg_front_end_gain_t(buf, len,
                                                 &msg->MSG_FRONT_END_GAIN);
    case SBP_MSG_FLASH_PROGRAM:
      return sbp_unpack_sbp_msg_flash_program_t(buf, len,
                                                &msg->MSG_FLASH_PROGRAM);
    case SBP_MSG_FLASH_DONE:
      return sbp_unpack_sbp_msg_flash_done_t(buf, len, &msg->MSG_FLASH_DONE);
    case SBP_MSG_FLASH_READ_REQ:
      return sbp_unpack_sbp_msg_flash_read_req_t(buf, len,
                                                 &msg->MSG_FLASH_READ_REQ);
    case SBP_MSG_FLASH_READ_RESP:
      return sbp_unpack_sbp_msg_flash_read_resp_t(buf, len,
                                                  &msg->MSG_FLASH_READ_RESP);
    case SBP_MSG_FLASH_ERASE:
      return sbp_unpack_sbp_msg_flash_erase_t(buf, len, &msg->MSG_FLASH_ERASE);
    case SBP_MSG_STM_FLASH_LOCK_SECTOR:
      return sbp_unpack_sbp_msg_stm_flash_lock_sector_t(
          buf, len, &msg->MSG_STM_FLASH_LOCK_SECTOR);
    case SBP_MSG_STM_FLASH_UNLOCK_SECTOR:
      return sbp_unpack_sbp_msg_stm_flash_unlock_sector_t(
          buf, len, &msg->MSG_STM_FLASH_UNLOCK_SECTOR);
    case SBP_MSG_STM_UNIQUE_ID_REQ:
      return sbp_unpack_sbp_msg_stm_unique_id_req_t(
          buf, len, &msg->MSG_STM_UNIQUE_ID_REQ);
    case SBP_MSG_STM_UNIQUE_ID_RESP:
      return sbp_unpack_sbp_msg_stm_unique_id_resp_t(
          buf, len, &msg->MSG_STM_UNIQUE_ID_RESP);
    case SBP_MSG_M25_FLASH_WRITE_STATUS:
      return sbp_unpack_sbp_msg_m25_flash_write_status_t(
          buf, len, &msg->MSG_M25_FLASH_WRITE_STATUS);
    case SBP_MSG_IMU_RAW:
    ...
    case SBP_MSG_ACQ_RESULT_DEP_C:
      return sbp_unpack_sbp_msg_acq_result_dep_c_t(buf, len,
                                                   &msg->MSG_ACQ_RESULT_DEP_C);
    case SBP_MSG_ACQ_RESULT_DEP_B:
      return sbp_unpack_sbp_msg_acq_result_dep_b_t(buf, len,
                                                   &msg->MSG_ACQ_RESULT_DEP_B);
    case SBP_MSG_ACQ_RESULT_DEP_A:
      return sbp_unpack_sbp_msg_acq_result_dep_a_t(buf, len,
                                                   &msg->MSG_ACQ_RESULT_DEP_A);
    case SBP_MSG_ACQ_SV_PROFILE:
      return sbp_unpack_sbp_msg_acq_sv_profile_t(buf, len,
                                                 &msg->MSG_ACQ_SV_PROFILE);
    case SBP_MSG_ACQ_SV_PROFILE_DEP:
      return sbp_unpack_sbp_msg_acq_sv_profile_dep_t(
          buf, len, &msg->MSG_ACQ_SV_PROFILE_DEP);
    case SBP_MSG_SOLN_META_DEP_A:
      return sbp_unpack_sbp_msg_soln_meta_dep_a_t(buf, len,
                                                  &msg->MSG_SOLN_META_DEP_A);
    case SBP_MSG_SOLN_META:
      return sbp_unpack_sbp_msg_soln_meta_t(buf, len, &msg->MSG_SOLN_META);
    case SBP_MSG_BASELINE_HEADING:
      return sbp_unpack_sbp_msg_baseline_heading_t(buf, len,
                                                   &msg->MSG_BASELINE_HEADING);
    case SBP_MSG_ORIENT_QUAT:
      return sbp_unpack_sbp_msg_orient_quat_t(buf, len, &msg->MSG_ORIENT_QUAT);
    case SBP_MSG_ORIENT_EULER:
      return sbp_unpack_sbp_msg_orient_euler_t(buf, len,
                                               &msg->MSG_ORIENT_EULER);
    case SBP_MSG_ANGULAR_RATE:
      return sbp_unpack_sbp_msg_angular_rate_t(buf, len,
                                               &msg->MSG_ANGULAR_RATE);
    case SBP_MSG_MAG_RAW:
  ...
  switch (msg->type) {
    case SBP_MSG_TRACKING_STATE_DETAILED_DEP_A:
      return sbp_packed_size_sbp_msg_tracking_state_detailed_dep_a_t(
          &msg->MSG_TRACKING_STATE_DETAILED_DEP_A);
    case SBP_MSG_TRACKING_STATE_DETAILED_DEP:
      return sbp_packed_size_sbp_msg_tracking_state_detailed_dep_t(
          &msg->MSG_TRACKING_STATE_DETAILED_DEP);
    case SBP_MSG_TRACKING_STATE:
    ...
    case SBP_MSG_TRACKING_STATE_DEP_A:
      return sbp_packed_size_sbp_msg_tracking_state_dep_a_t(
          &msg->MSG_TRACKING_STATE_DEP_A);
    case SBP_MSG_TRACKING_STATE_DEP_B:
      return sbp_packed_size_sbp_msg_tracking_state_dep_b_t(
          &msg->MSG_TRACKING_STATE_DEP_B);
    case SBP_MSG_SETTINGS_SAVE:
    ...
    case SBP_MSG_SSR_GRIDDED_CORRECTION_DEP_A:
      return sbp_packed_size_sbp_msg_ssr_gridded_correction_dep_a_t(
          &msg->MSG_SSR_GRIDDED_CORRECTION_DEP_A);
    case SBP_MSG_SSR_GRID_DEFINITION_DEP_A:
      return sbp_packed_size_sbp_msg_ssr_grid_definition_dep_a_t(
          &msg->MSG_SSR_GRID_DEFINITION_DEP_A);
    case SBP_MSG_EXT_EVENT:
    ...
    case SBP_MSG_LINUX_CPU_STATE_DEP_A:
      return sbp_packed_size_sbp_msg_linux_cpu_state_dep_a_t(
          &msg->MSG_LINUX_CPU_STATE_DEP_A);
    case SBP_MSG_LINUX_MEM_STATE_DEP_A:
      return sbp_packed_size_sbp_msg_linux_mem_state_dep_a_t(
          &msg->MSG_LINUX_MEM_STATE_DEP_A);
    case SBP_MSG_LINUX_SYS_STATE_DEP_A:
      return sbp_packed_size_sbp_msg_linux_sys_state_dep_a_t(
          &msg->MSG_LINUX_SYS_STATE_DEP_A);
    case SBP_MSG_LINUX_PROCESS_SOCKET_COUNTS:
      return sbp_packed_size_sbp_msg_linux_process_socket_counts_t(
          &msg->MSG_LINUX_PROCESS_SOCKET_COUNTS);
    case SBP_MSG_LINUX_PROCESS_SOCKET_QUEUES:
      return sbp_packed_size_sbp_msg_linux_process_socket_queues_t(
          &msg->MSG_LINUX_PROCESS_SOCKET_QUEUES);
    case SBP_MSG_LINUX_SOCKET_USAGE:
      return sbp_packed_size_sbp_msg_linux_socket_usage_t(
          &msg->MSG_LINUX_SOCKET_USAGE);
    case SBP_MSG_LINUX_PROCESS_FD_COUNT:
      return sbp_packed_size_sbp_msg_linux_process_fd_count_t(
          &msg->MSG_LINUX_PROCESS_FD_COUNT);
    case SBP_MSG_LINUX_PROCESS_FD_SUMMARY:
      return sbp_packed_size_sbp_msg_linux_process_fd_summary_t(
          &msg->MSG_LINUX_PROCESS_FD_SUMMARY);
    case SBP_MSG_LINUX_CPU_STATE:
      return sbp_packed_size_sbp_msg_linux_cpu_state_t(
          &msg->MSG_LINUX_CPU_STATE);
    case SBP_MSG_LINUX_MEM_STATE:
      return sbp_packed_size_sbp_msg_linux_mem_state_t(
          &msg->MSG_LINUX_MEM_STATE);
    case SBP_MSG_LINUX_SYS_STATE:
      return sbp_packed_size_sbp_msg_linux_sys_state_t(
          &msg->MSG_LINUX_SYS_STATE);
    case SBP_MSG_GPS_TIME:
    ...
    case SBP_MSG_BASELINE_ECEF_DEP_A:
      return sbp_packed_size_sbp_msg_baseline_ecef_dep_a_t(
          &msg->MSG_BASELINE_ECEF_DEP_A);
    case SBP_MSG_BASELINE_NED_DEP_A:
      return sbp_packed_size_sbp_msg_baseline_ned_dep_a_t(
          &msg->MSG_BASELINE_NED_DEP_A);
    case SBP_MSG_VEL_ECEF_DEP_A:
    ...
    case SBP_MSG_BASELINE_HEADING_DEP_A:
      return sbp_packed_size_sbp_msg_baseline_heading_dep_a_t(
          &msg->MSG_BASELINE_HEADING_DEP_A);
    case SBP_MSG_PROTECTION_LEVEL:
      return sbp_packed_size_sbp_msg_protection_level_t(
          &msg->MSG_PROTECTION_LEVEL);
    case SBP_MSG_FILEIO_READ_REQ:
      return sbp_packed_size_sbp_msg_fileio_read_req_t(
          &msg->MSG_FILEIO_READ_REQ);
    case SBP_MSG_FILEIO_READ_RESP:
      return sbp_packed_size_sbp_msg_fileio_read_resp_t(
          &msg->MSG_FILEIO_READ_RESP);
    case SBP_MSG_FILEIO_READ_DIR_REQ:
      return sbp_packed_size_sbp_msg_fileio_read_dir_req_t(
          &msg->MSG_FILEIO_READ_DIR_REQ);
    case SBP_MSG_FILEIO_READ_DIR_RESP:
      return sbp_packed_size_sbp_msg_fileio_read_dir_resp_t(
          &msg->MSG_FILEIO_READ_DIR_RESP);
    case SBP_MSG_FILEIO_REMOVE:
      return sbp_packed_size_sbp_msg_fileio_remove_t(&msg->MSG_FILEIO_REMOVE);
    case SBP_MSG_FILEIO_WRITE_REQ:
      return sbp_packed_size_sbp_msg_fileio_write_req_t(
          &msg->MSG_FILEIO_WRITE_REQ);
    case SBP_MSG_FILEIO_WRITE_RESP:
    ...
    case SBP_MSG_CSAC_TELEMETRY_LABELS:
      return sbp_packed_size_sbp_msg_csac_telemetry_labels_t(
          &msg->MSG_CSAC_TELEMETRY_LABELS);
    case SBP_MSG_INS_UPDATES:
      return sbp_packed_size_sbp_msg_ins_updates_t(&msg->MSG_INS_UPDATES);
    case SBP_MSG_GNSS_TIME_OFFSET:
      return sbp_packed_size_sbp_msg_gnss_time_offset_t(
          &msg->MSG_GNSS_TIME_OFFSET);
    case SBP_MSG_GROUP_META:
    ...
    case SBP_MSG_EPHEMERIS_GPS_DEP_E:
      return sbp_packed_size_sbp_msg_ephemeris_gps_dep_e_t(
          &msg->MSG_EPHEMERIS_GPS_DEP_E);
    case SBP_MSG_EPHEMERIS_GPS_DEP_F:
      return sbp_packed_size_sbp_msg_ephemeris_gps_dep_f_t(
          &msg->MSG_EPHEMERIS_GPS_DEP_F);
    case SBP_MSG_EPHEMERIS_GPS:
    ...
    case SBP_MSG_EPHEMERIS_GAL_DEP_A:
      return sbp_packed_size_sbp_msg_ephemeris_gal_dep_a_t(
          &msg->MSG_EPHEMERIS_GAL_DEP_A);
    case SBP_MSG_EPHEMERIS_GAL:
      return sbp_packed_size_sbp_msg_ephemeris_gal_t(&msg->MSG_EPHEMERIS_GAL);
    case SBP_MSG_EPHEMERIS_SBAS_DEP_A:
      return sbp_packed_size_sbp_msg_ephemeris_sbas_dep_a_t(
          &msg->MSG_EPHEMERIS_SBAS_DEP_A);
    case SBP_MSG_EPHEMERIS_GLO_DEP_A:
      return sbp_packed_size_sbp_msg_ephemeris_glo_dep_a_t(
          &msg->MSG_EPHEMERIS_GLO_DEP_A);
    case SBP_MSG_EPHEMERIS_SBAS_DEP_B:
      return sbp_packed_size_sbp_msg_ephemeris_sbas_dep_b_t(
          &msg->MSG_EPHEMERIS_SBAS_DEP_B);
    case SBP_MSG_EPHEMERIS_SBAS:
      return sbp_packed_size_sbp_msg_ephemeris_sbas_t(&msg->MSG_EPHEMERIS_SBAS);
    case SBP_MSG_EPHEMERIS_GLO_DEP_B:
      return sbp_packed_size_sbp_msg_ephemeris_glo_dep_b_t(
          &msg->MSG_EPHEMERIS_GLO_DEP_B);
    case SBP_MSG_EPHEMERIS_GLO_DEP_C:
      return sbp_packed_size_sbp_msg_ephemeris_glo_dep_c_t(
          &msg->MSG_EPHEMERIS_GLO_DEP_C);
    case SBP_MSG_EPHEMERIS_GLO_DEP_D:
      return sbp_packed_size_sbp_msg_ephemeris_glo_dep_d_t(
          &msg->MSG_EPHEMERIS_GLO_DEP_D);
    case SBP_MSG_EPHEMERIS_GLO:
      return sbp_packed_size_sbp_msg_ephemeris_glo_t(&msg->MSG_EPHEMERIS_GLO);
    case SBP_MSG_EPHEMERIS_DEP_D:
      return sbp_packed_size_sbp_msg_ephemeris_dep_d_t(
          &msg->MSG_EPHEMERIS_DEP_D);
    case SBP_MSG_EPHEMERIS_DEP_A:
      return sbp_packed_size_sbp_msg_ephemeris_dep_a_t(
          &msg->MSG_EPHEMERIS_DEP_A);
    case SBP_MSG_EPHEMERIS_DEP_B:
      return sbp_packed_size_sbp_msg_ephemeris_dep_b_t(
          &msg->MSG_EPHEMERIS_DEP_B);
    case SBP_MSG_EPHEMERIS_DEP_C:
      return sbp_packed_size_sbp_msg_ephemeris_dep_c_t(
          &msg->MSG_EPHEMERIS_DEP_C);
    case SBP_MSG_OBS_DEP_A:
    ...
    case SBP_MSG_SV_CONFIGURATION_GPS_DEP:
      return sbp_packed_size_sbp_msg_sv_configuration_gps_dep_t(
          &msg->MSG_SV_CONFIGURATION_GPS_DEP);
    case SBP_MSG_GNSS_CAPB:
      return sbp_packed_size_sbp_msg_gnss_capb_t(&msg->MSG_GNSS_CAPB);
    case SBP_MSG_GROUP_DELAY_DEP_A:
      return sbp_packed_size_sbp_msg_group_delay_dep_a_t(
          &msg->MSG_GROUP_DELAY_DEP_A);
    case SBP_MSG_GROUP_DELAY_DEP_B:
      return sbp_packed_size_sbp_msg_group_delay_dep_b_t(
          &msg->MSG_GROUP_DELAY_DEP_B);
    case SBP_MSG_GROUP_DELAY:
      return sbp_packed_size_sbp_msg_group_delay_t(&msg->MSG_GROUP_DELAY);
    case SBP_MSG_ALMANAC_GPS_DEP:
      return sbp_packed_size_sbp_msg_almanac_gps_dep_t(
          &msg->MSG_ALMANAC_GPS_DEP);
    case SBP_MSG_ALMANAC_GPS:
      return sbp_packed_size_sbp_msg_almanac_gps_t(&msg->MSG_ALMANAC_GPS);
    case SBP_MSG_ALMANAC_GLO_DEP:
      return sbp_packed_size_sbp_msg_almanac_glo_dep_t(
          &msg->MSG_ALMANAC_GLO_DEP);
    case SBP_MSG_ALMANAC_GLO:
    ...
    case SBP_MSG_UART_STATE_DEPA:
      return sbp_packed_size_sbp_msg_uart_state_depa_t(
          &msg->MSG_UART_STATE_DEPA);
    case SBP_MSG_IAR_STATE:
    ...
    case SBP_MSG_MASK_SATELLITE_DEP:
      return sbp_packed_size_sbp_msg_mask_satellite_dep_t(
          &msg->MSG_MASK_SATELLITE_DEP);
    case SBP_MSG_DEVICE_MONITOR:
    ...
    case SBP_MSG_NETWORK_STATE_REQ:
      return sbp_packed_size_sbp_msg_network_state_req_t(
          &msg->MSG_NETWORK_STATE_REQ);
    case SBP_MSG_NETWORK_STATE_RESP:
      return sbp_packed_size_sbp_msg_network_state_resp_t(
          &msg->MSG_NETWORK_STATE_RESP);
    case SBP_MSG_NETWORK_BANDWIDTH_USAGE:
      return sbp_packed_size_sbp_msg_network_bandwidth_usage_t(
          &msg->MSG_NETWORK_BANDWIDTH_USAGE);
    case SBP_MSG_CELL_MODEM_STATUS:
      return sbp_packed_size_sbp_msg_cell_modem_status_t(
          &msg->MSG_CELL_MODEM_STATUS);
    case SBP_MSG_SPECAN_DEP:
    ...
    case SBP_MSG_ACQ_RESULT_DEP_C:
      return sbp_packed_size_sbp_msg_acq_result_dep_c_t(
          &msg->MSG_ACQ_RESULT_DEP_C);
    case SBP_MSG_ACQ_RESULT_DEP_B:
      return sbp_packed_size_sbp_msg_acq_result_dep_b_t(
          &msg->MSG_ACQ_RESULT_DEP_B);
    case SBP_MSG_ACQ_RESULT_DEP_A:
      return sbp_packed_size_sbp_msg_acq_result_dep_a_t(
          &msg->MSG_ACQ_RESULT_DEP_A);
    case SBP_MSG_ACQ_SV_PROFILE:
    ...
    case SBP_MSG_ACQ_SV_PROFILE_DEP:
      return sbp_packed_size_sbp_msg_acq_sv_profile_dep_t(
          &msg->MSG_ACQ_SV_PROFILE_DEP);
    case SBP_MSG_SOLN_META_DEP_A:
      return sbp_packed_size_sbp_msg_soln_meta_dep_a_t(
          &msg->MSG_SOLN_META_DEP_A);
    case SBP_MSG_SOLN_META:
      return sbp_packed_size_sbp_msg_soln_meta_t(&msg->MSG_SOLN_META);
    case SBP_MSG_BASELINE_HEADING:
      return sbp_packed_size_sbp_msg_baseline_heading_t(
          &msg->MSG_BASELINE_HEADING);
    case SBP_MSG_ORIENT_QUAT:
