...
static inline bool sbp_pack_msg(uint8_t *buf, size_t len, u16 msg_type,
                                const sbp_msg_t *msg) {
  switch (msg_type) {
...
static inline bool sbp_unpack_msg(const uint8_t *buf, size_t len, u16 msg_type,
                                  sbp_msg_t *msg) {
  switch (msg_type) {
    case SBP_MSG_SBAS_RAW:
...
static inline size_t sbp_packed_size(u16 msg_type, const sbp_msg_t *msg) {
  switch (msg_type) {
    case SBP_MSG_SBAS_RAW:
