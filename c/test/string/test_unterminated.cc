...
TEST(TestUnterminatedString, InitialState) {
  ...
  EXPECT_EQ(sbp_unterminated_string_packed_len(&s, &short_params), 0);
  EXPECT_EQ(sbp_unterminated_string_packed_len(&s, &long_params), 0);
  EXPECT_EQ(sbp_unterminated_string_packed_len(&s, &max_params), 0);
...
TEST(TestUnterminatedString, InvalidState) {
  ...
  EXPECT_EQ(sbp_unterminated_string_packed_len(&s, &short_params), 0);
  EXPECT_EQ(sbp_unterminated_string_packed_len(&s, &long_params), 11);
  EXPECT_EQ(sbp_unterminated_string_packed_len(&s, &max_params), 11);
  ...
  s.packed_len = 9; // Points to the final 'a'
  EXPECT_FALSE(sbp_unterminated_string_valid(&s, &short_params));
...
TEST(TestUnterminatedString, Init) {
  ...
  EXPECT_EQ(sbp_unterminated_string_packed_len(&s, &params), 0);
  ...
  EXPECT_TRUE(sbp_unterminated_string_valid(&s, &params));
  EXPECT_EQ(sbp_unterminated_string_packed_len(&s, &params), 4);
...
TEST(TestUnterminatedString, Set)
{
  ...
  EXPECT_TRUE(sbp_unterminated_string_valid(&s, &params));
  EXPECT_EQ(sbp_unterminated_string_packed_len(&s, &params), 13);
  ...
  EXPECT_TRUE(sbp_unterminated_string_valid(&s, &params));
  EXPECT_EQ(sbp_unterminated_string_packed_len(&s, &params), 15);
...
TEST(TestUnterminatedString, Printf)
{
  ...
  EXPECT_TRUE(sbp_unterminated_string_valid(&s, &params));
  EXPECT_EQ(sbp_unterminated_string_packed_len(&s, &params), 7);
...
TEST(TestUnterminatedString, Append)
{
  ...
  EXPECT_TRUE(sbp_unterminated_string_valid(&s, &params));
  EXPECT_EQ(sbp_unterminated_string_packed_len(&s, &params), 5);
...
TEST(TestUnterminatedString, AppendPrintf)
{
  ...
  EXPECT_TRUE(sbp_unterminated_string_valid(&s, &params));
  EXPECT_EQ(sbp_unterminated_string_packed_len(&s, &params), 3);
  ...
  EXPECT_TRUE(sbp_unterminated_string_valid(&s, &params));
  EXPECT_EQ(sbp_unterminated_string_packed_len(&s, &params), 20);
...
TEST(TestUnterminatedString, Pack)
{
  ...
  EXPECT_TRUE(sbp_unterminated_string_valid(&s, &long_params));
  EXPECT_EQ(sbp_unterminated_string_packed_len(&s, &long_params), 13);
  ...
  EXPECT_TRUE(sbp_unterminated_string_set(&s, &long_params, "Hello, World!!!!!!!!"));
  EXPECT_TRUE(sbp_unterminated_string_valid(&s, &long_params));
  EXPECT_EQ(sbp_unterminated_string_packed_len(&s, &long_params), 20);
  EXPECT_TRUE(sbp_unterminated_string_pack(&s, &long_params, &ctx));
...
TEST(TestUnterminatedString, Unpack)
{
  ...
  EXPECT_TRUE(sbp_unterminated_string_unpack(&s, &params, &ctx));
  EXPECT_TRUE(sbp_unterminated_string_valid(&s, &params));
  EXPECT_EQ(sbp_unterminated_string_packed_len(&s, &params), 2);
