...
class Test_auto_check_sbp_observation_550 : public ::testing::Test, public sbp::State, public sbp::IReader, public sbp::IWriter, sbp::MessageHandler<sbp_msg_ephemeris_dep_b_t>
{
public:
  Test_auto_check_sbp_observation_550() : ::testing::Test(), sbp::State(), sbp::IReader(), sbp::IWriter(), sbp::MessageHandler<sbp_msg_ephemeris_dep_b_t>(this), last_msg_(), last_sender_id_(), n_callbacks_logged_(), wr_(), rd_(), io_buf_()
  {
    set_reader(this);
    set_writer(this);
  }
...
TEST_F(Test_auto_check_sbp_observation_550, Test)     
{
    ...
    sbp_msg_ephemeris_dep_b_t test_unpacked_msg{};
    test_unpacked_msg.af0 = -1.035025343298912e-05;
    test_unpacked_msg.af1 = -9.094947017729282e-13;
    test_unpacked_msg.af2 = 0.0;
    test_unpacked_msg.c_ic = 6.332993507385254e-08;
    test_unpacked_msg.c_is = -1.564621925354004e-07;
    test_unpacked_msg.c_rc = 234.375;
    test_unpacked_msg.c_rs = -74.90625;
    test_unpacked_msg.c_uc = -3.937631845474243e-06;
    test_unpacked_msg.c_us = 6.9122761487960815e-06;
    test_unpacked_msg.dn = 4.8884179079418005e-09;
    test_unpacked_msg.ecc = 0.011132609914056957;
    test_unpacked_msg.healthy = 1;
    test_unpacked_msg.inc = 0.9395524830579087;
    test_unpacked_msg.inc_dot = -3.296565886629854e-10;
    test_unpacked_msg.iode = 0;
    test_unpacked_msg.m0 = 2.467348395627239;
    test_unpacked_msg.omega0 = -0.9468985437479658;
    test_unpacked_msg.omegadot = -8.201055892610478e-09;
    test_unpacked_msg.prn = 3;
    test_unpacked_msg.sqrta = 5153.714303970337;
    test_unpacked_msg.tgd = -6.51925802230835e-09;
    test_unpacked_msg.toc_tow = 410400.0;
    test_unpacked_msg.toc_wn = 1838;
    test_unpacked_msg.toe_tow = 410400.0;
    test_unpacked_msg.toe_wn = 1838;
    test_unpacked_msg.valid = 1;
    test_unpacked_msg.w = 1.0525047200405302;
...
class Test_auto_check_sbp_observation_551 : public ::testing::Test, public sbp::State, public sbp::IReader, public sbp::IWriter, sbp::MessageHandler<sbp_msg_ephemeris_dep_b_t>
{
public:
  Test_auto_check_sbp_observation_551() : ::testing::Test(), sbp::State(), sbp::IReader(), sbp::IWriter(), sbp::MessageHandler<sbp_msg_ephemeris_dep_b_t>(this), last_msg_(), last_sender_id_(), n_callbacks_logged_(), wr_(), rd_(), io_buf_()
  {
    set_reader(this);
    set_writer(this);
  }
...
TEST_F(Test_auto_check_sbp_observation_551, Test)     
{
    ...
    sbp_msg_ephemeris_dep_b_t test_unpacked_msg{};
    test_unpacked_msg.af0 = 7.384549826383591e-05;
    test_unpacked_msg.af1 = -2.8421709430404007e-12;
    test_unpacked_msg.af2 = 0.0;
    test_unpacked_msg.c_ic = 1.341104507446289e-07;
    test_unpacked_msg.c_is = 1.1920928955078125e-07;
    test_unpacked_msg.c_rc = 315.78125;
    test_unpacked_msg.c_rs = 36.5625;
    test_unpacked_msg.c_uc = 2.0638108253479004e-06;
    test_unpacked_msg.c_us = 3.4142285585403442e-06;
    test_unpacked_msg.dn = 4.86198823561129e-09;
    test_unpacked_msg.ecc = 0.007922741584479809;
    test_unpacked_msg.healthy = 1;
    test_unpacked_msg.inc = 0.9669012918227122;
    test_unpacked_msg.inc_dot = 2.6251093463412166e-10;
    test_unpacked_msg.iode = 0;
    test_unpacked_msg.m0 = -1.588160855720083;
    test_unpacked_msg.omega0 = 1.237919941568746;
    test_unpacked_msg.omegadot = -8.295702692172441e-09;
    test_unpacked_msg.prn = 13;
    test_unpacked_msg.sqrta = 5153.57085609436;
    test_unpacked_msg.tgd = -9.313225746154785e-09;
    test_unpacked_msg.toc_tow = 410400.0;
    test_unpacked_msg.toc_wn = 1838;
    test_unpacked_msg.toe_tow = 410400.0;
    test_unpacked_msg.toe_wn = 1838;
    test_unpacked_msg.valid = 1;
    test_unpacked_msg.w = -1.9736022837941165;
...
class Test_auto_check_sbp_observation_552 : public ::testing::Test, public sbp::State, public sbp::IReader, public sbp::IWriter, sbp::MessageHandler<sbp_msg_ephemeris_dep_b_t>
{
public:
  Test_auto_check_sbp_observation_552() : ::testing::Test(), sbp::State(), sbp::IReader(), sbp::IWriter(), sbp::MessageHandler<sbp_msg_ephemeris_dep_b_t>(this), last_msg_(), last_sender_id_(), n_callbacks_logged_(), wr_(), rd_(), io_buf_()
  {
    set_reader(this);
    set_writer(this);
  }
...
TEST_F(Test_auto_check_sbp_observation_552, Test)     
{
    ...
    sbp_msg_ephemeris_dep_b_t test_unpacked_msg{};
    test_unpacked_msg.af0 = -7.249414920806885e-06;
    test_unpacked_msg.af1 = 4.547473508864641e-13;
    test_unpacked_msg.af2 = 0.0;
    test_unpacked_msg.c_ic = -4.6566128730773926e-08;
    test_unpacked_msg.c_is = -2.60770320892334e-08;
    test_unpacked_msg.c_rc = 236.03125;
    test_unpacked_msg.c_rs = -68.625;
    test_unpacked_msg.c_uc = -3.470107913017273e-06;
    test_unpacked_msg.c_us = 7.461756467819214e-06;
    test_unpacked_msg.dn = 4.4637573619826565e-09;
    test_unpacked_msg.ecc = 0.004040417145006359;
    test_unpacked_msg.healthy = 1;
    test_unpacked_msg.inc = 0.9619021920701416;
    test_unpacked_msg.inc_dot = -3.3644258561271105e-10;
    test_unpacked_msg.iode = 0;
    test_unpacked_msg.m0 = 2.7055255058713295;
    test_unpacked_msg.omega0 = -0.9258770941316397;
    test_unpacked_msg.omegadot = -8.082122367123182e-09;
    test_unpacked_msg.prn = 0;
    test_unpacked_msg.sqrta = 5153.669353485107;
    ...
    test_unpacked_msg.toe_wn = 1838;
    test_unpacked_msg.valid = 1;
    test_unpacked_msg.w = 0.37873566614641857;
...
class Test_auto_check_sbp_observation_553 : public ::testing::Test, public sbp::State, public sbp::IReader, public sbp::IWriter, sbp::MessageHandler<sbp_msg_ephemeris_dep_b_t>
{
public:
  Test_auto_check_sbp_observation_553() : ::testing::Test(), sbp::State(), sbp::IReader(), sbp::IWriter(), sbp::MessageHandler<sbp_msg_ephemeris_dep_b_t>(this), last_msg_(), last_sender_id_(), n_callbacks_logged_(), wr_(), rd_(), io_buf_()
  {
    set_reader(this);
    set_writer(this);
  }
...
TEST_F(Test_auto_check_sbp_observation_553, Test)     
{
...
class Test_auto_check_sbp_observation_554 : public ::testing::Test, public sbp::State, public sbp::IReader, public sbp::IWriter, sbp::MessageHandler<sbp_msg_ephemeris_dep_b_t>
{
public:
  Test_auto_check_sbp_observation_554() : ::testing::Test(), sbp::State(), sbp::IReader(), sbp::IWriter(), sbp::MessageHandler<sbp_msg_ephemeris_dep_b_t>(this), last_msg_(), last_sender_id_(), n_callbacks_logged_(), wr_(), rd_(), io_buf_()
  {
    set_reader(this);
    set_writer(this);
  }
...
TEST_F(Test_auto_check_sbp_observation_554, Test)     
{
    ...
    sbp_msg_ephemeris_dep_b_t test_unpacked_msg{};
    test_unpacked_msg.af0 = -9.925523772835732e-05;
    test_unpacked_msg.af1 = -2.5011104298755527e-12;
    test_unpacked_msg.af2 = 0.0;
    test_unpacked_msg.c_ic = -3.166496753692627e-08;
    test_unpacked_msg.c_is = -2.0675361156463623e-07;
    test_unpacked_msg.c_rc = 305.21875;
    test_unpacked_msg.c_rs = 43.21875;
    test_unpacked_msg.c_uc = 2.1010637283325195e-06;
    test_unpacked_msg.c_us = 3.766268491744995e-06;
    test_unpacked_msg.dn = 5.26057626697412e-09;
    test_unpacked_msg.ecc = 0.009923744946718216;
    test_unpacked_msg.healthy = 1;
    test_unpacked_msg.inc = 0.9487513221807672;
    test_unpacked_msg.inc_dot = 3.000124967247105e-10;
    test_unpacked_msg.iode = 0;
    test_unpacked_msg.m0 = -2.666160271911327;
    test_unpacked_msg.omega0 = 1.1669551972594425;
    test_unpacked_msg.omegadot = -8.45999524990264e-09;
    test_unpacked_msg.prn = 22;
    test_unpacked_msg.sqrta = 5153.636667251587;
    test_unpacked_msg.tgd = -2.0023435354232788e-08;
    test_unpacked_msg.toc_tow = 410400.0;
    test_unpacked_msg.toc_wn = 1838;
    test_unpacked_msg.toe_tow = 410400.0;
    test_unpacked_msg.toe_wn = 1838;
    test_unpacked_msg.valid = 1;
    test_unpacked_msg.w = -2.7021241452652935;
...
class Test_auto_check_sbp_observation_555 : public ::testing::Test, public sbp::State, public sbp::IReader, public sbp::IWriter, sbp::MessageHandler<sbp_msg_ephemeris_dep_b_t>
{
public:
  Test_auto_check_sbp_observation_555() : ::testing::Test(), sbp::State(), sbp::IReader(), sbp::IWriter(), sbp::MessageHandler<sbp_msg_ephemeris_dep_b_t>(this), last_msg_(), last_sender_id_(), n_callbacks_logged_(), wr_(), rd_(), io_buf_()
  {
    set_reader(this);
    set_writer(this);
  }
...
TEST_F(Test_auto_check_sbp_observation_555, Test)     
{
    ...
    sbp_msg_ephemeris_dep_b_t test_unpacked_msg{};
    test_unpacked_msg.af0 = 0.0003196117468178272;
    test_unpacked_msg.af1 = -1.0231815394945443e-12;
    test_unpacked_msg.af2 = 0.0;
    test_unpacked_msg.c_ic = 9.12696123123169e-08;
    test_unpacked_msg.c_is = 5.21540641784668e-08;
    test_unpacked_msg.c_rc = 247.28125;
    test_unpacked_msg.c_rs = -77.90625;
    test_unpacked_msg.c_uc = -3.723427653312683e-06;
    test_unpacked_msg.c_us = 7.178634405136108e-06;
    test_unpacked_msg.dn = 4.400897600764146e-09;
    test_unpacked_msg.ecc = 0.008178644930012524;
    test_unpacked_msg.healthy = 1;
    test_unpacked_msg.inc = 0.9755122017245301;
    test_unpacked_msg.inc_dot = -5.882387882209502e-10;
    test_unpacked_msg.iode = 0;
    test_unpacked_msg.m0 = 1.9401823459824192;
    test_unpacked_msg.omega0 = 2.241868028927766;
    test_unpacked_msg.omegadot = -7.962474526167494e-09;
    test_unpacked_msg.prn = 30;
    test_unpacked_msg.sqrta = 5153.7539920806885;
    test_unpacked_msg.tgd = -1.3504177331924438e-08;
    test_unpacked_msg.toc_tow = 410400.0;
    test_unpacked_msg.toc_wn = 1838;
    test_unpacked_msg.toe_tow = 410400.0;
    test_unpacked_msg.toe_wn = 1838;
    test_unpacked_msg.valid = 1;
    test_unpacked_msg.w = -0.5237901716088061;
