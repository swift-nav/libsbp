...
class Test_auto_check_sbp_navigation_360 : public ::testing::Test, public sbp::State, public sbp::IReader, public sbp::IWriter, sbp::MessageHandler<sbp_msg_vel_ecef_cov_t>
{
public:
  Test_auto_check_sbp_navigation_360() : ::testing::Test(), sbp::State(), sbp::IReader(), sbp::IWriter(), sbp::MessageHandler<sbp_msg_vel_ecef_cov_t>(this), last_msg_(), last_sender_id_(), n_callbacks_logged_(), wr_(), rd_(), io_buf_()
  {
    set_reader(this);
    set_writer(this);
  }
...
TEST_F(Test_auto_check_sbp_navigation_360, Test)     
{
    ...
    sbp_msg_vel_ecef_cov_t test_unpacked_msg{};
    test_unpacked_msg.cov_x_x = 2.0;
    test_unpacked_msg.cov_x_y = 2.0;
    test_unpacked_msg.cov_x_z = 2.0;
    test_unpacked_msg.cov_y_y = 2.0;
    test_unpacked_msg.cov_y_z = 1.0;
    test_unpacked_msg.cov_z_z = 3.0;
    test_unpacked_msg.flags = 4;
    test_unpacked_msg.n_sats = 3;
    test_unpacked_msg.tow = 2;
    test_unpacked_msg.x = 0;
    test_unpacked_msg.y = 0;
    test_unpacked_msg.z = 6;
