...
class Test_auto_check_sbp_navigation_160 : public ::testing::Test, public sbp::State, public sbp::IReader, public sbp::IWriter, sbp::MessageHandler<sbp_msg_dops_t>
{
public:
  Test_auto_check_sbp_navigation_160() : ::testing::Test(), sbp::State(), sbp::IReader(), sbp::IWriter(), sbp::MessageHandler<sbp_msg_dops_t>(this), last_msg_(), last_sender_id_(), n_callbacks_logged_(), wr_(), rd_(), io_buf_()
  {
    set_reader(this);
    set_writer(this);
  }
...
TEST_F(Test_auto_check_sbp_navigation_160, Test)     
{

    uint8_t encoded_frame[] = {85,8,2,66,0,15,100,0,0,0,2,0,6,0,5,0,5,0,5,0,0,244,4, };

    sbp_msg_dops_t test_unpacked_msg{};
    test_unpacked_msg.flags = 0;
    test_unpacked_msg.gdop = 2;
    test_unpacked_msg.hdop = 5;
    test_unpacked_msg.pdop = 6;
    test_unpacked_msg.tdop = 5;
    test_unpacked_msg.tow = 100;
    test_unpacked_msg.vdop = 5;
