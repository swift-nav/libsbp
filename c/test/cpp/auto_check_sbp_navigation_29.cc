...
class Test_auto_check_sbp_navigation_290 : public ::testing::Test, public sbp::State, public sbp::IReader, public sbp::IWriter, sbp::MessageHandler<sbp_msg_pos_llh_cov_gnss_t>
{
public:
  Test_auto_check_sbp_navigation_290() : ::testing::Test(), sbp::State(), sbp::IReader(), sbp::IWriter(), sbp::MessageHandler<sbp_msg_pos_llh_cov_gnss_t>(this), last_msg_(), last_sender_id_(), n_callbacks_logged_(), wr_(), rd_(), io_buf_()
  {
    set_reader(this);
    set_writer(this);
  }
...
TEST_F(Test_auto_check_sbp_navigation_290, Test)     
{
    ...
    sbp_msg_pos_llh_cov_gnss_t test_unpacked_msg{};
    test_unpacked_msg.cov_d_d = 0.03288137540221214;
    test_unpacked_msg.cov_e_d = -0.0008439270895905793;
    test_unpacked_msg.cov_e_e = 0.004523798823356628;
    test_unpacked_msg.cov_n_d = 0.0018563168123364449;
    test_unpacked_msg.cov_n_e = -0.00036755966721102595;
    test_unpacked_msg.cov_n_n = 0.007488971576094627;
