...
var serial = '/dev/cu.usbserial-00002414';
...
/**
 * The current version of libsbp-javascript is designed for decoding,
 *  and not encoding of messages. It's possible but cumbersome:
 */
function makeMessageReset () {
  return constructMsg(MsgReset, {}).toBuffer();
}
