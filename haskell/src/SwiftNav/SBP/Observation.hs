...
data PackedObsContent = PackedObsContent
  ...
  , _packedObsContent_lock :: Word16
    ...
    -- changed.
  , _packedObsContent_sid :: SBPSignal
    -- ^ Signal identifier (constellation / satellite / band)
  } deriving ( Show, Read, Eq )
...
data MsgEphemeris = MsgEphemeris
  ...
  , _msgEphemeris_sid    :: SBPSignal
    -- ^ Identifier of the signal being tracked (constellation / satellite /
    -- band)
